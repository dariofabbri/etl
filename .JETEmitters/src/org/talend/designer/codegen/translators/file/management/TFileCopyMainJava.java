...
public class TFileCopyMainJava
{
  ...
  protected final String TEXT_71 = NL + NL + "\t\t}" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_72 = "_DESTINATION_FILEPATH\",desFile_";
  protected final String TEXT_73 = ".getPath()); " + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_74 = "_DESTINATION_FILENAME\",desFile_";
  protected final String TEXT_75 = ".getName()); " + NL + "" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_76 = "_SOURCE_DIRECTORY\", srcFile_";
  protected final String TEXT_77 = ".getParent());" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_78 = "_DESTINATION_DIRECTORY\", desFile_";
  protected final String TEXT_79 = ".getParent());";
