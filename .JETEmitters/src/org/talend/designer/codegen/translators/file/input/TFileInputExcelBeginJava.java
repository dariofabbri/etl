...
public class TFileInputExcelBeginJava
{
  ...
  protected final String TEXT_599 = NL + "\t\tObject source_";
  protected final String TEXT_600 = " = ";
  protected final String TEXT_601 = ";" + NL + "\t\tcom.talend.excel.xssf.event.ExcelReader excelReader_";
  protected final String TEXT_602 = " = null;" + NL + "\t\t" + NL + "\t\tif(source_";
  protected final String TEXT_603 = " instanceof java.io.InputStream || source_";
  protected final String TEXT_604 = " instanceof String){" + NL + "\t\t\texcelReader_";
  protected final String TEXT_605 = " = new com.talend.excel.xssf.event.ExcelReader();" + NL + "\t\t}else{" + NL + "\t\t\tthrow new Exception(\"The data source should be specified as Inputstream or File Path!\");" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\ttry {";
  protected final String TEXT_606 = NL + "\t\texcelReader_";
  protected final String TEXT_607 = ".addSheetName(\".*\",true);";
  protected final String TEXT_608 = NL + "\t\texcelReader_";
  protected final String TEXT_609 = ".addSheetName(";
  protected final String TEXT_610 = ", ";
  protected final String TEXT_611 = ");";
  protected final String TEXT_612 = NL + "\t\tint start_column_";
  protected final String TEXT_613 = " = ";
  protected final String TEXT_614 = "0";
  protected final String TEXT_615 = "-1";
  protected final String TEXT_616 = ";" + NL + "\t\tint end_column_";
  protected final String TEXT_617 = " = ";
  protected final String TEXT_618 = "-1";
  protected final String TEXT_619 = "-1";
  protected final String TEXT_620 = ";" + NL + "\t\tif(start_column_";
  protected final String TEXT_621 = " >=0) {//follow start column" + NL + "\t\t\tend_column_";
  protected final String TEXT_622 = " = start_column_";
  protected final String TEXT_623 = " + ";
  protected final String TEXT_624 = " - 1;" + NL + "\t\t} else if(end_column_";
  protected final String TEXT_625 = " >= 0) {//follow end column" + NL + "\t\t\tstart_column_";
  protected final String TEXT_626 = " = end_column_";
  protected final String TEXT_627 = " - ";
  protected final String TEXT_628 = " + 1;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tif(end_column_";
  protected final String TEXT_629 = "<0 || start_column_";
  protected final String TEXT_630 = "<0) {" + NL + "\t\t\tthrow new RuntimeException(\"Error start column and end column.\");" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tint header_";
  protected final String TEXT_631 = " = ";
  protected final String TEXT_632 = "0";
  protected final String TEXT_633 = ";" + NL + "\t\tint limit_";
  protected final String TEXT_634 = " = ";
  protected final String TEXT_635 = "-1";
  protected final String TEXT_636 = ";" + NL + "\t\t" + NL + "\t\tint nb_line_";
  protected final String TEXT_637 = " = 0;" + NL + "\t\t" + NL + "\t\t//for the number format        " + NL + "        java.text.DecimalFormat df_";
  protected final String TEXT_638 = " = new java.text.DecimalFormat(\"#.####################################\");" + NL + "        char decimalChar_";
  protected final String TEXT_639 = " = df_";
  protected final String TEXT_640 = ".getDecimalFormatSymbols().getDecimalSeparator();" + NL + "\t\t" + NL + "\t\texcelReader_";
  protected final String TEXT_641 = ".parse(";
  protected final String TEXT_642 = ",";
  protected final String TEXT_643 = ");" + NL + "\t\t" + NL + "\t\twhile((header_";
  protected final String TEXT_644 = "--)>0 && excelReader_";
  protected final String TEXT_645 = ".hasNext()) {//skip the header" + NL + "\t\t\texcelReader_";
  protected final String TEXT_646 = ".next();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\twhile(excelReader_";
  protected final String TEXT_647 = ".hasNext()) {" + NL + "\t\t\tint emptyColumnCount_";
  protected final String TEXT_648 = " = 0;" + NL + "\t\t" + NL + "\t\t\tif (limit_";
  protected final String TEXT_649 = " != -1 && nb_line_";
  protected final String TEXT_650 = " >= limit_";
  protected final String TEXT_651 = ") {" + NL + "\t\t\t\texcelReader_";
  protected final String TEXT_652 = ".stopRead();" + NL + "        \t\tbreak;" + NL + "        \t}" + NL + "        \t" + NL + "        \tjava.util.List<String> row_";
  protected final String TEXT_653 = " = excelReader_";
  protected final String TEXT_654 = ".next();";
  protected final String TEXT_655 = NL + "\t\t";
  protected final String TEXT_656 = " = null;\t\t\t";
  protected final String TEXT_657 = NL + "\t\tString[] temp_row_";
  protected final String TEXT_658 = " = new String[";
  protected final String TEXT_659 = "];" + NL + "\t\tfor(int i_";
  protected final String TEXT_660 = "=0;i_";
  protected final String TEXT_661 = " < ";
  protected final String TEXT_662 = ";i_";
  protected final String TEXT_663 = "++){" + NL + "\t\t\tint current_";
  protected final String TEXT_664 = " = i_";
  protected final String TEXT_665 = " + start_column_";
  protected final String TEXT_666 = ";" + NL + "\t\t\tif(current_";
  protected final String TEXT_667 = " <= end_column_";
  protected final String TEXT_668 = "){" + NL + "\t\t\t\tif(current_";
  protected final String TEXT_669 = " < row_";
  protected final String TEXT_670 = ".size()){" + NL + "\t\t\t\t\tString column_";
  protected final String TEXT_671 = " = row_";
  protected final String TEXT_672 = ".get(current_";
  protected final String TEXT_673 = ");" + NL + "\t\t\t\t\tif(column_";
  protected final String TEXT_674 = "!=null) {" + NL + "\t\t\t\t\t\ttemp_row_";
  protected final String TEXT_675 = "[i_";
  protected final String TEXT_676 = "] = column_";
  protected final String TEXT_677 = ";" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\ttemp_row_";
  protected final String TEXT_678 = "[i_";
  protected final String TEXT_679 = "]=\"\";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\ttemp_row_";
  protected final String TEXT_680 = "[i_";
  protected final String TEXT_681 = "]=\"\";" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\ttemp_row_";
  protected final String TEXT_682 = "[i_";
  protected final String TEXT_683 = "]=\"\";" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tboolean whetherReject_";
  protected final String TEXT_684 = " = false;" + NL + "\t\t";
  protected final String TEXT_685 = " = new ";
  protected final String TEXT_686 = "Struct();" + NL + "\t\tint curColNum_";
  protected final String TEXT_687 = " = -1;" + NL + "\t\tString curColName_";
  protected final String TEXT_688 = " = \"\";" + NL + "\t\t" + NL + "\t\ttry{";
  protected final String TEXT_689 = NL + "\t\t\tif(temp_row_";
  protected final String TEXT_690 = "[";
  protected final String TEXT_691 = "]";
  protected final String TEXT_692 = ".length() > 0) {" + NL + "\t\t\t\tcurColNum_";
  protected final String TEXT_693 = "=";
  protected final String TEXT_694 = " + start_column_";
  protected final String TEXT_695 = " + 1;" + NL + "\t\t\t\tcurColName_";
  protected final String TEXT_696 = " = \"";
  protected final String TEXT_697 = "\";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_698 = "\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_699 = ".";
  protected final String TEXT_700 = " = temp_row_";
  protected final String TEXT_701 = "[";
  protected final String TEXT_702 = "]";
  protected final String TEXT_703 = ";";
  protected final String TEXT_704 = "\t\t" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_705 = ".";
  protected final String TEXT_706 = " = ParserUtils.parseTo_Date(temp_row_";
  protected final String TEXT_707 = "[";
  protected final String TEXT_708 = "]";
  protected final String TEXT_709 = ", ";
  protected final String TEXT_710 = ");" + NL + "\t\t\t\t}catch(Exception e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_711 = NL + "\t\t\t\t\tthrow new RuntimeException(\"The cell format is not Date in ( Row. \"+(nb_line_";
  protected final String TEXT_712 = "+1)+ \" and ColumnNum. \" + curColNum_";
  protected final String TEXT_713 = " + \" )\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_714 = NL + "\t\t\t\t";
  protected final String TEXT_715 = ".";
  protected final String TEXT_716 = " = ParserUtils.parseTo_";
  protected final String TEXT_717 = "(ParserUtils.parseTo_Number(temp_row_";
  ...
  protected final String TEXT_725 = " = ParserUtils.parseTo_";
  protected final String TEXT_726 = "(ParserUtils.parseTo_Number(temp_row_";
  protected final String TEXT_727 = "[";
  protected final String TEXT_728 = "]";
  protected final String TEXT_729 = ", null, '.'==decimalChar_";
  protected final String TEXT_730 = " ? null : decimalChar_";
  protected final String TEXT_731 = "));";
  protected final String TEXT_732 = "\t\t\t\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_733 = ".";
  protected final String TEXT_734 = " = temp_row_";
  protected final String TEXT_735 = "[";
  protected final String TEXT_736 = "]";
  protected final String TEXT_737 = ".getBytes(";
  protected final String TEXT_738 = ");";
  protected final String TEXT_739 = NL + "\t\t\t\t";
  protected final String TEXT_740 = ".";
  protected final String TEXT_741 = " = ParserUtils.parseTo_";
  protected final String TEXT_742 = "(temp_row_";
  protected final String TEXT_743 = "[";
  protected final String TEXT_744 = "]";
  protected final String TEXT_745 = ");";
  protected final String TEXT_746 = NL + "\t\t\t}else{";
  protected final String TEXT_747 = NL + "\t\t\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_748 = "' in '";
  protected final String TEXT_749 = "' connection, value is invalid or this column should be nullable or have a default value.\");";
  protected final String TEXT_750 = NL + "\t\t\t\t";
  protected final String TEXT_751 = ".";
  protected final String TEXT_752 = " = ";
  protected final String TEXT_753 = ";" + NL + "\t\t\t\temptyColumnCount_";
  ...
  protected final String TEXT_760 = NL + "        if(emptyColumnCount_";
  protected final String TEXT_761 = " == ";
  protected final String TEXT_762 = "){" + NL + "        \tbreak; //if meet the empty row, there will break the iterate." + NL + "        }";
  protected final String TEXT_763 = NL + "\t\t} catch(Exception e) {" + NL + "\t\t\twhetherReject_";
  protected final String TEXT_764 = " = true;";
  protected final String TEXT_765 = NL + "\t            throw(e);";
  ...
  protected final String TEXT_775 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_776 = "+ \" column: \" + curColName_";
  protected final String TEXT_777 = " + \" (No. \" + curColNum_";
  protected final String TEXT_778 = " + \")\";" + NL + "\t\t\t\t\t";
  protected final String TEXT_779 = " = null;";
  protected final String TEXT_780 = NL + "\t\t\t\t\t System.err.println(e.getMessage());" + NL + "\t\t\t\t\t ";
