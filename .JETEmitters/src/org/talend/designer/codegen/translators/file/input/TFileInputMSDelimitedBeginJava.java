...
public class TFileInputMSDelimitedBeginJava
{
  ...
  protected final String TEXT_171 = ").toCharArray();" + NL + "}else {" + NL + "\tthrow new IllegalArgumentException(\"Row Separator must be assigned a char.\"); " + NL + "}" + NL + "\t\t" + NL + "com.talend.csv.CSVReader ";
  protected final String TEXT_172 = "csvReader";
  protected final String TEXT_173 = "=new com.talend.csv.CSVReader(new java.io.BufferedReader(new java.io.InputStreamReader( new java.io.FileInputStream(";
  protected final String TEXT_174 = "),";
  protected final String TEXT_175 = ")), ";
  protected final String TEXT_176 = ");";
  protected final String TEXT_177 = NL;
  protected final String TEXT_178 = "csvReader";
  protected final String TEXT_179 = ".setTrimWhitespace(false);" + NL;
  protected final String TEXT_180 = NL + "\ttmpcsvReader";
  protected final String TEXT_181 = ".setStoreRawRecord(true);";
  protected final String TEXT_182 = NL + NL + "if ( (rowSeparator_";
  protected final String TEXT_183 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_184 = "[0] != '\\r') )" + NL + "\t";
  protected final String TEXT_185 = "csvReader";
  protected final String TEXT_186 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_187 = "[0]);" + NL;
  protected final String TEXT_188 = NL;
  protected final String TEXT_189 = "csvReader";
  protected final String TEXT_190 = ".setQuoteChar('";
  protected final String TEXT_191 = "');" + NL;
  protected final String TEXT_192 = NL;
  protected final String TEXT_193 = "csvReader";
  protected final String TEXT_194 = ".setEscapeChar('\\\\');";
  protected final String TEXT_195 = NL;
  protected final String TEXT_196 = "csvReader";
  protected final String TEXT_197 = ".setEscapeChar(";
  protected final String TEXT_198 = "csvReader";
  protected final String TEXT_199 = ".getQuoteChar());";
  protected final String TEXT_200 = NL + "//?????doesn't work for other escapeChar" + NL + "//the default escape mode is double escape";
  protected final String TEXT_201 = NL;
  protected final String TEXT_202 = "csvReader";
  protected final String TEXT_203 = ".setEscapeChar(";
  protected final String TEXT_204 = "csvReader";
  protected final String TEXT_205 = ".getQuoteChar());";
  protected final String TEXT_206 = "\t" + NL + "String[] delim_";
  protected final String TEXT_207 = " = new String[]{";
  protected final String TEXT_208 = NL;
  protected final String TEXT_209 = NL + "};" + NL + "" + NL + "//java.io.BufferedReader reader_";
  protected final String TEXT_210 = " = new java.io.BufferedReader(new java.io.FileReader(";
  protected final String TEXT_211 = "));" + NL + "" + NL + "String tmp";
  protected final String TEXT_212 = " = \"\";";
  protected final String TEXT_213 = "      " + NL + "" + NL + "int index_";
  protected final String TEXT_214 = " = Integer.parseInt(";
  protected final String TEXT_215 = ");" + NL + "" + NL + "String[] row";
  protected final String TEXT_216 = "=null;" + NL + "  " + NL + "String temp_";
  protected final String TEXT_217 = " = null;" + NL + "" + NL + "while ( ";
  protected final String TEXT_218 = "csvReader";
  protected final String TEXT_219 = ".readNext() ) {";
  protected final String TEXT_220 = NL + "\trow";
  protected final String TEXT_221 = "=csvReader";
  protected final String TEXT_222 = ".getValues();" + NL + "\t";
  protected final String TEXT_223 = NL + "\tfor(int ii_";
  protected final String TEXT_224 = "=0;ii_";
  protected final String TEXT_225 = " < row";
  protected final String TEXT_226 = ".length;ii_";
  protected final String TEXT_227 = "++){" + NL + "\t\trow";
  protected final String TEXT_228 = "[ii_";
  protected final String TEXT_229 = "] = row";
  protected final String TEXT_230 = "[ii_";
  protected final String TEXT_231 = "].trim(); " + NL + "\t}" + NL + "\t";
  protected final String TEXT_232 = NL + "\ttmp";
  protected final String TEXT_233 = " = ";
  protected final String TEXT_234 = "csvReader";
  protected final String TEXT_235 = ".getRawRecord();" + NL + "\tfor(int i_";
  protected final String TEXT_236 = "=0; i_";
  protected final String TEXT_237 = "<delim_";
  protected final String TEXT_238 = ".length; i_";
  protected final String TEXT_239 = "++){ //NS000" + NL + "\t\tcom.talend.csv.CSVReader csvReader";
  protected final String TEXT_240 = " = new com.talend.csv.CSVReader(new java.io.BufferedReader(new java.io.InputStreamReader(" + NL + "\t\t\tnew java.io.ByteArrayInputStream(tmp";
  protected final String TEXT_241 = ".getBytes()), ";
  protected final String TEXT_242 = ")), delim_";
  protected final String TEXT_243 = "[i_";
  protected final String TEXT_244 = "].charAt(0));" + NL + "\t\tcsvReader";
  protected final String TEXT_245 = ".setTrimWhitespace(false);" + NL + "\t\tif ( (rowSeparator_";
  protected final String TEXT_246 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_247 = "[0] != '\\r') )" + NL + "\t\t\tcsvReader";
  protected final String TEXT_248 = ".setLineEnd(\"\" + rowSeparator_";
  protected final String TEXT_249 = "[0]);" + NL + "\t\t" + NL + "\t\tcsvReader";
  protected final String TEXT_250 = ".setQuoteChar('";
  protected final String TEXT_251 = "');";
  protected final String TEXT_252 = NL + "\t\tcsvReader";
  protected final String TEXT_253 = ".setEscapeChar('\\\\');";
  protected final String TEXT_254 = NL + "\t\tcsvReader";
  protected final String TEXT_255 = ".setEscapeChar(csvReader";
  protected final String TEXT_256 = ".getQuoteChar());";
  protected final String TEXT_257 = NL + "\t\t//?????doesn't work for other escapeChar" + NL + "\t\tcsvReader";
  protected final String TEXT_258 = ".setEscapeChar(csvReader";
  protected final String TEXT_259 = ".getQuoteChar());";
  protected final String TEXT_260 = NL;
  protected final String TEXT_261 = NL + "\t";
  protected final String TEXT_262 = " = null;";
  protected final String TEXT_263 = "\t\t";
  protected final String TEXT_264 = NL + NL + "\t\tif(csvReader";
  protected final String TEXT_265 = ".readNext()==false) {" + NL + "\t\t\tcsvReader";
  protected final String TEXT_266 = ".close();" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\trow";
  protected final String TEXT_267 = " = csvReader";
  protected final String TEXT_268 = ".getValues();" + NL + "    \t";
  protected final String TEXT_269 = NL + "    \tfor(int ii_";
  protected final String TEXT_270 = "=0;ii_";
  protected final String TEXT_271 = " < row";
  protected final String TEXT_272 = ".length;ii_";
  protected final String TEXT_273 = "++){" + NL + "    \t\trow";
  protected final String TEXT_274 = "[ii_";
  protected final String TEXT_275 = "] = row";
  protected final String TEXT_276 = "[ii_";
  protected final String TEXT_277 = "].trim(); " + NL + "    \t}" + NL + "    \t";
  protected final String TEXT_278 = NL + "\t\tif (row";
  protected final String TEXT_279 = " == null" + NL + "\t\t\t\t|| row";
  protected final String TEXT_280 = ".length <= index_";
  protected final String TEXT_281 = ") {" + NL + "\t\t\tcontinue;" + NL + "\t\t}";
  protected final String TEXT_282 = NL + "\t\ttry{";
  protected final String TEXT_283 = NL + "\t";
  protected final String TEXT_284 = "if((row";
  protected final String TEXT_285 = ".length == 0) ? (\"\".equals(";
  protected final String TEXT_286 = ")) : " + NL + "\t(row";
  protected final String TEXT_287 = "[index_";
  protected final String TEXT_288 = "].equals(";
  protected final String TEXT_289 = ")";
  protected final String TEXT_290 = ")){";
  protected final String TEXT_291 = NL + "\t\tkey_";
  protected final String TEXT_292 = "_";
  protected final String TEXT_293 = "++;";
  protected final String TEXT_294 = NL + "\t\tkey_";
  protected final String TEXT_295 = "_";
  protected final String TEXT_296 = " = (row";
  protected final String TEXT_297 = ".length <= ";
  protected final String TEXT_298 = ") ? \"\" : row";
  protected final String TEXT_299 = "[";
  protected final String TEXT_300 = "];";
  protected final String TEXT_301 = NL + "\t\tif((count_";
  protected final String TEXT_302 = "_";
  protected final String TEXT_303 = " < lowBound_";
  protected final String TEXT_304 = "_";
  protected final String TEXT_305 = ") || (count_";
  protected final String TEXT_306 = "_";
  protected final String TEXT_307 = " > highBound_";
  protected final String TEXT_308 = "_";
  protected final String TEXT_309 = ")){" + NL + "\t\t\tthrow new Exception(\"Data error in file: The cardinality for \" + ";
  protected final String TEXT_310 = " + \" is ";
  protected final String TEXT_311 = ", but we have found \" + count_";
  protected final String TEXT_312 = "_";
  protected final String TEXT_313 = " + \".\");//thow exception............" + NL + "\t\t}" + NL + "\t\tcount_";
  protected final String TEXT_314 = "_";
  protected final String TEXT_315 = " = 0;";
  protected final String TEXT_316 = NL + "\t\tcount_";
  protected final String TEXT_317 = "_";
  protected final String TEXT_318 = "++;" + NL + "\t\tif((count_";
  protected final String TEXT_319 = "_";
  protected final String TEXT_320 = " < lowBound_";
  protected final String TEXT_321 = "_";
  protected final String TEXT_322 = ") || (count_";
  protected final String TEXT_323 = "_";
  protected final String TEXT_324 = " > highBound_";
  protected final String TEXT_325 = "_";
  protected final String TEXT_326 = ")){" + NL + "\t\t\tthrow new Exception(\"Data error in file: The cardinality for \" + ";
  protected final String TEXT_327 = " + \" is ";
  protected final String TEXT_328 = ", but we have found \" + count_";
  protected final String TEXT_329 = "_";
  protected final String TEXT_330 = " + \".\");//thow exception............" + NL + "\t\t}";
  protected final String TEXT_331 = NL + "\t\t";
  protected final String TEXT_332 = " = new ";
  protected final String TEXT_333 = "Struct();";
  protected final String TEXT_334 = NL + "\t\t";
  protected final String TEXT_335 = ".";
  protected final String TEXT_336 = " = String.valueOf(key_";
  protected final String TEXT_337 = "_";
  protected final String TEXT_338 = ");";
  protected final String TEXT_339 = NL + "\t\t";
  protected final String TEXT_340 = ".";
  protected final String TEXT_341 = " = (row";
  protected final String TEXT_342 = ".length <= ";
  protected final String TEXT_343 = ") ? \"\" : row";
  protected final String TEXT_344 = "[";
  protected final String TEXT_345 = "];";
  protected final String TEXT_346 = NL + "\t\ttemp_";
  protected final String TEXT_347 = " = String.valueOf(key_";
  protected final String TEXT_348 = "_";
  protected final String TEXT_349 = ");";
  protected final String TEXT_350 = NL + "\t\ttemp_";
  protected final String TEXT_351 = " = (row";
  protected final String TEXT_352 = ".length <= ";
  protected final String TEXT_353 = ") ? \"\" : row";
  protected final String TEXT_354 = "[";
  protected final String TEXT_355 = "];";
  protected final String TEXT_356 = NL + "\t\tif(temp_";
  protected final String TEXT_357 = ".length() > 0) {";
  protected final String TEXT_358 = NL + "\t\t\t";
  protected final String TEXT_359 = ".";
  protected final String TEXT_360 = " = temp_";
  protected final String TEXT_361 = ".getBytes(";
  protected final String TEXT_362 = ");";
  protected final String TEXT_363 = "\t\t\t";
  protected final String TEXT_364 = ".";
  protected final String TEXT_365 = " = ParserUtils.parseTo_Date(temp_";
  protected final String TEXT_366 = ", ";
  protected final String TEXT_367 = ",false);";
  protected final String TEXT_368 = NL + "\t\t\t";
  protected final String TEXT_369 = ".";
  protected final String TEXT_370 = " = ParserUtils.parseTo_Date(temp_";
  protected final String TEXT_371 = ", ";
  protected final String TEXT_372 = ");";
  protected final String TEXT_373 = NL + "\t\t\t";
  protected final String TEXT_374 = ".";
  protected final String TEXT_375 = " = ParserUtils.parseTo_";
  protected final String TEXT_376 = "(ParserUtils.parseTo_Number(temp_";
  protected final String TEXT_377 = ", ";
  protected final String TEXT_378 = ", ";
  protected final String TEXT_379 = "));";
  protected final String TEXT_380 = NL + "\t\t\t";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = " = ParserUtils.parseTo_";
  protected final String TEXT_383 = "(temp_";
  protected final String TEXT_384 = ");";
  protected final String TEXT_385 = NL + "\t\t} else {\t\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_387 = "' in '";
  protected final String TEXT_388 = "' connection, value is invalid or this column should be nullable or have a default value.\");";
  protected final String TEXT_389 = "\t\t\t";
  protected final String TEXT_390 = ".";
  protected final String TEXT_391 = " = ";
  protected final String TEXT_392 = ";";
  protected final String TEXT_393 = "\t\t}";
  protected final String TEXT_394 = NL + "\t\tif(csvReader";
  protected final String TEXT_395 = "!=null) {" + NL + "\t\t\tcsvReader";
  protected final String TEXT_396 = ".close();" + NL + "\t\t}" + NL + "\t\tbreak;";
  protected final String TEXT_397 = NL + "\t}";
  protected final String TEXT_398 = NL + "\t} catch (Exception e) {";
  protected final String TEXT_399 = NL + "            throw(e);";
  protected final String TEXT_400 = NL + "        System.err.println(e.getMessage());";
