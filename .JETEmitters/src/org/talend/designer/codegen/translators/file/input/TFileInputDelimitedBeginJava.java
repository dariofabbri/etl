...
public class TFileInputDelimitedBeginJava
{
  ...
  protected final String TEXT_372 = ";\t\t" + NL + "\t\t\t\tcom.talend.csv.CSVReader csvReader";
  ...
  protected final String TEXT_395 = "=new com.talend.csv.CSVReader(zis_";
  ...
  protected final String TEXT_405 = "=new com.talend.csv.CSVReader((java.io.InputStream)filename_";
  protected final String TEXT_406 = ", fieldSeparator_";
  protected final String TEXT_407 = "[0], ";
  protected final String TEXT_408 = ");" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_409 = "=new com.talend.csv.CSVReader(new java.io.BufferedReader(new java.io.InputStreamReader(" + NL + "\t\t                \t\tnew java.io.FileInputStream(String.valueOf(filename_";
  ...
  protected final String TEXT_429 = ".setQuoteChar(textEnclosure_";
  protected final String TEXT_430 = "[0]); " + NL + "\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t            \t\t\t\tcsvReader";
  protected final String TEXT_432 = ".setEscapeChar('\\\\');" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t            \t\t\t\tcsvReader";
  protected final String TEXT_434 = ".setEscapeChar(csvReader";
  protected final String TEXT_435 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_436 = NL + "\t            \t\t\t\t//?????doesn't work for other escapeChar" + NL + "\t            \t\t\t\t//the default escape mode is double escape" + NL + "\t            \t\t\t\tcsvReader";
  protected final String TEXT_437 = ".setEscapeChar(csvReader";
  protected final String TEXT_438 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_439 = " " + NL + "\t\t        \t\t\tString escapeChar1_";
  protected final String TEXT_440 = " = ";
  protected final String TEXT_441 = ";          " + NL + "\t\t        \t\t\tchar escapeChar_";
  protected final String TEXT_442 = "[] = null;" + NL + "\t\t\t        " + NL + "\t\t\t\t\t        if(((String)escapeChar1_";
  protected final String TEXT_443 = ").length() > 0 ){ " + NL + "\t\t\t\t\t        \tescapeChar_";
  protected final String TEXT_444 = " = ((String)escapeChar1_";
  protected final String TEXT_445 = ").toCharArray(); " + NL + "\t\t\t\t\t  \t\t}else { " + NL + "\t\t        \t\t\t    throw new IllegalArgumentException(\"Escape Char must be assigned a char.\"); " + NL + "\t\t        \t\t\t}" + NL + "\t\t       \t\t\t\tif(escapeChar_";
  protected final String TEXT_446 = "[0] == '\\\\'){" + NL + "\t\t       \t\t\t\t\tcsvReader";
  protected final String TEXT_447 = ".setEscapeChar('\\\\');" + NL + "\t\t       \t\t\t\t}else if(escapeChar_";
  protected final String TEXT_448 = "[0] ==";
  protected final String TEXT_449 = "'";
  protected final String TEXT_450 = "'";
  protected final String TEXT_451 = "textEnclosure_";
  protected final String TEXT_452 = "[0]";
  protected final String TEXT_453 = "){" + NL + "\t\t       \t\t\t\t\tcsvReader";
  protected final String TEXT_454 = ".setEscapeChar(csvReader";
  protected final String TEXT_455 = ".getQuoteChar());" + NL + "\t\t       \t\t\t\t} else {" + NL + "\t\t       \t\t\t\t\t//the default escape mode is double escape" + NL + "\t\t       \t\t\t\t\tcsvReader";
  protected final String TEXT_456 = ".setEscapeChar(csvReader";
  protected final String TEXT_457 = ".getQuoteChar());" + NL + "\t\t       \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_458 = "      " + NL + "\t\t" + NL + "\t\t\t" + NL + "\t\t\t\t\t\tif(footer_";
  protected final String TEXT_459 = " > 0){" + NL + "\t\t\t\t\t\tfor(totalLine";
  protected final String TEXT_460 = "=0;totalLine";
  protected final String TEXT_461 = " < ";
  protected final String TEXT_462 = "; totalLine";
  protected final String TEXT_463 = "++){" + NL + "\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_464 = ".readNext();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcsvReader";
  protected final String TEXT_465 = ".setSkipEmptyRecords(";
  protected final String TEXT_466 = ");" + NL + "\t\t\t            while (csvReader";
  protected final String TEXT_467 = ".readNext()) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_468 = NL + "\t\t\t\t\t\t\t\trow";
  protected final String TEXT_469 = "=csvReader";
  protected final String TEXT_470 = ".getValues();" + NL + "\t\t\t\t\t\t\t\tif(!(row";
  protected final String TEXT_471 = ".length == 1 && (\"\\015\").equals(row";
  protected final String TEXT_472 = "[0]))){//empty line when row separator is '\\n'" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_473 = NL + "\t                " + NL + "\t                \t\ttotalLine";
  protected final String TEXT_474 = "++;" + NL + "\t                " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_475 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_476 = NL + "\t                " + NL + "\t\t\t            }" + NL + "\t            \t\tint lastLineTemp";
  protected final String TEXT_477 = " = totalLine";
  protected final String TEXT_478 = " - footer_";
  protected final String TEXT_479 = "   < 0? 0 : totalLine";
  protected final String TEXT_480 = " - footer_";
  protected final String TEXT_481 = " ;" + NL + "\t            \t\tif(lastLine";
  protected final String TEXT_482 = " > 0){" + NL + "\t                \t\tlastLine";
  protected final String TEXT_483 = " = lastLine";
  protected final String TEXT_484 = " < lastLineTemp";
  protected final String TEXT_485 = " ? lastLine";
  protected final String TEXT_486 = " : lastLineTemp";
  protected final String TEXT_487 = "; " + NL + "\t            \t\t}else {" + NL + "\t                \t\tlastLine";
  protected final String TEXT_488 = " = lastLineTemp";
  protected final String TEXT_489 = ";" + NL + "\t            \t\t}" + NL + "\t         " + NL + "\t\t\t          \tcsvReader";
  protected final String TEXT_490 = ".close();" + NL + "\t\t\t\t        if(filename_";
  protected final String TEXT_491 = " instanceof java.io.InputStream){" + NL + "\t\t\t\t \t\t\tcsvReader";
  protected final String TEXT_492 = "=new com.talend.csv.CSVReader((java.io.InputStream)filename_";
  protected final String TEXT_493 = ", fieldSeparator_";
  protected final String TEXT_494 = "[0], ";
  protected final String TEXT_495 = ");" + NL + "\t\t        \t\t}else{" + NL + "\t\t\t\t \t\t\tcsvReader";
  protected final String TEXT_496 = "=new com.talend.csv.CSVReader(new java.io.BufferedReader(new java.io.InputStreamReader(" + NL + "\t\t\t\t          \tnew java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_497 = ")),";
  protected final String TEXT_498 = ")), fieldSeparator_";
  protected final String TEXT_499 = "[0]);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcsvReader";
  protected final String TEXT_500 = ".setTrimWhitespace(false);" + NL + "\t\t\t\t\t\tif ( (rowSeparator_";
  protected final String TEXT_501 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_502 = "[0] != '\\r') )\t" + NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_503 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_504 = "[0]);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_505 = NL + "\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_506 = ".setQuoteChar('";
  protected final String TEXT_507 = "');" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_508 = NL + "\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_509 = ".setQuoteChar(textEnclosure_";
  protected final String TEXT_510 = "[0]);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_511 = NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_512 = ".setEscapeChar('\\\\');" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_513 = NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_514 = ".setEscapeChar(csvReader";
  protected final String TEXT_515 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_516 = NL + "\t        \t\t\t\t//?????doesn't work for other escapeChar" + NL + "\t        \t\t\t\t//the default escape mode is double escape" + NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_517 = ".setEscapeChar(csvReader";
  protected final String TEXT_518 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_519 = " " + NL + "\t       \t\t\t\t\tif(escapeChar_";
  protected final String TEXT_520 = "[0] == '\\\\'){" + NL + "\t       \t\t\t\t\t\tcsvReader";
  protected final String TEXT_521 = ".setEscapeChar('\\\\');" + NL + "\t       \t\t\t\t\t}else if(escapeChar_";
  protected final String TEXT_522 = "[0] == ";
  protected final String TEXT_523 = "'";
  protected final String TEXT_524 = "'";
  protected final String TEXT_525 = "textEnclosure_";
  protected final String TEXT_526 = "[0]";
  protected final String TEXT_527 = "){" + NL + "\t       \t\t\t\t\t\tcsvReader";
  protected final String TEXT_528 = ".setEscapeChar(csvReader";
  protected final String TEXT_529 = ".getQuoteChar());" + NL + "\t       \t\t\t\t\t} else {" + NL + "\t       \t\t\t\t\t\t//the default escape mode is double escape" + NL + "\t        \t\t\t\t\tcsvReader";
  protected final String TEXT_530 = ".setEscapeChar(csvReader";
  protected final String TEXT_531 = ".getQuoteChar());" + NL + "\t       \t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_532 = "  " + NL + "\t        \t\t}" + NL + "\t        " + NL + "\t\t\t        if(limit";
  protected final String TEXT_533 = " != 0){" + NL + "\t\t\t        \tfor(currentLine";
  protected final String TEXT_534 = "=0;currentLine";
  protected final String TEXT_535 = " < ";
  protected final String TEXT_536 = ";currentLine";
  protected final String TEXT_537 = "++){" + NL + "\t\t\t        \t\tcsvReader";
  protected final String TEXT_538 = ".readNext();" + NL + "\t\t\t        \t}" + NL + "\t\t\t        }" + NL + "\t\t\t        csvReader";
  protected final String TEXT_539 = ".setSkipEmptyRecords(";
  protected final String TEXT_540 = ");" + NL + "\t        " + NL + "\t    \t\t} catch(Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_541 = NL + "\t\t\t\t\t\tthrow e;" + NL + "\t\t\t\t\t";
  protected final String TEXT_542 = NL + "\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_543 = NL + "\t    \t\t}//TD110 end" + NL + "\t        " + NL + "\t        \twhile ( limit";
  protected final String TEXT_544 = " != 0 && csvReader";
  protected final String TEXT_545 = "!=null && csvReader";
  protected final String TEXT_546 = ".readNext() ) { " + NL + "\t        " + NL + "\t\t        \trow";
  protected final String TEXT_547 = "=csvReader";
  protected final String TEXT_548 = ".getValues();" + NL + "\t        \t" + NL + "\t\t\t\t\t";
  protected final String TEXT_549 = NL + "\t        \t\t\tif(row";
  protected final String TEXT_550 = ".length == 1 && (\"\\015\").equals(row";
  protected final String TEXT_551 = "[0])){//empty line when row separator is '\\n'" + NL + "\t        \t\t\t\tcontinue;" + NL + "\t        \t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_552 = NL + "\t        \t" + NL + "\t        \t" + NL + "\t        \t\tcurrentLine";
  protected final String TEXT_553 = "++;" + NL + "\t            " + NL + "\t\t            if(lastLine";
  protected final String TEXT_554 = " > -1 && currentLine";
  protected final String TEXT_555 = " > lastLine";
  protected final String TEXT_556 = ") {" + NL + "\t\t                break;" + NL + "\t    \t        }" + NL + "\t        \t    outputLine";
  protected final String TEXT_557 = "++;" + NL + "\t            \tif (limit";
  protected final String TEXT_558 = " > 0 && outputLine";
  protected final String TEXT_559 = " > limit";
  protected final String TEXT_560 = ") {" + NL + "\t                \tbreak;" + NL + "\t            \t}  " + NL + "\t                                                                      " + NL + "\t\t\t\t\t";
  protected final String TEXT_561 = NL + "\t    \t\t\t\t\t\t\t";
  protected final String TEXT_562 = " = null;\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_563 = NL + "\t\t\t\t\t\t\t\tboolean whetherReject_";
  protected final String TEXT_564 = " = false;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_565 = " = new ";
  protected final String TEXT_566 = "Struct();" + NL + "\t\t\t\t\t\t\t\ttry {\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_567 = " " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_568 = " = null; " + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_569 = NL + "\t    \t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\t        whetherReject_";
  protected final String TEXT_570 = " = true;" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_571 = NL + "            \t\t\t\t\t\t\tthrow(e);" + NL + "            \t\t\t\t\t\t";
  protected final String TEXT_572 = NL + "\t\t\t\t\t\t                    ";
  protected final String TEXT_573 = " = new ";
  protected final String TEXT_574 = "Struct();" + NL + "                \t\t\t\t\t\t\t";
  ...
  protected final String TEXT_584 = NL + "\t    \t\t\t\t\t\t}" + NL + "\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_585 = NL + "\t\t\t\t\t\t\t\t\t\tif(!whetherReject_";
  ...
  protected final String TEXT_590 = "Struct();" + NL + "\t             \t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
