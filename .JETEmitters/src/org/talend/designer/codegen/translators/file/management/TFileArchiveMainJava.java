...
public class TFileArchiveMainJava
{
  ...
  protected final String TEXT_57 = "     " + NL + "      org.apache.commons.compress.archivers.zip.ZipArchiveOutputStream out_";
  ...
  protected final String TEXT_69 = " = new org.apache.commons.compress.archivers.zip.ZipArchiveOutputStream(new java.io.BufferedOutputStream(output_stream_";
  ...
  protected final String TEXT_81 = ")));" + NL + "            org.apache.commons.compress.archivers.zip.ZipArchiveEntry entry = new org.apache.commons.compress.archivers.zip.ZipArchiveEntry(list_";
  ...
  protected final String TEXT_87 = ".putArchiveEntry(entry);   " + NL + "           " + NL + "            int readLen_";
  ...
  protected final String TEXT_96 = ".closeArchiveEntry();" + NL + "            out_";
  protected final String TEXT_97 = ".flush();    " + NL + "            in_";
  protected final String TEXT_98 = ".close();       " + NL + "        }        " + NL + "      }" + NL + "      " + NL + "      if (out_";
  protected final String TEXT_99 = " != null)  out_";
  protected final String TEXT_100 = ".close();" + NL + "      globalMap.put(\"";
  protected final String TEXT_101 = "_ARCHIVE_FILEPATH\",zipFile_";
  protected final String TEXT_102 = ");" + NL + "      globalMap.put(\"";
  protected final String TEXT_103 = "_ARCHIVE_FILENAME\",(";
  protected final String TEXT_104 = ").contains(\"\\\\\")?" + NL + "    (";
  protected final String TEXT_105 = ").substring(((";
  protected final String TEXT_106 = ").lastIndexOf(\"\\\\\")+2)): (";
  protected final String TEXT_107 = ").substring(((";
  protected final String TEXT_108 = ").lastIndexOf(\"/\"))+1));";
