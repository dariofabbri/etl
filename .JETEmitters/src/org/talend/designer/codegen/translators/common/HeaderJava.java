...
public class HeaderJava
{
  ...
  protected final String TEXT_129 = "_onSubJobError(exception, errorComponent, globalMap);" + NL + "\t\t\t}" + NL + "\t\t\t";
