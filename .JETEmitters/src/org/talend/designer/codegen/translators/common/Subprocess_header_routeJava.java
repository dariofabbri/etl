...
public class Subprocess_header_routeJava
{
  ...
  protected final String TEXT_1 = NL + "/**" + NL + "* please initial uri map first before using the returned RouteBuilder" + NL + "* @return RouteBuilder" + NL + "*/" + NL + "public RouteBuilder route() {";
