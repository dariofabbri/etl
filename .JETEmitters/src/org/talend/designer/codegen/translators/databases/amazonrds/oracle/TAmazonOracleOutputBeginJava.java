...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_243 = ".createStatement();";
  protected final String TEXT_244 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_245 = ".execute(\"";
  protected final String TEXT_246 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_266 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_296 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_305 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_306 = " = conn_";
  protected final String TEXT_307 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_308 = ".executeUpdate(\"";
  protected final String TEXT_309 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_310 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_311 = " += rsTruncCount_";
  protected final String TEXT_312 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_313 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_314 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_315 = ".close();            ";
  protected final String TEXT_316 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_317 = " = conn_";
  protected final String TEXT_318 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_319 = " = stmtTruncCount_";
  protected final String TEXT_320 = ".executeQuery(\"";
  protected final String TEXT_321 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_322 = " = conn_";
  protected final String TEXT_323 = ".createStatement();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_328 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_329 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_330 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_348 = ".prepareStatement(insert_";
  protected final String TEXT_349 = ");";
  protected final String TEXT_350 = NL + "                        ";
  protected final String TEXT_351 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_352 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_353 = " = conn_";
  protected final String TEXT_354 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_355 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_356 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_357 = ",insert_";
  protected final String TEXT_358 = ",keyPsmt_";
  ...
  protected final String TEXT_376 = ".prepareStatement(update_";
  protected final String TEXT_377 = ");" + NL + "\t    ";
  protected final String TEXT_378 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_379 = " = conn_";
  protected final String TEXT_380 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_387 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_388 = " = new StringBuffer(insert_";
  protected final String TEXT_389 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_390 = ".insert(insert_";
  protected final String TEXT_391 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_392 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_393 = " =insertStringBuffer_";
  protected final String TEXT_394 = ".toString(); ";
  protected final String TEXT_395 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_396 = " = conn_";
  protected final String TEXT_397 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_403 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_404 = " = new StringBuffer(update_";
  protected final String TEXT_405 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_406 = ".insert(update_";
  protected final String TEXT_407 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_408 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_409 = " =updateStringBuffer_";
  protected final String TEXT_410 = ".toString(); ";
  protected final String TEXT_411 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_412 = " = conn_";
  protected final String TEXT_413 = ".prepareStatement(update_";
  ...
  protected final String TEXT_428 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_434 = ") VALUES (";
  protected final String TEXT_435 = ")\";" + NL + "\t   \t";
  protected final String TEXT_436 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_437 = " = new StringBuffer(insert_";
  protected final String TEXT_438 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_439 = ".insert(insert_";
  protected final String TEXT_440 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_441 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_442 = " =insertStringBuffer_";
  protected final String TEXT_443 = ".toString(); ";
  protected final String TEXT_444 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".prepareStatement(insert_";
  protected final String TEXT_447 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_448 = NL + "\t    String delete_";
  protected final String TEXT_449 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_450 = " + \" WHERE ";
  protected final String TEXT_451 = "\";" + NL + "\t    ";
  protected final String TEXT_452 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_453 = " = new StringBuffer(delete_";
  protected final String TEXT_454 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_455 = ".insert(delete_";
  protected final String TEXT_456 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_457 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_458 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_462 = ".prepareStatement(delete_";
  protected final String TEXT_463 = ");" + NL + "\t    ";
  protected final String TEXT_464 = NL + "        StringBuffer query_";
  protected final String TEXT_465 = " = null;" + NL + "\t   ";
  protected final String TEXT_466 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_467 = " = insert_";
