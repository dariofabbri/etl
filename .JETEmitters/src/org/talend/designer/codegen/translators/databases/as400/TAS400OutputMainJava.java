...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_245 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_300 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_350 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_391 = " = false;";
  ...
  protected final String TEXT_406 = NL + "                insertedCount_";
  protected final String TEXT_407 = " = insertedCount_";
  protected final String TEXT_408 = " + pstmt_";
  protected final String TEXT_409 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_410 = "++;" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_422 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_423 = ";";
  protected final String TEXT_424 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_425 = NL + "            }";
  protected final String TEXT_426 = NL + "\t\t    try {";
  protected final String TEXT_427 = NL + "                    ";
  protected final String TEXT_428 = NL + "                        query_";
  protected final String TEXT_429 = " = ";
  protected final String TEXT_430 = ";";
  protected final String TEXT_431 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_432 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_445 = NL + "                        query_";
  protected final String TEXT_446 = " = ";
  protected final String TEXT_447 = ";";
  protected final String TEXT_448 = NL + "                globalMap.put(\"";
  protected final String TEXT_449 = "_QUERY\", query_";
  protected final String TEXT_450 = ".toString().trim());";
  protected final String TEXT_451 = NL + "                updatedCount_";
  protected final String TEXT_452 = " = updatedCount_";
  protected final String TEXT_453 = " + pstmt_";
  protected final String TEXT_454 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_455 = "++;" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_456 = " = true;";
  protected final String TEXT_457 = NL + "                    throw(e);";
  protected final String TEXT_458 = NL + "                        ";
  protected final String TEXT_459 = " = new ";
  protected final String TEXT_460 = "Struct();";
  ...
  protected final String TEXT_467 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_468 = ";";
  protected final String TEXT_469 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_470 = NL + "            }";
  protected final String TEXT_471 = NL + "\t\t\t\t\t";
  protected final String TEXT_472 = NL + "                    \t";
  protected final String TEXT_473 = NL + "                    ";
  protected final String TEXT_474 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_475 = " = pstmt_";
  protected final String TEXT_476 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_477 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_478 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_479 = " = rs_";
  protected final String TEXT_480 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_481 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_482 = NL + "                        ";
  protected final String TEXT_483 = NL + "                            query_";
  protected final String TEXT_484 = " = ";
  protected final String TEXT_485 = ";";
  protected final String TEXT_486 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_487 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_495 = NL + "\t                        query_";
  ...
  protected final String TEXT_503 = NL + "                    globalMap.put(\"";
  protected final String TEXT_504 = "_QUERY\", query_";
  protected final String TEXT_505 = ".toString().trim());";
  protected final String TEXT_506 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_507 = " = updatedCount_";
  protected final String TEXT_508 = " + pstmtUpdate_";
  protected final String TEXT_509 = ".executeUpdate();" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_510 = " = true;";
  protected final String TEXT_511 = NL + "                        throw(e);";
  protected final String TEXT_512 = NL + "                            ";
  protected final String TEXT_513 = " = new ";
  protected final String TEXT_514 = "Struct();";
  ...
  protected final String TEXT_521 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_522 = ";";
  protected final String TEXT_523 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_524 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_538 = NL + "                    insertedCount_";
  protected final String TEXT_539 = " = insertedCount_";
  protected final String TEXT_540 = " + pstmtInsert_";
  protected final String TEXT_541 = ".executeUpdate();" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_555 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_556 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_557 = "++;" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_558 = NL + "    \t    int updateFlag_";
  protected final String TEXT_559 = "=0;" + NL + "            try {" + NL + "    \t    ";
  ...
  protected final String TEXT_584 = "\t" + NL + "                updateFlag_";
  protected final String TEXT_585 = "=pstmtUpdate_";
  protected final String TEXT_586 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_587 = " = updatedCount_";
  protected final String TEXT_588 = "+updateFlag_";
  protected final String TEXT_589 = ";" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_590 = " = true;";
  protected final String TEXT_591 = NL + "                    throw(e);";
  ...
  protected final String TEXT_601 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_602 = ";";
  protected final String TEXT_603 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_604 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_605 = " == 0) {" + NL + "            \ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_606 = NL + "\t\t\t\tquery_";
  protected final String TEXT_607 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_608 = NL + "                        ";
  protected final String TEXT_609 = NL + "                            query_";
  protected final String TEXT_610 = " = ";
  protected final String TEXT_611 = ";";
  protected final String TEXT_612 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_622 = " = insertedCount_";
  protected final String TEXT_623 = " + pstmtInsert_";
  protected final String TEXT_624 = ".executeUpdate();" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_625 = " = true;";
  protected final String TEXT_626 = NL + "                        throw(e);";
  ...
  protected final String TEXT_639 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_655 = NL + "                deletedCount_";
  protected final String TEXT_656 = " = deletedCount_";
  protected final String TEXT_657 = " + pstmt_";
  protected final String TEXT_658 = ".executeUpdate();" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_673 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_674 = "++;" + NL + "    \t";
  protected final String TEXT_675 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_686 = NL + "                    commitCounter_";
  protected final String TEXT_687 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_688 = " <= commitCounter_";
  protected final String TEXT_689 = ") {                " + NL + "                        conn_";
  protected final String TEXT_690 = ".commit();                \t" + NL + "                        commitCounter_";
