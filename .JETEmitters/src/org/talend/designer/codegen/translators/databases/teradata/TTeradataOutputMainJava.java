...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_399 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = ", pstmt_";
  protected final String TEXT_402 = ", ";
  protected final String TEXT_403 = ", \"";
  protected final String TEXT_404 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_405 = NL + "                globalMap.put(\"";
  protected final String TEXT_406 = "_QUERY\", query_";
  protected final String TEXT_407 = ".toString().trim());";
  ...
  protected final String TEXT_415 = NL + "    \t\t////////////////////////////" + NL + "            try {" + NL + "                insertedCount_";
  ...
  protected final String TEXT_419 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_420 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_421 = " = true;";
  protected final String TEXT_422 = NL + "                    throw(e_";
  ...
  protected final String TEXT_436 = ".errorMessage = e_";
  protected final String TEXT_437 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_438 = ";";
  protected final String TEXT_439 = NL + "                        System.err.print(e_";
  protected final String TEXT_440 = ".getMessage());";
  ...
  protected final String TEXT_474 = NL + "    \t\t//////////////////////////////////////" + NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_478 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_479 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_480 = " = true;";
  protected final String TEXT_481 = NL + "                    throw(e_";
  protected final String TEXT_482 = ");";
  protected final String TEXT_483 = NL + "                        ";
  protected final String TEXT_484 = " = new ";
  protected final String TEXT_485 = "Struct();";
  protected final String TEXT_486 = NL + "                            ";
  protected final String TEXT_487 = ".";
  protected final String TEXT_488 = " = ";
  protected final String TEXT_489 = ".";
  protected final String TEXT_490 = ";";
  protected final String TEXT_491 = NL + "                        rejectedCount_";
  protected final String TEXT_492 = " = rejectedCount_";
  protected final String TEXT_493 = " + 1;";
  protected final String TEXT_494 = NL + "                        ";
  protected final String TEXT_495 = ".errorMessage = e_";
  protected final String TEXT_496 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_497 = ";";
  protected final String TEXT_498 = NL + "                        System.err.print(e_";
  protected final String TEXT_499 = ".getMessage());";
  ...
  protected final String TEXT_505 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_506 = " = pstmt_";
  protected final String TEXT_507 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_508 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_509 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_510 = " = rs_";
  protected final String TEXT_511 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_517 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_518 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_519 = ".";
  protected final String TEXT_520 = ", pstmtUpdate_";
  ...
  protected final String TEXT_536 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_537 = " = updatedCount_";
  protected final String TEXT_538 = " + pstmtUpdate_";
  protected final String TEXT_539 = ".executeUpdate();" + NL + "    \t\t\t} catch(Exception e_";
  protected final String TEXT_540 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_541 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_542 = NL + "    \t                throw(e_";
  ...
  protected final String TEXT_554 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_555 = ".errorMessage = e_";
  protected final String TEXT_556 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_557 = ";" + NL + "    \t                    ";
  protected final String TEXT_558 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_559 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_560 = NL + "    \t\t\t}" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_577 = ".executeUpdate();" + NL + "    \t\t\t} catch(Exception e_";
  protected final String TEXT_578 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_579 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_580 = NL + "    \t                throw(e_";
  protected final String TEXT_581 = ");" + NL + "    \t                ";
  protected final String TEXT_582 = NL + "                            ";
  protected final String TEXT_583 = " = new ";
  protected final String TEXT_584 = "Struct();";
  protected final String TEXT_585 = NL + "    \t                        ";
  protected final String TEXT_586 = ".";
  protected final String TEXT_587 = " = ";
  protected final String TEXT_588 = ".";
  protected final String TEXT_589 = ";" + NL + "    \t                        ";
  protected final String TEXT_590 = NL + "    \t                    rejectedCount_";
  protected final String TEXT_591 = " = rejectedCount_";
  protected final String TEXT_592 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_593 = ".errorMessage = e_";
  protected final String TEXT_594 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_595 = ";" + NL + "    \t                    ";
  protected final String TEXT_596 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_597 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_598 = NL + "    \t\t\t}" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_599 = "++;" + NL + "    \t\t";
  protected final String TEXT_600 = NL + "    \t    int updateFlag_";
  protected final String TEXT_601 = "=0;" + NL + "    \t    ";
  protected final String TEXT_602 = NL + "                    ";
  protected final String TEXT_603 = NL + "                        query_";
  protected final String TEXT_604 = " = ";
  protected final String TEXT_605 = ";";
  protected final String TEXT_606 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_607 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_625 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_626 = "=pstmtUpdate_";
  protected final String TEXT_627 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_628 = " = updatedCount_";
  protected final String TEXT_629 = " + updateFlag_";
  protected final String TEXT_630 = ";" + NL + "        \t} catch(Exception e_";
  protected final String TEXT_631 = ") {" + NL + "        \t    whetherReject_";
  protected final String TEXT_632 = " = true;" + NL + "        \t    ";
  protected final String TEXT_633 = NL + "                    throw(e_";
  ...
  protected final String TEXT_647 = ".errorMessage = e_";
  protected final String TEXT_648 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_649 = ";";
  protected final String TEXT_650 = NL + "                        System.err.print(e_";
  protected final String TEXT_651 = ".getMessage());";
  protected final String TEXT_652 = NL + "        \t}" + NL + "        \tif(updateFlag_";
  protected final String TEXT_653 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_654 = NL + "\t\t\t\tquery_";
  protected final String TEXT_655 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_656 = NL + "                        ";
  protected final String TEXT_657 = NL + "                            query_";
  protected final String TEXT_658 = " = ";
  protected final String TEXT_659 = ";";
  protected final String TEXT_660 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_669 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_670 = " = insertedCount_";
  protected final String TEXT_671 = " + pstmtInsert_";
  protected final String TEXT_672 = ".executeUpdate();" + NL + "        \t\t} catch(Exception e_";
  protected final String TEXT_673 = ") {" + NL + "        \t\t    whetherReject_";
  protected final String TEXT_674 = " = true;" + NL + "        \t\t    ";
  protected final String TEXT_675 = NL + "                        throw(e_";
  protected final String TEXT_676 = ");";
  protected final String TEXT_677 = NL + "                            ";
  protected final String TEXT_678 = " = new ";
  protected final String TEXT_679 = "Struct();";
  protected final String TEXT_680 = NL + "                                ";
  protected final String TEXT_681 = ".";
  protected final String TEXT_682 = " = ";
  protected final String TEXT_683 = ".";
  protected final String TEXT_684 = ";";
  protected final String TEXT_685 = NL + "                            rejectedCount_";
  protected final String TEXT_686 = " = rejectedCount_";
  protected final String TEXT_687 = " + 1;";
  protected final String TEXT_688 = NL + "                            ";
  protected final String TEXT_689 = ".errorMessage = e_";
  protected final String TEXT_690 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_691 = ";";
  protected final String TEXT_692 = NL + "                            System.err.print(e_";
  protected final String TEXT_693 = ".getMessage());";
  protected final String TEXT_694 = NL + "        \t\t}" + NL + "        \t} " + NL + "        \tnb_line_";
  ...
  protected final String TEXT_705 = NL + "                globalMap.put(\"";
  protected final String TEXT_706 = "_QUERY\", query_";
  protected final String TEXT_707 = ".toString().trim());";
  protected final String TEXT_708 = NL + "    \t\t";
  protected final String TEXT_709 = NL + "    \t\t  pstmt_";
  protected final String TEXT_710 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_711 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_712 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_713 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_714 = NL + "    \t\t//////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_715 = " = deletedCount_";
  protected final String TEXT_716 = " + pstmt_";
  protected final String TEXT_717 = ".executeUpdate();" + NL + "    \t\t} catch(Exception e_";
  protected final String TEXT_718 = ") {" + NL + "    \t\t    whetherReject_";
  protected final String TEXT_719 = " = true;" + NL + "    \t\t    ";
  protected final String TEXT_720 = NL + "                    throw(e_";
  ...
  protected final String TEXT_734 = ".errorMessage = e_";
  protected final String TEXT_735 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_736 = ";";
  protected final String TEXT_737 = NL + "                        System.err.print(e_";
  protected final String TEXT_738 = ".getMessage());";
  protected final String TEXT_739 = NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_740 = "++;" + NL + "    \t\t//////////////////////////////////////    \t\t" + NL + "    \t\t";
  protected final String TEXT_741 = NL + NL + "    \t";
  protected final String TEXT_742 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_753 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_754 = " <= batchSizeCounter_";
  protected final String TEXT_755 = ") {                ";
  protected final String TEXT_756 = "                                                " + NL + "                try {" + NL + "                \t\tbatchSizeCounter_";
  protected final String TEXT_757 = " = 0; " + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_758 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_759 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_760 = " += pstmt_";
  protected final String TEXT_761 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_762 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_763 = " += pstmt_";
  protected final String TEXT_764 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_765 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_766 = " += pstmt_";
  protected final String TEXT_767 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_768 = "                         \t    \t" + NL + "                }catch(java.sql.SQLException e_";
  protected final String TEXT_769 = "){" + NL + "                \t";
  protected final String TEXT_770 = NL + "\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_771 = " = e_";
  protected final String TEXT_772 = ";" + NL + "\t\t\t\t\twhile (e2_";
  protected final String TEXT_773 = " != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_774 = ".getMessage());" + NL + "\t\t\t\t\t\te2_";
  protected final String TEXT_775 = " = e2_";
  protected final String TEXT_776 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_777 = NL + "\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_778 = " = e_";
  protected final String TEXT_779 = ";" + NL + "                \tboolean isFailure = false;" + NL + "\t\t\twhile(e_";
  protected final String TEXT_780 = " != null){" + NL + "\t\t\t\tif(e_";
  protected final String TEXT_781 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_782 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_783 = ".printStackTrace();" + NL + "\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse if(e_";
  protected final String TEXT_784 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse{" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_785 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_786 = ".printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\te_";
  protected final String TEXT_787 = " = e_";
  protected final String TEXT_788 = ".getNextException();" + NL + "\t\t\t}" + NL + "\t\t\tif(isFailure && e_";
  protected final String TEXT_789 = " != null){" + NL + "\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_790 = ".getMessage());" + NL + "\t\t\t\te_";
  protected final String TEXT_791 = ".printStackTrace();" + NL + "\t\t\t}" + NL + "                \t";
  protected final String TEXT_792 = NL + "\t\t\t\tthrow (e3_";
  protected final String TEXT_793 = ");" + NL + "            \t\t";
  protected final String TEXT_794 = NL + "\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_795 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_796 = "  " + NL + "                }";
  protected final String TEXT_797 = "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_798 = NL + "                commitCounter_";
  protected final String TEXT_799 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_800 = " <= commitCounter_";
  protected final String TEXT_801 = ") {" + NL + "                " + NL + "                \t";
  protected final String TEXT_802 = NL + "\t\t                try {" + NL + "\t\t                \tcommitCounter_";
  ...
  protected final String TEXT_806 = NL + "    \t\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_807 = " > 0 ) {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_808 = NL + "\t\t                \t\t    pstmt_";
  protected final String TEXT_809 = ".executeBatch();" + NL + "\t\t            \t    \t";
  protected final String TEXT_810 = NL + "\t\t            \t    \t\tinsertedCount_";
  protected final String TEXT_811 = " += pstmt_";
  protected final String TEXT_812 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_813 = "            \t    \t\t" + NL + "\t\t            \t    \t\tupdatedCount_";
  protected final String TEXT_814 = " += pstmt_";
  protected final String TEXT_815 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_816 = NL + "\t\t            \t    \t    deletedCount_";
  protected final String TEXT_817 = " += pstmt_";
  protected final String TEXT_818 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_819 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_820 = NL + "    \t\t\t\t\t\t\t}" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_821 = "\t" + NL + "\t\t\t\t\t\t\t\t                " + NL + "\t\t                \tconn_";
  protected final String TEXT_822 = ".commit();\t\t                \t" + NL + "\t\t                }catch(java.sql.SQLException e_";
  protected final String TEXT_823 = "){" + NL + "\t\t                \t";
  protected final String TEXT_824 = NL + "\t\t\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_825 = " = e_";
  protected final String TEXT_826 = ";" + NL + "\t\t\t\t\t\t\twhile (e2_";
  protected final String TEXT_827 = " != null) {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_828 = ".getMessage());" + NL + "\t\t\t\t\t\t\t\te2_";
  protected final String TEXT_829 = " = e2_";
  protected final String TEXT_830 = ".getNextException();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_831 = NL + "\t\t\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_832 = " = e_";
  protected final String TEXT_833 = ";" + NL + "\t\t                \tboolean isFailure = false;" + NL + "\t\t\t\t\twhile(e_";
  protected final String TEXT_834 = " != null){" + NL + "\t\t\t\t\t\tif(e_";
  protected final String TEXT_835 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_836 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_837 = ".printStackTrace();" + NL + "\t\t\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse if(e_";
  protected final String TEXT_838 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_839 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_840 = ".printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\te_";
  protected final String TEXT_841 = " = e_";
  protected final String TEXT_842 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(isFailure && e_";
  protected final String TEXT_843 = " != null){" + NL + "\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_844 = ".getMessage());" + NL + "\t\t\t\t\t\te_";
  protected final String TEXT_845 = ".printStackTrace();" + NL + "\t\t\t\t\t}" + NL + "\t\t                \t";
  protected final String TEXT_846 = NL + "\t\t\t\t\t\tthrow (e3_";
  protected final String TEXT_847 = ");" + NL + "\t\t                \t";
  protected final String TEXT_848 = NL + "\t\t\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_849 = ".getMessage());" + NL + "\t\t                \t";
