...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_171 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_172 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_193 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_200 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_210 = NL + "                if(whetherExist_";
  protected final String TEXT_211 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_214 = ".execute(\"";
  protected final String TEXT_215 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_216 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_228 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_238 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_239 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_240 = "            ";
  protected final String TEXT_241 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_244 = ".executeUpdate(\"";
  protected final String TEXT_245 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_246 = ".close();";
  protected final String TEXT_247 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_250 = " = stmtTruncCount_";
  protected final String TEXT_251 = ".executeQuery(\"";
  protected final String TEXT_252 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_255 = ".executeUpdate(\"";
  protected final String TEXT_256 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_257 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_258 = " += rsTruncCount_";
  protected final String TEXT_259 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_260 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_261 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_262 = ".close();            ";
  protected final String TEXT_263 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_266 = " = stmtTruncCount_";
  protected final String TEXT_267 = ".executeQuery(\"";
  protected final String TEXT_268 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_271 = ".executeUpdate(\"";
  protected final String TEXT_272 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_273 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_274 = " += rsTruncCount_";
  protected final String TEXT_275 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_276 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_277 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_290 = " WHERE ";
  ...
  protected final String TEXT_297 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_298 = " + \"\\\" WHERE ";
  protected final String TEXT_299 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_300 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_301 = " + \"\\\" (";
  protected final String TEXT_302 = ") VALUES (";
  protected final String TEXT_303 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_304 = " = conn_";
  protected final String TEXT_305 = ".prepareStatement(insert_";
  protected final String TEXT_306 = ");" + NL + "\t    String update_";
  protected final String TEXT_307 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_308 = " + \"\\\" SET ";
  protected final String TEXT_309 = " WHERE ";
  protected final String TEXT_310 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_324 = ") VALUES (";
  protected final String TEXT_325 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_326 = " = conn_";
  protected final String TEXT_327 = ".prepareStatement(insert_";
  protected final String TEXT_328 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_329 = NL + "\t    String delete_";
  protected final String TEXT_330 = " = \"DELETE  FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_334 = ".prepareStatement(delete_";
  protected final String TEXT_335 = ");" + NL + "\t    ";
  protected final String TEXT_336 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_337 = " = null;" + NL + "       \t";
  protected final String TEXT_338 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_339 = " = insert_";
  ...
  protected final String TEXT_348 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_349 = " = insert_";
  protected final String TEXT_350 = ".split(\"\\\\?\");";
  protected final String TEXT_351 = NL + "\t\t\tdelete_";
  protected final String TEXT_352 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_353 = " = delete_";
  protected final String TEXT_354 = ".split(\"\\\\?\");";
  protected final String TEXT_355 = NL + "\t\t\treplace_";
  protected final String TEXT_356 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_367 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_368 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
