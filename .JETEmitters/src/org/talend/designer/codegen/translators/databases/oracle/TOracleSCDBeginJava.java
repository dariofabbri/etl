...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_162 = NL + "\t                    if(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_163 = ").getTIMESTAMPTZ(";
  protected final String TEXT_164 = ") != null){" + NL + "\t                    \t";
  protected final String TEXT_165 = ".";
  protected final String TEXT_166 = " = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_167 = ").getTIMESTAMPTZ(";
  protected final String TEXT_168 = ").toBytes());" + NL + "\t                    }else{" + NL + "\t                    \t";
  protected final String TEXT_169 = ".";
  protected final String TEXT_170 = " = null;" + NL + "\t                    }" + NL + "\t                ";
  protected final String TEXT_171 = NL + "\t                    timestamp_";
  protected final String TEXT_172 = " = resultSet_";
  protected final String TEXT_173 = ".getTimestamp(";
  protected final String TEXT_174 = ");" + NL + "\t                    if(timestamp_";
  protected final String TEXT_175 = " != null) {" + NL + "\t                        ";
  protected final String TEXT_176 = ".";
  protected final String TEXT_177 = " = new java.util.Date(timestamp_";
  protected final String TEXT_178 = ".getTime());" + NL + "\t                    } else {" + NL + "\t                        ";
  protected final String TEXT_179 = ".";
  protected final String TEXT_180 = " = null;" + NL + "\t                    }";
  protected final String TEXT_181 = NL + "                    if(resultSet_";
  protected final String TEXT_182 = ".getObject(";
  protected final String TEXT_183 = ") != null) {";
  protected final String TEXT_184 = NL + "                        ";
  protected final String TEXT_185 = ".";
  protected final String TEXT_186 = " = resultSet_";
  protected final String TEXT_187 = ".get";
  protected final String TEXT_188 = "(";
  protected final String TEXT_189 = ");" + NL + "                    }";
  protected final String TEXT_190 = NL + "            cache_";
  protected final String TEXT_191 = ".put(sk_";
  protected final String TEXT_192 = ", row_";
  protected final String TEXT_193 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_194 = ".close();" + NL + "        statement_";
  protected final String TEXT_195 = ".close();";
  protected final String TEXT_196 = NL + "            System.out.println(\"[";
  protected final String TEXT_197 = "] comparison cache loaded\");";
  protected final String TEXT_198 = NL + "        ";
  protected final String TEXT_199 = " nextSurrogateKey_";
  protected final String TEXT_200 = " = 1;";
  protected final String TEXT_201 = NL + "            if(cache_";
  protected final String TEXT_202 = ".size() > 0) {";
  protected final String TEXT_203 = NL + "        String tmpQuery_";
  protected final String TEXT_204 = " = \"SELECT MAX(";
  protected final String TEXT_205 = ") FROM \" + tableName_";
  protected final String TEXT_206 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_207 = " = connection_";
  protected final String TEXT_208 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_209 = " = tmpStmt_";
  protected final String TEXT_210 = ".executeQuery(tmpQuery_";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "        if(tmpRS_";
  protected final String TEXT_213 = ".next() && tmpRS_";
  protected final String TEXT_214 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_215 = " = tmpRS_";
  protected final String TEXT_216 = ".get";
  protected final String TEXT_217 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_218 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_219 = ".close();";
  protected final String TEXT_220 = NL + "            }            ";
  protected final String TEXT_221 = NL + "    String insertionSQL_";
  protected final String TEXT_222 = " = \"";
  protected final String TEXT_223 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_224 = " = connection_";
  protected final String TEXT_225 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_226 = ");";
  protected final String TEXT_227 = NL + "            insertionStatement_";
  protected final String TEXT_228 = ".setTimestamp(";
  protected final String TEXT_229 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_230 = "\")));";
  protected final String TEXT_231 = NL + "            insertionStatement_";
  protected final String TEXT_232 = ".setNull(";
  protected final String TEXT_233 = ", java.sql.Types.DATE);";
  protected final String TEXT_234 = NL + "            insertionStatement_";
  protected final String TEXT_235 = ".setTimestamp(";
  protected final String TEXT_236 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_237 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_238 = NL + "        String updateSQLForType1_";
  protected final String TEXT_239 = " = \"";
  protected final String TEXT_240 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_241 = " = connection_";
  protected final String TEXT_242 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_243 = ");        ";
  protected final String TEXT_244 = NL + "        String updateSQLForType2_";
  protected final String TEXT_245 = " = \"";
  protected final String TEXT_246 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_247 = " = connection_";
  protected final String TEXT_248 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_249 = ");";
  protected final String TEXT_250 = NL + "            updateForType2_";
  protected final String TEXT_251 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_252 = "\")));";
  protected final String TEXT_253 = NL + "        String updateSQLForType3_";
  protected final String TEXT_254 = " = \"";
  protected final String TEXT_255 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_256 = " = connection_";
  protected final String TEXT_257 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_258 = ");";
  protected final String TEXT_259 = NL + "    ";
  protected final String TEXT_260 = NL + "        SCDSK_";
  protected final String TEXT_261 = " lookUpKey_";
  protected final String TEXT_262 = " = null;        ";
  protected final String TEXT_263 = NL + "    SCDStruct_";
