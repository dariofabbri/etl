...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_386 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_387 = " = conn_";
  protected final String TEXT_388 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_389 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_390 = " +\" ON\");" + NL + "\t    ";
  ...
  protected final String TEXT_414 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_419 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_420 = " = insertedCount_";
  protected final String TEXT_421 = " + pstmt_";
  protected final String TEXT_422 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_423 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_424 = " = true;";
  protected final String TEXT_425 = NL + "                    throw(e);";
  protected final String TEXT_426 = NL + "                        ";
  protected final String TEXT_427 = " = new ";
  protected final String TEXT_428 = "Struct();";
  protected final String TEXT_429 = NL + "                            ";
  protected final String TEXT_430 = ".";
  protected final String TEXT_431 = " = ";
  protected final String TEXT_432 = ".";
  protected final String TEXT_433 = ";";
  protected final String TEXT_434 = NL + "                        rejectedCount_";
  protected final String TEXT_435 = " = rejectedCount_";
  protected final String TEXT_436 = " + 1;";
  protected final String TEXT_437 = NL + "                        ";
  protected final String TEXT_438 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_439 = ";";
  protected final String TEXT_440 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_441 = NL + "            }";
  protected final String TEXT_442 = NL + "                    ";
  protected final String TEXT_443 = NL + "                        query_";
  protected final String TEXT_444 = " = ";
  protected final String TEXT_445 = ";";
  protected final String TEXT_446 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_447 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_472 = NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_476 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_477 = " = true;";
  protected final String TEXT_478 = NL + "                    throw(e);";
  ...
  protected final String TEXT_491 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_492 = ";";
  protected final String TEXT_493 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_498 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  ...
  protected final String TEXT_529 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_530 = " = updatedCount_";
  protected final String TEXT_531 = " + pstmtUpdate_";
  protected final String TEXT_532 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_543 = NL + "                            rejectedCount_";
  protected final String TEXT_544 = " = rejectedCount_";
  protected final String TEXT_545 = " + 1;";
  protected final String TEXT_546 = NL + "                            ";
  protected final String TEXT_547 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_548 = ";";
  protected final String TEXT_549 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_550 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_551 = NL + "                        ";
  protected final String TEXT_552 = NL + "                            query_";
  protected final String TEXT_553 = " = ";
  protected final String TEXT_554 = ";";
  protected final String TEXT_555 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_556 = ".";
  protected final String TEXT_557 = ", pstmtInsert_";
  protected final String TEXT_558 = ", ";
  protected final String TEXT_559 = ", \"";
  protected final String TEXT_560 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_561 = NL + "                    globalMap.put(\"";
  protected final String TEXT_562 = "_QUERY\", query_";
  protected final String TEXT_563 = ".toString().trim());";
  protected final String TEXT_564 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_565 = " = insertedCount_";
  protected final String TEXT_566 = " + pstmtInsert_";
  protected final String TEXT_567 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_585 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_586 = "++;";
  protected final String TEXT_587 = NL + "            int updateFlag_";
  protected final String TEXT_588 = " = 0;";
  protected final String TEXT_589 = NL + "                    ";
  protected final String TEXT_590 = NL + "                        query_";
  protected final String TEXT_591 = " = ";
  protected final String TEXT_592 = ";";
  protected final String TEXT_593 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_594 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_595 = ".";
  protected final String TEXT_596 = ", pstmtUpdate_";
  ...
  protected final String TEXT_606 = NL + "                        query_";
  protected final String TEXT_607 = " = ";
  protected final String TEXT_608 = ";";
  protected final String TEXT_609 = NL + "                globalMap.put(\"";
  protected final String TEXT_610 = "_QUERY\", query_";
  protected final String TEXT_611 = ".toString().trim());";
  protected final String TEXT_612 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_613 = "=pstmtUpdate_";
  protected final String TEXT_614 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_615 = " = updatedCount_";
  protected final String TEXT_616 = "+updateFlag_";
  protected final String TEXT_617 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_635 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_636 = " == 0) {" + NL + "            \t";
  protected final String TEXT_637 = NL + "\t\t\t\tquery_";
  protected final String TEXT_638 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_639 = NL + "                        ";
  protected final String TEXT_640 = NL + "                            query_";
  protected final String TEXT_641 = " = ";
  protected final String TEXT_642 = ";";
  protected final String TEXT_643 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_644 = ".";
  protected final String TEXT_645 = ", pstmtInsert_";
  ...
  protected final String TEXT_652 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_653 = " = insertedCount_";
  protected final String TEXT_654 = " + pstmtInsert_";
  ...
  protected final String TEXT_673 = NL + "                }" + NL + "            }" + NL + "            " + NL + "            nb_line_";
  ...
  protected final String TEXT_772 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_773 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_774 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_775 = NL + "                \t\tint countSum_";
  protected final String TEXT_776 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_777 = ": pstmt_";
  protected final String TEXT_778 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_779 = " += (countEach_";
  protected final String TEXT_780 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_785 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_786 = " += countSum_";
  protected final String TEXT_787 = ";" + NL + "            \t    \t";
  protected final String TEXT_788 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_789 = " += countSum_";
  ...
  protected final String TEXT_796 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_797 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_798 = NL + "\t                \tint countSum_";
  protected final String TEXT_799 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_800 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_801 = " += (countEach_";
  protected final String TEXT_802 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_813 = " " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_814 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_815 = NL + "                \tconn_";
  protected final String TEXT_816 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_817 = "=0;" + NL + "                }\t";
