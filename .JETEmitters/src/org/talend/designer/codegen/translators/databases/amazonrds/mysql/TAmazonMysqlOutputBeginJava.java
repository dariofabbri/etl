...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_185 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_201 = NL + "                if(!whetherExist_";
  protected final String TEXT_202 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_224 = NL + "                if(whetherExist_";
  protected final String TEXT_225 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_228 = ".execute(\"";
  protected final String TEXT_229 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_230 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_234 = ".execute(\"";
  protected final String TEXT_235 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_252 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_253 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_254 = "            ";
  protected final String TEXT_255 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_258 = ".executeUpdate(\"";
  protected final String TEXT_259 = "\");" + NL + "            stmtClear_";
  ...
  protected final String TEXT_277 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_278 = " = conn_";
  protected final String TEXT_279 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_280 = " = stmtTruncCount_";
  ...
  protected final String TEXT_284 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_285 = ".executeUpdate(\"";
  ...
  protected final String TEXT_289 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_290 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_291 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_292 = ".close();";
  protected final String TEXT_293 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_294 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_296 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_297 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_298 = ".append (\"`\" +  ";
  protected final String TEXT_299 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_300 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_322 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_323 = " = conn_";
  protected final String TEXT_324 = ".prepareStatement(insert_";
  protected final String TEXT_325 = ");";
  protected final String TEXT_326 = NL + "                        ";
  protected final String TEXT_327 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_328 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_329 = " = conn_";
  protected final String TEXT_330 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_331 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_332 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_333 = ",insert_";
  protected final String TEXT_334 = ",keyPsmt_";
  protected final String TEXT_335 = ");";
  protected final String TEXT_336 = NL + "\t        \t        ";
  protected final String TEXT_337 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_338 = " {" + NL + "    \t            ";
  protected final String TEXT_339 = NL + "                            ";
  protected final String TEXT_340 = " ";
  protected final String TEXT_341 = ";                ";
  protected final String TEXT_342 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_343 = "(";
  protected final String TEXT_344 = NL + "                                ,";
  protected final String TEXT_345 = NL + "                            ";
  protected final String TEXT_346 = " ";
  protected final String TEXT_347 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_348 = NL + "                                this.";
  protected final String TEXT_349 = " = ";
  protected final String TEXT_350 = ";              ";
  protected final String TEXT_351 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_352 = "> exInsertColValueList";
  protected final String TEXT_353 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_354 = " exInsertColValue";
  protected final String TEXT_355 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_356 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_357 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_358 = ".append(\"(";
  protected final String TEXT_359 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_360 = "-1) extendInsertValueStmt_";
  protected final String TEXT_361 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_362 = " = \"INSERT INTO `\"+";
  protected final String TEXT_363 = "+\"` (";
  protected final String TEXT_364 = ") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_380 = ".prepareStatement(insert_";
  protected final String TEXT_381 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_382 = " = \"";
  protected final String TEXT_383 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_384 = " =  \"";
  protected final String TEXT_385 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_386 = " = 0;\t ";
  protected final String TEXT_387 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_388 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_395 = NL + "\t\t        int batchSize_";
  protected final String TEXT_396 = " = ";
  protected final String TEXT_397 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_398 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_399 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_400 = " = new StringBuffer(insert_";
  protected final String TEXT_401 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_402 = ".insert(insert_";
  protected final String TEXT_403 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_404 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_405 = " =insertStringBuffer_";
  ...
  protected final String TEXT_412 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_428 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_429 = " = conn_";
  protected final String TEXT_430 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_431 = " + \"` WHERE ";
  protected final String TEXT_432 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_433 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_449 = " = \"UPDATE `\" + ";
  protected final String TEXT_450 = " + \"` SET ";
  protected final String TEXT_451 = " WHERE ";
  protected final String TEXT_452 = "\";" + NL + "\t    ";
  protected final String TEXT_453 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_454 = " = new StringBuffer(update_";
  protected final String TEXT_455 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_456 = ".insert(update_";
  protected final String TEXT_457 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_458 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_459 = " =updateStringBuffer_";
  ...
  protected final String TEXT_466 = " = \"UPDATE `\" + ";
  protected final String TEXT_467 = " + \"` SET ";
  protected final String TEXT_468 = " WHERE ";
  protected final String TEXT_469 = "\";" + NL + "\t    ";
  protected final String TEXT_470 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_471 = " = new StringBuffer(update_";
  protected final String TEXT_472 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_473 = ".insert(update_";
  protected final String TEXT_474 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_475 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_476 = " =updateStringBuffer_";
  ...
  protected final String TEXT_486 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_487 = " = new StringBuffer(insert_";
  protected final String TEXT_488 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_489 = ".insert(insert_";
  protected final String TEXT_490 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_491 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_492 = " =insertStringBuffer_";
  ...
  protected final String TEXT_502 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_503 = " = new StringBuffer(delete_";
  protected final String TEXT_504 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_505 = ".insert(delete_";
  protected final String TEXT_506 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_507 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_508 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_514 = NL + "\t    String replace_";
  protected final String TEXT_515 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_516 = " + \"` (";
  protected final String TEXT_517 = ") VALUES (";
  protected final String TEXT_518 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".prepareStatement(replace_";
  protected final String TEXT_521 = ");" + NL + "\t    ";
  protected final String TEXT_522 = NL + "\t    String insertIgnore_";
  protected final String TEXT_523 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_524 = " + \"` (";
  protected final String TEXT_525 = ") VALUES (";
  protected final String TEXT_526 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_527 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_528 = " = conn_";
  protected final String TEXT_529 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_530 = ");" + NL + "\t    ";
  protected final String TEXT_531 = NL + "\t    String insert_";
  protected final String TEXT_532 = " = \"INSERT IGNORE INTO `\" + ";
  ...
  protected final String TEXT_578 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_579 = " {" + NL + "    \t            ";
  protected final String TEXT_580 = NL + "                            ";
  protected final String TEXT_581 = " ";
  protected final String TEXT_582 = ";                ";
  protected final String TEXT_583 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_584 = ";" + NL + "\t\t\t";
  protected final String TEXT_585 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_586 = "(";
  protected final String TEXT_587 = NL + "                                ,";
  protected final String TEXT_588 = NL + "                            ";
  protected final String TEXT_589 = " ";
  protected final String TEXT_590 = NL + "\t\t\t\t, Dynamic ";
  protected final String TEXT_591 = NL + "\t\t\t";
  protected final String TEXT_592 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_593 = NL + "                                this.";
  protected final String TEXT_594 = " = ";
  protected final String TEXT_595 = ";              ";
  protected final String TEXT_596 = NL + "\t\t\t\tthis.";
  protected final String TEXT_597 = "=";
  protected final String TEXT_598 = ";" + NL + "\t\t\t";
  protected final String TEXT_599 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_600 = "> exInsertColValueList";
  protected final String TEXT_601 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_602 = " exInsertColValue";
  protected final String TEXT_603 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_604 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_605 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_606 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_607 = "=1;";
  protected final String TEXT_608 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_609 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_610 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_611 = " =null;" + NL + "\tint batchSizeCounter_";
  protected final String TEXT_612 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_613 = "=0;" + NL + "\tint rowCount";
  protected final String TEXT_614 = "=0;";
