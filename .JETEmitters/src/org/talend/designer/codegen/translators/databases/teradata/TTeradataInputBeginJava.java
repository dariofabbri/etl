...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_91 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_94 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_95 = " == null || dbProperties_";
  protected final String TEXT_96 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_97 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_98 = " + \"/DATABASE=\" + ";
  protected final String TEXT_99 = ";    " + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_100 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_101 = " + \"/DATABASE=\" + ";
  protected final String TEXT_102 = " + \",\" + ";
  protected final String TEXT_103 = ";" + NL + "\t\t\t}       ";
  protected final String TEXT_104 = NL + "                stmt_";
  protected final String TEXT_105 = ".setFetchSize(200000);";
  protected final String TEXT_106 = NL + "    " + NL + "\t";
  protected final String TEXT_107 = NL + "\t\t    int nb_line_";
  protected final String TEXT_108 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_109 = " = null;";
  protected final String TEXT_110 = NL + "\t\t        conn_";
  protected final String TEXT_111 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_112 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_113 = ") {";
  protected final String TEXT_114 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_115 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_116 = " = dataSources_";
  protected final String TEXT_117 = ".get(";
  protected final String TEXT_118 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_119 = "\", conn_";
  protected final String TEXT_120 = ");" + NL + "\t\t        }";
  protected final String TEXT_121 = NL + NL + "\t\t    ";
  protected final String TEXT_122 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_125 = "_QUERY\",dbquery_";
  protected final String TEXT_126 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_127 = " = stmt_";
  protected final String TEXT_128 = ".executeQuery(dbquery_";
  protected final String TEXT_129 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_130 = " = rs_";
  protected final String TEXT_131 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_132 = " = rsmd_";
  protected final String TEXT_133 = ".getColumnCount();" + NL;
  protected final String TEXT_134 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_135 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_136 = ".setDbmsId(\"";
  protected final String TEXT_137 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_138 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_139 = "=1; i_";
  protected final String TEXT_140 = "<";
  protected final String TEXT_141 = "; i_";
  protected final String TEXT_142 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_143 = ".add(rsmd_";
  protected final String TEXT_144 = ".getColumnName(i_";
  protected final String TEXT_145 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_148 = "; i <= rsmd_";
  protected final String TEXT_149 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  ...
  protected final String TEXT_188 = " = null;" + NL + "\t\t    while (rs_";
