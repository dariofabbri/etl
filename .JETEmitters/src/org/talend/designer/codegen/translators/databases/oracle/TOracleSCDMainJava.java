...
public class TOracleSCDMainJava {
  ...
  protected final String TEXT_171 = NL + "    }" + NL + "\t} catch (Exception e) {//catch" + NL + "  \t\t";
  ...
  protected final String TEXT_185 = NL + "\t}//end catch" + NL + "    ";
  ...
  protected final String TEXT_196 = NL + "                lookUpValue_";
  protected final String TEXT_197 = ".";
  protected final String TEXT_198 = " = ";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = ";";
  protected final String TEXT_201 = NL + "        cache_";
  protected final String TEXT_202 = ".put(lookUpKey_";
  protected final String TEXT_203 = ", lookUpValue_";
...
if(inputSchema != null && inputSchema.size() > 0 && outputSchema != null && outputSchema.size() > 0) {
    ...
    stringBuffer.append(scdManager.genSetStatement("searchingStmt_" + cid, inConnectionName + "." + sourceKey.getLabelName(), paramIndex, sourceKey.getJavaType(),true, sourceKey.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType1_" + cid, inConnectionName + "." + sourceKey.getLabelName(), index, sourceKey.getJavaType(),true , sourceKey.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType2_" + cid, inConnectionName + "." + sourceKey.getLabelName(), index, sourceKey.getJavaType(),true, sourceKey.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType3_" + cid,  inConnectionName + "." + sourceKey.getLabelName(), index, sourceKey.getJavaType(),true, sourceKey.getDbType()));
