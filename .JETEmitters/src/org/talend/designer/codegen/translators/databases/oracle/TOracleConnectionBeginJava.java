...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_106 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_107 = "\", conn_";
  protected final String TEXT_108 = ");" + NL + "\t}";
  protected final String TEXT_109 = NL + "\tif (null != conn_";
  protected final String TEXT_110 = ") {" + NL + "\t\t";
  protected final String TEXT_111 = NL + "\t}";
  protected final String TEXT_112 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_113 = "\",conn_";
  protected final String TEXT_114 = ");";
  protected final String TEXT_115 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_116 = "\",conn_";
  protected final String TEXT_117 = ".getMetaData().getUserName());";
  protected final String TEXT_118 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_119 = "\", ";
  protected final String TEXT_120 = ");";
  protected final String TEXT_121 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_122 = "\",";
  protected final String TEXT_123 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
