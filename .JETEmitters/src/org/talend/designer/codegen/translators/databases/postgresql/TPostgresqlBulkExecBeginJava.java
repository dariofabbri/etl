...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_107 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_108 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_109 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_110 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_114 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_115 = " = dbMetaData_";
  protected final String TEXT_116 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_117 = " = false;" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_125 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_161 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_167 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_168 = ".executeUpdate(\"";
  protected final String TEXT_169 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_170 = ".close();";
  protected final String TEXT_171 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_174 = " = stmtTruncCount_";
  protected final String TEXT_175 = ".executeQuery(\"";
  protected final String TEXT_176 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".createStatement();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_187 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_188 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_189 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_190 = NL + "\t";
  protected final String TEXT_191 = NL + "        int keyCount_";
  protected final String TEXT_192 = " = ";
  protected final String TEXT_193 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_194 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        String tmpTableName_";
  protected final String TEXT_195 = " = tableName_";
  protected final String TEXT_196 = ";" + NL + "        tableName_";
  protected final String TEXT_197 = " = \"tmp_";
  protected final String TEXT_198 = "\" + \"_\" + pid ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_201 = ".execute(\"";
  protected final String TEXT_202 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_203 = ".close();" + NL + "        " + NL + "        ";
  protected final String TEXT_204 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_205 = " =conn_";
  protected final String TEXT_206 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_207 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_208 = ".close();" + NL + "   \t\t";
  protected final String TEXT_209 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_212 = ".execute(bulkSQL_";
  protected final String TEXT_213 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_214 = ".close();" + NL + "        " + NL + "        tableName_";
  protected final String TEXT_215 = " = tmpTableName_";
  protected final String TEXT_216 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_217 = " = \"tmp_";
  protected final String TEXT_218 = "\" + \"_\" + pid;" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".createStatement();" + NL + "        " + NL + "        stmtUpdateBulk_";
  protected final String TEXT_221 = ".executeUpdate(\"";
  protected final String TEXT_222 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_223 = ".close();" + NL + "        tableName_";
  protected final String TEXT_224 = " = tmpTableName_";
  protected final String TEXT_225 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_228 = ".execute(\"";
  protected final String TEXT_229 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_230 = ".close();";
  protected final String TEXT_231 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_232 = " =conn_";
  protected final String TEXT_233 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_234 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_235 = ".close();";
  protected final String TEXT_236 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_239 = ".execute(bulkSQL_";
  protected final String TEXT_240 = ");" + NL + "    stmtBulk_";
