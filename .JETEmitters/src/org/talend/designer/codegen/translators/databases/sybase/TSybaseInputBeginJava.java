...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_104 = NL + "\t\t    int nb_line_";
  protected final String TEXT_105 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_106 = " = null;";
  protected final String TEXT_107 = NL + "\t\t        conn_";
  protected final String TEXT_108 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_109 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_110 = ") {";
  protected final String TEXT_111 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_112 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_113 = " = dataSources_";
  protected final String TEXT_114 = ".get(";
  protected final String TEXT_115 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_116 = "\", conn_";
  protected final String TEXT_117 = ");" + NL + "\t\t        }";
  protected final String TEXT_118 = NL + NL + "\t\t    ";
  protected final String TEXT_119 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_120 = " = ";
  protected final String TEXT_121 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_122 = "_QUERY\",dbquery_";
  protected final String TEXT_123 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_124 = " = stmt_";
  protected final String TEXT_125 = ".executeQuery(dbquery_";
  protected final String TEXT_126 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_127 = " = rs_";
  protected final String TEXT_128 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_129 = " = rsmd_";
  protected final String TEXT_130 = ".getColumnCount();" + NL;
  protected final String TEXT_131 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_132 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_133 = ".setDbmsId(\"";
  protected final String TEXT_134 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_135 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_136 = "=1; i_";
  protected final String TEXT_137 = "<";
  protected final String TEXT_138 = "; i_";
  protected final String TEXT_139 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_140 = ".add(rsmd_";
  protected final String TEXT_141 = ".getColumnName(i_";
  protected final String TEXT_142 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_145 = "; i <= rsmd_";
  protected final String TEXT_146 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  ...
  protected final String TEXT_185 = " = null;" + NL + "\t\t    while (rs_";
