...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_111 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_116 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_117 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_118 = ".close();";
  protected final String TEXT_119 = "      " + NL + "\t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_122 = " = dbMetaData_";
  protected final String TEXT_123 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_124 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_125 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_126 = " = rsTable_";
  protected final String TEXT_127 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_158 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_159 = ".execute(\"";
  protected final String TEXT_160 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_161 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_183 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_184 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_185 = "            ";
  protected final String TEXT_186 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_189 = ".executeUpdate(\"";
  protected final String TEXT_190 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_191 = ".close();";
  protected final String TEXT_192 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_195 = " = stmtTruncCount_";
  protected final String TEXT_196 = ".executeQuery(\"";
  protected final String TEXT_197 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_200 = ".executeUpdate(\"";
  protected final String TEXT_201 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_202 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_203 = " += rsTruncCount_";
  protected final String TEXT_204 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_205 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_206 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_224 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_225 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_226 = " + \"\\\" (";
  protected final String TEXT_227 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_228 = ".";
  protected final String TEXT_229 = ", \"";
  protected final String TEXT_230 = "\")+\") VALUES (";
  protected final String TEXT_231 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_239 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_240 = ".";
  protected final String TEXT_241 = ")+\")\";";
  protected final String TEXT_242 = NL + "\t    pstmt_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".prepareStatement(insert_";
  protected final String TEXT_245 = ");" + NL + "\t    ";
  protected final String TEXT_246 = NL + "\t\t\t\tString update_";
  protected final String TEXT_247 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_248 = " + \"\\\" SET ";
  protected final String TEXT_249 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_250 = ".";
  protected final String TEXT_251 = ", \"";
  protected final String TEXT_252 = "\")+\" WHERE ";
  protected final String TEXT_253 = "\";";
  protected final String TEXT_254 = NL + "\t\t\t\tString update_";
  protected final String TEXT_255 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_256 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_257 = ".";
  protected final String TEXT_258 = ", \"";
  protected final String TEXT_259 = "\")+\" WHERE ";
  ...
  protected final String TEXT_266 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_267 = " + \"\\\" (";
  protected final String TEXT_268 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_269 = ".";
  protected final String TEXT_270 = ", \"";
  protected final String TEXT_271 = "\")+\") VALUES (";
  ...
  protected final String TEXT_280 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_286 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_293 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_304 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_312 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_313 = ".";
  protected final String TEXT_314 = ", \"";
  protected final String TEXT_315 = "\")+\") VALUES (";
  protected final String TEXT_316 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_317 = ".";
  protected final String TEXT_318 = ")+\")\";";
  protected final String TEXT_319 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_320 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_321 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_322 = ".";
  protected final String TEXT_323 = ", \"";
  protected final String TEXT_324 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_325 = ".";
  protected final String TEXT_326 = ")+\")\";";
  protected final String TEXT_327 = NL + "\t\t\t\tString update_";
  protected final String TEXT_328 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_329 = " + \"\\\" SET ";
  protected final String TEXT_330 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_331 = ".";
  protected final String TEXT_332 = ", \"";
  protected final String TEXT_333 = "\")+\" WHERE ";
  protected final String TEXT_334 = "\";";
  protected final String TEXT_335 = NL + "\t\t\t\tString update_";
  protected final String TEXT_336 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_337 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_338 = ".";
  protected final String TEXT_339 = ", \"";
  protected final String TEXT_340 = "\")+\" WHERE ";
  ...
  protected final String TEXT_354 = ".prepareStatement(delete_";
  protected final String TEXT_355 = ");" + NL + "\t    ";
  protected final String TEXT_356 = NL + "        StringBuffer query_";
  protected final String TEXT_357 = " = null;" + NL + "       \t";
  protected final String TEXT_358 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_366 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_367 = " = update_";
  protected final String TEXT_368 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_369 = " = insert_";
  protected final String TEXT_370 = ".split(\"\\\\?\");";
  protected final String TEXT_371 = NL + "\t\t\tdelete_";
  protected final String TEXT_372 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_373 = " = delete_";
  protected final String TEXT_374 = ".split(\"\\\\?\");";
  protected final String TEXT_375 = NL + "\t\t\treplace_";
  protected final String TEXT_376 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_377 = " = replace_";
  protected final String TEXT_378 = ".split(\"\\\\?\");";
  protected final String TEXT_379 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_380 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_381 = " = insertIgnore_";
  protected final String TEXT_382 = ".split(\"\\\\?\");";
  protected final String TEXT_383 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_384 = " = insert_";
  protected final String TEXT_385 = ".split(\"\\\\?\");";
  protected final String TEXT_386 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_387 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_388 = " = buffersSize_";
  protected final String TEXT_389 = ";";
  protected final String TEXT_390 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_391 = " = buffersSize_";
  protected final String TEXT_392 = ";";
  protected final String TEXT_393 = NL + "        whetherReject_";
  protected final String TEXT_394 = " = false;";
  protected final String TEXT_395 = NL + "                    ";
  protected final String TEXT_396 = NL + "                        query_";
  protected final String TEXT_397 = " = ";
  protected final String TEXT_398 = ";";
  protected final String TEXT_399 = NL + "                            geometryColumnName_";
  protected final String TEXT_400 = " = \"";
  protected final String TEXT_401 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_402 = ") {" + NL + "                                dimension_";
  protected final String TEXT_403 = " = 2;" + NL + "                                " + NL + "                                // A null first geometry will lead to unknown coordinate system  " + NL + "                                if (";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_406 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_407 = " = " + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_410 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_411 = " = refSys_";
  protected final String TEXT_412 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_413 = " = refSys_";
  protected final String TEXT_414 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_415 = " == null || ident_";
  protected final String TEXT_416 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_417 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_418 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_419 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_420 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_421 = " = Integer.parseInt(code_";
  protected final String TEXT_422 = ");" + NL + "                                            }" + NL + "                                        } catch (Exception e) {" + NL + "                                            System.out.println(\"SRID_";
  protected final String TEXT_423 = " could not be determined\");" + NL + "                                            SRID_";
  protected final String TEXT_424 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_425 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_426 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_427 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_434 = "_QUERY\", query_";
  protected final String TEXT_435 = ".toString().trim());";
  protected final String TEXT_436 = NL + "\t\t\t";
  protected final String TEXT_437 = NL + "    \t\tpstmt_";
  protected final String TEXT_438 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_439 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_440 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_441 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_442 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_443 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_444 = NL + "                \tsp_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_447 = NL + "                insertedCount_";
  protected final String TEXT_448 = " = insertedCount_";
  protected final String TEXT_449 = " + pstmt_";
  protected final String TEXT_450 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_451 = NL + "\t                conn_";
  protected final String TEXT_452 = ".releaseSavepoint(sp_";
  protected final String TEXT_453 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_454 = NL + "                nb_line_";
  protected final String TEXT_455 = "++;" + NL + "            } catch(Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_456 = NL + "\t                conn_";
  protected final String TEXT_457 = ".rollback(sp_";
  protected final String TEXT_458 = ");" + NL + "\t            ";
  protected final String TEXT_459 = NL + "                whetherReject_";
  protected final String TEXT_460 = " = true;";
  protected final String TEXT_461 = NL + "                    throw(e);";
  protected final String TEXT_462 = NL + "                        ";
  protected final String TEXT_463 = " = new ";
  protected final String TEXT_464 = "Struct();";
  protected final String TEXT_465 = NL + "                            ";
  protected final String TEXT_466 = ".";
  protected final String TEXT_467 = " = ";
  protected final String TEXT_468 = ".";
  protected final String TEXT_469 = ";";
  protected final String TEXT_470 = NL + "                        rejectedCount_";
  protected final String TEXT_471 = " = rejectedCount_";
  protected final String TEXT_472 = " + 1;";
  protected final String TEXT_473 = NL + "                        ";
  protected final String TEXT_474 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_482 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_483 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_501 = "_QUERY\", query_";
  protected final String TEXT_502 = ".toString().trim());";
  protected final String TEXT_503 = NL + "    \t\tpstmt_";
  protected final String TEXT_504 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_505 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_506 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_507 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_508 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_509 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_510 = NL + "\t                sp_";
  protected final String TEXT_511 = " = conn_";
  protected final String TEXT_512 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_513 = NL + "                updatedCount_";
  protected final String TEXT_514 = " = updatedCount_";
  protected final String TEXT_515 = " + pstmt_";
  protected final String TEXT_516 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_517 = NL + "                \tconn_";
  protected final String TEXT_518 = ".releaseSavepoint(sp_";
  protected final String TEXT_519 = ");";
  protected final String TEXT_520 = "\t" + NL + "                nb_line_";
  protected final String TEXT_521 = "++;" + NL + "            } catch(Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_522 = NL + "\t                conn_";
  protected final String TEXT_523 = ".rollback(sp_";
  protected final String TEXT_524 = ");" + NL + "\t            ";
  protected final String TEXT_525 = NL + "                whetherReject_";
  ...
  protected final String TEXT_547 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_548 = " = pstmt_";
  protected final String TEXT_549 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_550 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_551 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_552 = " = rs_";
  protected final String TEXT_553 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_554 = " > 0) {";
  protected final String TEXT_555 = NL + "                        ";
  protected final String TEXT_556 = NL + "                            query_";
  protected final String TEXT_557 = " = ";
  protected final String TEXT_558 = ";";
  protected final String TEXT_559 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_560 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_561 = ".";
  protected final String TEXT_562 = ", pstmtUpdate_";
  ...
  protected final String TEXT_578 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_579 = NL + "\t                    sp_";
  protected final String TEXT_580 = " = conn_";
  protected final String TEXT_581 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_582 = NL + "                    updatedCount_";
  protected final String TEXT_583 = " = updatedCount_";
  protected final String TEXT_584 = " + pstmtUpdate_";
  protected final String TEXT_585 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_586 = NL + "    \t                conn_";
  protected final String TEXT_587 = ".releaseSavepoint(sp_";
  protected final String TEXT_588 = ");" + NL + "    \t            ";
  protected final String TEXT_589 = NL + "                } catch(Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_590 = NL + "    \t                conn_";
  protected final String TEXT_591 = ".rollback(sp_";
  ...
  protected final String TEXT_610 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_611 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_612 = NL + "                        ";
  protected final String TEXT_613 = NL + "                            query_";
  protected final String TEXT_614 = " = ";
  protected final String TEXT_615 = ";";
  protected final String TEXT_616 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_617 = ".";
  protected final String TEXT_618 = ", pstmtInsert_";
  protected final String TEXT_619 = ", ";
  protected final String TEXT_620 = ", \"";
  protected final String TEXT_621 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_622 = NL + "                    globalMap.put(\"";
  protected final String TEXT_623 = "_QUERY\", query_";
  protected final String TEXT_624 = ".toString().trim());";
  protected final String TEXT_625 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_626 = NL + "\t                    sp_";
  protected final String TEXT_627 = " = conn_";
  protected final String TEXT_628 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_629 = NL + "                    insertedCount_";
  protected final String TEXT_630 = " = insertedCount_";
  protected final String TEXT_631 = " + pstmtInsert_";
  protected final String TEXT_632 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_633 = NL + "    \t                conn_";
  protected final String TEXT_634 = ".releaseSavepoint(sp_";
  protected final String TEXT_635 = ");" + NL + "    \t            ";
  protected final String TEXT_636 = NL + "                } catch(Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_637 = NL + "    \t                conn_";
  protected final String TEXT_638 = ".rollback(sp_";
  protected final String TEXT_639 = ");" + NL + "    \t            ";
  protected final String TEXT_640 = NL + "                    whetherReject_";
  protected final String TEXT_641 = " = true;";
  protected final String TEXT_642 = NL + "                        throw(e);";
  protected final String TEXT_643 = NL + "                            ";
  protected final String TEXT_644 = " = new ";
  protected final String TEXT_645 = "Struct();";
  protected final String TEXT_646 = NL + "                                ";
  protected final String TEXT_647 = ".";
  protected final String TEXT_648 = " = ";
  protected final String TEXT_649 = ".";
  protected final String TEXT_650 = ";";
  protected final String TEXT_651 = NL + "                            rejectedCount_";
  protected final String TEXT_652 = " = rejectedCount_";
  protected final String TEXT_653 = " + 1;";
  protected final String TEXT_654 = NL + "                            ";
  protected final String TEXT_655 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_656 = ";";
  protected final String TEXT_657 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_658 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_659 = "++;";
  protected final String TEXT_660 = NL + "            int updateFlag_";
  protected final String TEXT_661 = "=0;";
  protected final String TEXT_662 = NL + "                    ";
  protected final String TEXT_663 = NL + "                        query_";
  protected final String TEXT_664 = " = ";
  protected final String TEXT_665 = ";";
  protected final String TEXT_666 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_667 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_683 = NL + "                globalMap.put(\"";
  protected final String TEXT_684 = "_QUERY\", query_";
  protected final String TEXT_685 = ".toString().trim());";
  protected final String TEXT_686 = NL + "        " + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_687 = NL + "\t                sp_";
  protected final String TEXT_688 = " = conn_";
  protected final String TEXT_689 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_690 = NL + "                updateFlag_";
  protected final String TEXT_691 = "=pstmtUpdate_";
  protected final String TEXT_692 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_693 = " = updatedCount_";
  protected final String TEXT_694 = "+updateFlag_";
  protected final String TEXT_695 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_696 = NL + "\t                conn_";
  protected final String TEXT_697 = ".releaseSavepoint(sp_";
  protected final String TEXT_698 = ");" + NL + "\t            ";
  protected final String TEXT_699 = NL + "            } catch(Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_700 = NL + "\t                conn_";
  protected final String TEXT_701 = ".rollback(sp_";
  protected final String TEXT_702 = ");" + NL + "\t            ";
  protected final String TEXT_703 = " " + NL + "                whetherReject_";
  protected final String TEXT_704 = " = true;";
  protected final String TEXT_705 = NL + "                    throw(e);";
  protected final String TEXT_706 = NL + "                        ";
  protected final String TEXT_707 = " = new ";
  protected final String TEXT_708 = "Struct();";
  protected final String TEXT_709 = NL + "                            ";
  protected final String TEXT_710 = ".";
  protected final String TEXT_711 = " = ";
  protected final String TEXT_712 = ".";
  protected final String TEXT_713 = ";";
  protected final String TEXT_714 = NL + "                        rejectedCount_";
  protected final String TEXT_715 = " = rejectedCount_";
  protected final String TEXT_716 = " + 1;";
  protected final String TEXT_717 = NL + "                        ";
  protected final String TEXT_718 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_719 = ";";
  protected final String TEXT_720 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_721 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_722 = " == 0) {" + NL + "            \t";
  protected final String TEXT_723 = NL + "\t\t\t\tquery_";
  protected final String TEXT_724 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_725 = NL + "                        ";
  protected final String TEXT_726 = NL + "                            query_";
  protected final String TEXT_727 = " = ";
  protected final String TEXT_728 = ";";
  protected final String TEXT_729 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_730 = ".";
  protected final String TEXT_731 = ", pstmtInsert_";
  ...
  protected final String TEXT_738 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_739 = NL + "\t                    sp_";
  protected final String TEXT_740 = " = conn_";
  protected final String TEXT_741 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_742 = NL + "                    insertedCount_";
  protected final String TEXT_743 = " = insertedCount_";
  protected final String TEXT_744 = " + pstmtInsert_";
  protected final String TEXT_745 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_746 = NL + "    \t                conn_";
  protected final String TEXT_747 = ".releaseSavepoint(sp_";
  protected final String TEXT_748 = ");" + NL + "    \t            ";
  protected final String TEXT_749 = NL + "                } catch(Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_750 = NL + "    \t                conn_";
  protected final String TEXT_751 = ".rollback(sp_";
  ...
  protected final String TEXT_758 = "Struct();";
  protected final String TEXT_759 = NL + "                                ";
  protected final String TEXT_760 = ".";
  protected final String TEXT_761 = " = ";
  protected final String TEXT_762 = ".";
  protected final String TEXT_763 = ";";
  protected final String TEXT_764 = NL + "                            rejectedCount_";
  protected final String TEXT_765 = " = rejectedCount_";
  ...
  protected final String TEXT_771 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_795 = NL + "                deletedCount_";
  protected final String TEXT_796 = " = deletedCount_";
  protected final String TEXT_797 = " + pstmt_";
  protected final String TEXT_798 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_799 = NL + "\t                conn_";
  protected final String TEXT_800 = ".releaseSavepoint(sp_";
  protected final String TEXT_801 = ");" + NL + "\t            ";
  protected final String TEXT_802 = NL + "            } catch(Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_803 = NL + "\t                conn_";
  protected final String TEXT_804 = ".rollback(sp_";
  protected final String TEXT_805 = ");" + NL + "\t            ";
  protected final String TEXT_806 = NL + "                whetherReject_";
  protected final String TEXT_807 = " = true;";
  protected final String TEXT_808 = NL + "                    throw(e);";
  protected final String TEXT_809 = NL + "                        ";
  protected final String TEXT_810 = " = new ";
  protected final String TEXT_811 = "Struct();";
  protected final String TEXT_812 = NL + "                            ";
  protected final String TEXT_813 = ".";
  protected final String TEXT_814 = " = ";
  protected final String TEXT_815 = ".";
  protected final String TEXT_816 = ";";
  protected final String TEXT_817 = NL + "                        rejectedCount_";
  protected final String TEXT_818 = " = rejectedCount_";
  ...
  protected final String TEXT_825 = NL + "            nb_line_";
  protected final String TEXT_826 = "++;";
  protected final String TEXT_827 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_838 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_839 = " <= batchSizeCounter_";
  protected final String TEXT_840 = ") {                ";
  protected final String TEXT_841 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_842 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_843 = ": pstmt_";
  protected final String TEXT_844 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_845 = " += (countEach_";
  protected final String TEXT_846 = " < 0 ? 0 : countEach_";
  protected final String TEXT_847 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "\t\t\t\t    \t";
  protected final String TEXT_848 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_849 = " += countSum_";
  protected final String TEXT_850 = "; " + NL + "\t\t\t\t    \t";
  protected final String TEXT_851 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_852 = " += countSum_";
  protected final String TEXT_853 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_854 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_855 = " += countSum_";
  protected final String TEXT_856 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_857 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_858 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_859 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_860 = NL + "                \tint countSum_";
  protected final String TEXT_861 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_862 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_863 = " += (countEach_";
  protected final String TEXT_864 = " < 0 ? 0 : countEach_";
  protected final String TEXT_865 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_866 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_867 = " += countSum_";
  protected final String TEXT_868 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_869 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_870 = " += countSum_";
  protected final String TEXT_871 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_872 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_873 = " += countSum_";
  protected final String TEXT_874 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_875 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_876 = NL + "                }";
  protected final String TEXT_877 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  ...
  protected final String TEXT_882 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_883 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_884 = ": pstmt_";
  protected final String TEXT_885 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_886 = " += (countEach_";
  protected final String TEXT_887 = " < 0 ? 0 : countEach_";
  protected final String TEXT_888 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_889 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_890 = " += countSum_";
  protected final String TEXT_891 = ";" + NL + "            \t    \t";
  protected final String TEXT_892 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_893 = " += countSum_";
  ...
  protected final String TEXT_898 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_899 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_900 = NL + "                \t\tint countSum_";
  protected final String TEXT_901 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_902 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_903 = " += (countEach_";
  protected final String TEXT_904 = " < 0 ? 0 : countEach_";
  protected final String TEXT_905 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_906 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_907 = " += countSum_";
  protected final String TEXT_908 = "; " + NL + "\t\t\t\t    \t";
  protected final String TEXT_909 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_910 = " += countSum_";
  protected final String TEXT_911 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_912 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_913 = " += countSum_";
  protected final String TEXT_914 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_915 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_916 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_917 = NL + "                \tconn_";
  protected final String TEXT_918 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_919 = "=0;" + NL + "                }\t";
