...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_472 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_473 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_474 = " = true;";
  protected final String TEXT_475 = NL + "                    throw(e);";
  protected final String TEXT_476 = NL + "                        ";
  protected final String TEXT_477 = " = new ";
  protected final String TEXT_478 = "Struct();";
  protected final String TEXT_479 = NL + "                            ";
  protected final String TEXT_480 = ".";
  protected final String TEXT_481 = " = ";
  protected final String TEXT_482 = ".";
  protected final String TEXT_483 = ";";
  protected final String TEXT_484 = NL + "                        rejectedCount_";
  protected final String TEXT_485 = " = rejectedCount_";
  protected final String TEXT_486 = " + 1;";
  protected final String TEXT_487 = NL + "                        ";
  protected final String TEXT_488 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_489 = ";";
  protected final String TEXT_490 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_495 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_496 = " = pstmt_";
  protected final String TEXT_497 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_498 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_499 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_500 = " = rs_";
  protected final String TEXT_501 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_502 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_503 = NL + "                        ";
  protected final String TEXT_504 = NL + "                            query_";
  protected final String TEXT_505 = " = ";
  protected final String TEXT_506 = ";";
  protected final String TEXT_507 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_508 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_509 = ".";
  protected final String TEXT_510 = ", pstmtUpdate_";
  ...
  protected final String TEXT_523 = NL + "                    globalMap.put(\"";
  protected final String TEXT_524 = "_QUERY\", query_";
  protected final String TEXT_525 = ".toString().trim());";
  protected final String TEXT_526 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_527 = " = updatedCount_";
  protected final String TEXT_528 = " + pstmtUpdate_";
  protected final String TEXT_529 = ".executeUpdate(); " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_530 = " = true;";
  protected final String TEXT_531 = NL + "                        throw(e);";
  protected final String TEXT_532 = NL + "                            ";
  protected final String TEXT_533 = " = new ";
  protected final String TEXT_534 = "Struct();";
  protected final String TEXT_535 = NL + "                                ";
  protected final String TEXT_536 = ".";
  protected final String TEXT_537 = " = ";
  protected final String TEXT_538 = ".";
  protected final String TEXT_539 = ";";
  protected final String TEXT_540 = NL + "                            rejectedCount_";
  protected final String TEXT_541 = " = rejectedCount_";
  ...
  protected final String TEXT_546 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_547 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_548 = NL + "                        ";
  protected final String TEXT_549 = NL + "                            query_";
  protected final String TEXT_550 = " = ";
  protected final String TEXT_551 = ";";
  protected final String TEXT_552 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_553 = ".";
  protected final String TEXT_554 = ", pstmtInsert_";
  protected final String TEXT_555 = ", ";
  protected final String TEXT_556 = ", \"";
  protected final String TEXT_557 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_558 = NL + "                    globalMap.put(\"";
  protected final String TEXT_559 = "_QUERY\", query_";
  protected final String TEXT_560 = ".toString().trim());";
  protected final String TEXT_561 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_562 = " = insertedCount_";
  protected final String TEXT_563 = " + pstmtInsert_";
  protected final String TEXT_564 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_565 = " = true;";
  protected final String TEXT_566 = NL + "                        throw(e);";
  protected final String TEXT_567 = NL + "                            ";
  protected final String TEXT_568 = " = new ";
  protected final String TEXT_569 = "Struct();";
  protected final String TEXT_570 = NL + "                                ";
  protected final String TEXT_571 = ".";
  protected final String TEXT_572 = " = ";
  protected final String TEXT_573 = ".";
  protected final String TEXT_574 = ";";
  protected final String TEXT_575 = NL + "                            rejectedCount_";
  protected final String TEXT_576 = " = rejectedCount_";
  ...
  protected final String TEXT_581 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_582 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_583 = "++;" + NL + "    \t\t";
  protected final String TEXT_584 = NL + "    \t    int updateFlag_";
  protected final String TEXT_585 = "=0;" + NL + "    \t    ";
  protected final String TEXT_586 = NL + "                    ";
  protected final String TEXT_587 = NL + "                        query_";
  protected final String TEXT_588 = " = ";
  protected final String TEXT_589 = ";";
  protected final String TEXT_590 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_591 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_592 = ".";
  protected final String TEXT_593 = ", pstmtUpdate_";
  ...
  protected final String TEXT_688 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_689 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_690 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_691 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_692 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_693 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_694 = " = deletedCount_";
  protected final String TEXT_695 = " + pstmt_";
  protected final String TEXT_696 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_713 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_714 = NL + "            }";
  protected final String TEXT_715 = NL + "            nb_line_";
  protected final String TEXT_716 = "++;" + NL + "    \t";
  protected final String TEXT_717 = NL + "            if(!whetherReject_";
  protected final String TEXT_718 = ") {";
  protected final String TEXT_719 = NL + "                            ";
  protected final String TEXT_720 = " = new ";
  protected final String TEXT_721 = "Struct();";
  ...
  protected final String TEXT_728 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_729 = " <= batchSizeCounter_";
  protected final String TEXT_730 = ") {                ";
  protected final String TEXT_731 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_732 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_733 = ": pstmt_";
  protected final String TEXT_734 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_735 = " += (countEach_";
  protected final String TEXT_736 = " < 0 ? 0 : countEach_";
  protected final String TEXT_737 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "            \t    \t";
  protected final String TEXT_738 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_739 = " += countSum_";
  ...
  protected final String TEXT_748 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_749 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_750 = NL + "                \tint countSum_";
  protected final String TEXT_751 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_752 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_753 = " += (countEach_";
  protected final String TEXT_754 = " < 0 ? 0 : countEach_";
  protected final String TEXT_755 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_756 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_757 = " += countSum_";
  protected final String TEXT_758 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_759 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_760 = " += countSum_";
  protected final String TEXT_761 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_762 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_763 = " += countSum_";
  protected final String TEXT_764 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_765 = " " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_766 = NL + "                }";
  protected final String TEXT_767 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_768 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_769 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_770 = " <= commitCounter_";
  protected final String TEXT_771 = ") {" + NL + "                ";
  protected final String TEXT_772 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_773 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_774 = ": pstmt_";
  protected final String TEXT_775 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_776 = " += (countEach_";
  protected final String TEXT_777 = " < 0 ? 0 : countEach_";
  protected final String TEXT_778 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_779 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_780 = " += countSum_";
  protected final String TEXT_781 = ";" + NL + "            \t    \t";
  protected final String TEXT_782 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_783 = " += countSum_";
  protected final String TEXT_784 = ";" + NL + "            \t    \t";
  protected final String TEXT_785 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_786 = " += countSum_";
  protected final String TEXT_787 = ";" + NL + "            \t    \t";
  protected final String TEXT_788 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_789 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_790 = NL + "                \t\tint countSum_";
  protected final String TEXT_791 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_792 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_793 = " += (countEach_";
  protected final String TEXT_794 = " < 0 ? 0 : countEach_";
  protected final String TEXT_795 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_796 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_797 = " += countSum_";
  protected final String TEXT_798 = ";" + NL + "            \t    \t";
  protected final String TEXT_799 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_800 = " += countSum_";
  protected final String TEXT_801 = ";" + NL + "            \t    \t";
  protected final String TEXT_802 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_803 = " += countSum_";
  protected final String TEXT_804 = ";" + NL + "            \t    \t";
  protected final String TEXT_805 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_806 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_807 = NL + "                \tconn_";
  protected final String TEXT_808 = ".commit();                " + NL + "                \tcommitCounter_";
