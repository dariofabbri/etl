...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_204 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_267 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_278 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_279 = " = conn_";
  protected final String TEXT_280 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_281 = ".execute(\"";
  protected final String TEXT_282 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_283 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_288 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_295 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_308 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_309 = " = conn_";
  protected final String TEXT_310 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_333 = " = stmtTruncCount_";
  protected final String TEXT_334 = ".executeQuery(\"";
  protected final String TEXT_335 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_338 = ".executeUpdate(\"";
  protected final String TEXT_339 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_340 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_344 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_345 = ".close();";
  protected final String TEXT_346 = NL + "\t    String insert_";
  protected final String TEXT_347 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_348 = " + \" (";
  protected final String TEXT_349 = ") VALUES (";
  protected final String TEXT_350 = ")\";" + NL + "\t   \t";
  protected final String TEXT_351 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_352 = " = new StringBuffer(insert_";
  protected final String TEXT_353 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_354 = ".insert(insert_";
  protected final String TEXT_355 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_356 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_357 = " =insertStringBuffer_";
  protected final String TEXT_358 = ".toString(); ";
  protected final String TEXT_359 = "    \t    " + NL + "\t    ";
  protected final String TEXT_360 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_361 = " = conn_";
  protected final String TEXT_362 = ".prepareStatement(insert_";
  protected final String TEXT_363 = ");";
  protected final String TEXT_364 = NL + "                        ";
  protected final String TEXT_365 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_366 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_367 = " = conn_";
  protected final String TEXT_368 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_369 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_370 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_371 = ",insert_";
  protected final String TEXT_372 = ",keyPsmt_";
  ...
  protected final String TEXT_378 = " WHERE ";
  protected final String TEXT_379 = "\";" + NL + "    \t";
  protected final String TEXT_380 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_381 = " = new StringBuffer(update_";
  protected final String TEXT_382 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_383 = ".insert(update_";
  protected final String TEXT_384 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_385 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_386 = " =updateStringBuffer_";
  ...
  protected final String TEXT_390 = ".prepareStatement(update_";
  ...
  protected final String TEXT_396 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_397 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_398 = " + \" (";
  protected final String TEXT_399 = ") VALUES (";
  protected final String TEXT_400 = ")\";" + NL + "\t   \t";
  protected final String TEXT_401 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_402 = " = new StringBuffer(insert_";
  protected final String TEXT_403 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_404 = ".insert(insert_";
  protected final String TEXT_405 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_406 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_407 = " =insertStringBuffer_";
  protected final String TEXT_408 = ".toString(); ";
  protected final String TEXT_409 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_410 = " = conn_";
  protected final String TEXT_411 = ".prepareStatement(insert_";
  protected final String TEXT_412 = ");" + NL + "\t    String update_";
  protected final String TEXT_413 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_414 = " + \" SET ";
  protected final String TEXT_415 = " WHERE ";
  protected final String TEXT_416 = "\";" + NL + "\t    ";
  protected final String TEXT_417 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_418 = " = new StringBuffer(update_";
  protected final String TEXT_419 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_420 = ".insert(update_";
  protected final String TEXT_421 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_422 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_423 = " =updateStringBuffer_";
  protected final String TEXT_424 = ".toString(); ";
  protected final String TEXT_425 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_426 = " = conn_";
  protected final String TEXT_427 = ".prepareStatement(update_";
  ...
  protected final String TEXT_442 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_462 = NL + "\t    String delete_";
  protected final String TEXT_463 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_464 = " + \" WHERE ";
  protected final String TEXT_465 = "\";" + NL + "\t    ";
  protected final String TEXT_466 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_467 = " = new StringBuffer(delete_";
  protected final String TEXT_468 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_469 = ".insert(delete_";
  protected final String TEXT_470 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_471 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_472 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_476 = ".prepareStatement(delete_";
  protected final String TEXT_477 = ");" + NL + "\t    ";
  protected final String TEXT_478 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_484 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_485 = " = update_";
