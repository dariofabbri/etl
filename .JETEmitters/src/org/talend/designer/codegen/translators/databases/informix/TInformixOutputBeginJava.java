...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_307 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_376 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_377 = " = ";
  protected final String TEXT_378 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_379 = " = 0;" + NL + "        ";
  protected final String TEXT_380 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_381 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_382 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
