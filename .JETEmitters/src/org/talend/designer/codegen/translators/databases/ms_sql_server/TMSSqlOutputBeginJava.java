...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_192 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_221 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_234 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_235 = ".execute(\"";
  protected final String TEXT_236 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_237 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_259 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_260 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_261 = "            ";
  protected final String TEXT_262 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_263 = " = conn_";
  protected final String TEXT_264 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_291 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_292 = ".executeUpdate(\"";
  protected final String TEXT_293 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_294 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_295 = " += rsTruncCount_";
  protected final String TEXT_296 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_297 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_298 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_311 = " = null;    " + NL + "\t\tString keyPsmt_";
  protected final String TEXT_312 = " = conn_";
  protected final String TEXT_313 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_314 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_315 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_316 = ",insert_";
  protected final String TEXT_317 = ",keyPsmt_";
  ...
  protected final String TEXT_342 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_343 = " = conn_";
  protected final String TEXT_344 = ".prepareStatement(update_";
  protected final String TEXT_345 = ");    ";
  protected final String TEXT_346 = NL + "        String update_";
  protected final String TEXT_347 = " = \"UPDATE [\" + tableName_";
  protected final String TEXT_348 = " + \"] SET ";
  protected final String TEXT_349 = " WHERE ";
  protected final String TEXT_350 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_370 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_371 = " + \"] WHERE ";
  protected final String TEXT_372 = "\"); " + NL + "        String insert_";
  protected final String TEXT_373 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_374 = " + \"] (";
  protected final String TEXT_375 = ") VALUES (";
  protected final String TEXT_376 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_377 = " = conn_";
  protected final String TEXT_378 = ".prepareStatement(insert_";
  protected final String TEXT_379 = ");";
  protected final String TEXT_380 = NL + "    \t" + NL + "    class BufferLine_";
  protected final String TEXT_381 = " {";
  protected final String TEXT_382 = NL + "                ";
  protected final String TEXT_383 = " ";
  protected final String TEXT_384 = ";                ";
  protected final String TEXT_385 = "   " + NL + "    " + NL + "        public BufferLine_";
  protected final String TEXT_386 = "(";
  protected final String TEXT_387 = NL + "                    ,";
  protected final String TEXT_388 = NL + "                ";
  protected final String TEXT_389 = " ";
  protected final String TEXT_390 = " " + NL + "        ){";
  protected final String TEXT_391 = NL + "                    this.";
  protected final String TEXT_392 = " = ";
  protected final String TEXT_393 = ";              ";
  protected final String TEXT_394 = "   \t                " + NL + "        }" + NL + "    }" + NL + "    " + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_395 = "> sInsertColValueList";
  protected final String TEXT_396 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_397 = " sInsertColValue";
  protected final String TEXT_398 = " = null; " + NL + "    " + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_399 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_400 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_401 = ".append(\"(";
  protected final String TEXT_402 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_403 = "-1) extendInsertValueStmt_";
  protected final String TEXT_404 = ".append(\",\");" + NL + "    }" + NL + "   " + NL + "\tString insert_";
  protected final String TEXT_405 = " = \"INSERT INTO \"+";
  protected final String TEXT_406 = "+\" (";
  protected final String TEXT_407 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_408 = ".toString();" + NL + "\t" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_409 = " =  conn_";
  protected final String TEXT_410 = ".prepareStatement(insert_";
  protected final String TEXT_411 = ");" + NL + "      " + NL + "    String insertColName";
  protected final String TEXT_412 = " = \"";
  protected final String TEXT_413 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_414 = " =  \"";
  protected final String TEXT_415 = "\"; " + NL + "    int rowCount";
  ...
  protected final String TEXT_425 = ".split(\"\\\\?\");";
  protected final String TEXT_426 = NL + "\t\t\tupdate_";
  protected final String TEXT_427 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_428 = " = update_";
  protected final String TEXT_429 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_430 = " = insert_";
  protected final String TEXT_431 = ".split(\"\\\\?\");";
  ...
  protected final String TEXT_435 = ".split(\"\\\\?\");";
  protected final String TEXT_436 = NL + "\t\t\treplace_";
  protected final String TEXT_437 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_438 = " = replace_";
  protected final String TEXT_439 = ".split(\"\\\\?\");";
  protected final String TEXT_440 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_441 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_442 = " = insertIgnore_";
  protected final String TEXT_443 = ".split(\"\\\\?\");";
  protected final String TEXT_444 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_445 = " = insert_";
  protected final String TEXT_446 = ".split(\"\\\\?\");";
  protected final String TEXT_447 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_448 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_449 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_450 = "\") == true;";
  protected final String TEXT_451 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = ".createStatement();";
  protected final String TEXT_454 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_455 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_456 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_457 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_458 = NL + "     \t\tstmt_";
  protected final String TEXT_459 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_460 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_461 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_462 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_463 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
