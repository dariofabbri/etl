...
public class TMysqlOutputBulkBeginJava
{
  ...
  protected final String TEXT_14 = NL + "\t\tint escape_mode_";
  protected final String TEXT_15 = " = 0;  // 0: double quotes; 1: backslash" + NL + "\t\tif(escapeChar_";
  protected final String TEXT_16 = "=='\\\\'){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_17 = " = 1;" + NL + "\t\t}else if(escapeChar_";
  protected final String TEXT_18 = " == textEnclosure_";
  protected final String TEXT_19 = "){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_20 = " = 0;" + NL + "\t\t}else {" + NL + "\t\t\tthrow new RuntimeException(\"The escape mode only support the '\\\\' or double text enclosure.\");" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_21 = " = new java.io.File(";
  protected final String TEXT_22 = ");\t\t" + NL + "\t\t";
  protected final String TEXT_23 = NL + "\t\tfile_";
  protected final String TEXT_24 = ".getParentFile().mkdirs();" + NL + "\t\t";
  protected final String TEXT_25 = NL + "\t\t\t\t" + NL + "\t\tjava.io.BufferedWriter csvWriter_";
  protected final String TEXT_26 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        new java.io.FileOutputStream(file_";
  protected final String TEXT_27 = ", ";
  protected final String TEXT_28 = "), ";
  protected final String TEXT_29 = "));";
  protected final String TEXT_30 = NL + "      \tlong diskSpace_";
