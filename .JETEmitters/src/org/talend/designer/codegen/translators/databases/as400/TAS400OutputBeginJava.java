...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_172 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_177 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_183 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_190 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_218 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_228 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_229 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_230 = "            ";
  protected final String TEXT_231 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_234 = ".executeUpdate(\"";
  protected final String TEXT_235 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_236 = ".close();";
  protected final String TEXT_237 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_238 = " = conn_";
  protected final String TEXT_239 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_240 = " = stmtTruncCount_";
  protected final String TEXT_241 = ".executeQuery(\"";
  protected final String TEXT_242 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_245 = ".executeUpdate(\"";
  protected final String TEXT_246 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_247 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_248 = " += rsTruncCount_";
  protected final String TEXT_249 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_250 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_251 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_269 = NL + "\t    String insert_";
  protected final String TEXT_270 = " = \"INSERT INTO \" + ";
  protected final String TEXT_271 = " + \" (";
  protected final String TEXT_272 = ") VALUES (";
  protected final String TEXT_273 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_274 = " = conn_";
  protected final String TEXT_275 = ".prepareStatement(insert_";
  protected final String TEXT_276 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_277 = NL + "\t    String update_";
  protected final String TEXT_278 = " = \"UPDATE \" + ";
  protected final String TEXT_279 = " + \" SET ";
  protected final String TEXT_280 = " WHERE ";
  protected final String TEXT_281 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".prepareStatement(update_";
  protected final String TEXT_284 = ");" + NL + "\t    ";
  protected final String TEXT_285 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_286 = " = conn_";
  protected final String TEXT_287 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_288 = " + \" WHERE ";
  protected final String TEXT_289 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_290 = " = \"INSERT INTO \" + ";
  protected final String TEXT_291 = " + \" (";
  protected final String TEXT_292 = ") VALUES (";
  protected final String TEXT_293 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_297 = " = \"UPDATE \" + ";
  protected final String TEXT_298 = " + \" SET ";
  protected final String TEXT_299 = " WHERE ";
  protected final String TEXT_300 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_301 = " = conn_";
  protected final String TEXT_302 = ".prepareStatement(update_";
  protected final String TEXT_303 = ");" + NL + "\t    ";
  protected final String TEXT_304 = NL + "\t    String update_";
  protected final String TEXT_305 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_311 = ");" + NL + "\t    String insert_";
  protected final String TEXT_312 = " = \"INSERT INTO \" + ";
  protected final String TEXT_313 = " + \" (";
  protected final String TEXT_314 = ") VALUES (";
  protected final String TEXT_315 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_316 = " = conn_";
  protected final String TEXT_317 = ".prepareStatement(insert_";
  protected final String TEXT_318 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_319 = NL + "\t    String delete_";
  protected final String TEXT_320 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_324 = ".prepareStatement(delete_";
  protected final String TEXT_325 = ");" + NL + "\t    ";
  protected final String TEXT_326 = NL + "        StringBuffer query_";
  protected final String TEXT_327 = " = null;" + NL + "       \t";
  protected final String TEXT_328 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_334 = ".split(\"\\\\?\");";
  protected final String TEXT_335 = NL + "\t\t\tupdate_";
  protected final String TEXT_336 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_337 = " = update_";
  protected final String TEXT_338 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_339 = " = insert_";
  protected final String TEXT_340 = ".split(\"\\\\?\");";
  protected final String TEXT_341 = NL + "\t\t\tdelete_";
  protected final String TEXT_342 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_343 = " = delete_";
  protected final String TEXT_344 = ".split(\"\\\\?\");";
  protected final String TEXT_345 = NL + "\t\t\treplace_";
  protected final String TEXT_346 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_347 = " = replace_";
  protected final String TEXT_348 = ".split(\"\\\\?\");";
  protected final String TEXT_349 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_350 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_351 = " = insertIgnore_";
  ...
  protected final String TEXT_357 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_358 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_359 = " =null;";
  protected final String TEXT_360 = NL + NL + NL;
