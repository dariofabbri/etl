...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_545 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_546 = " = true;";
  protected final String TEXT_547 = NL + "                    throw(e);";
  ...
  protected final String TEXT_560 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_561 = ";";
  protected final String TEXT_562 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_599 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_623 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_624 = " = pstmt_";
  protected final String TEXT_625 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_626 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_627 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_628 = " = rs_";
  protected final String TEXT_629 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_630 = " > 0) {";
  protected final String TEXT_631 = NL + "                        ";
  protected final String TEXT_632 = NL + "                            query_";
  protected final String TEXT_633 = " = ";
  protected final String TEXT_634 = ";";
  protected final String TEXT_635 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_636 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_637 = ".";
  protected final String TEXT_638 = ", pstmtUpdate_";
  ...
  protected final String TEXT_654 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_655 = " = updatedCount_";
  ...
  protected final String TEXT_675 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_676 = NL + "                        ";
  protected final String TEXT_677 = NL + "                            query_";
  protected final String TEXT_678 = " = ";
  protected final String TEXT_679 = ";";
  protected final String TEXT_680 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_689 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_690 = " = insertedCount_";
  protected final String TEXT_691 = " + pstmtInsert_";
  ...
  protected final String TEXT_710 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_711 = "++;" + NL + "    \t\t";
  protected final String TEXT_712 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_718 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_719 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_720 = ".";
  protected final String TEXT_721 = ", pstmtUpdate_";
  ...
  protected final String TEXT_738 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_739 = " = pstmtUpdate_";
  protected final String TEXT_740 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_741 = " = updatedCount_";
  protected final String TEXT_742 = "+updateFlag_";
  protected final String TEXT_743 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_761 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_762 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_763 = NL + "\t\t\t\tquery_";
  protected final String TEXT_764 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_765 = NL + "                        ";
  protected final String TEXT_766 = NL + "                            query_";
  protected final String TEXT_767 = " = ";
  protected final String TEXT_768 = ";";
  protected final String TEXT_769 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_775 = NL + "                    globalMap.put(\"";
  protected final String TEXT_776 = "_QUERY\", query_";
  protected final String TEXT_777 = ".toString().trim());";
  protected final String TEXT_778 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_779 = " = insertedCount_";
  protected final String TEXT_780 = " + pstmtInsert_";
  protected final String TEXT_781 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_782 = " = true;";
  protected final String TEXT_783 = NL + "                        throw(e);";
  protected final String TEXT_784 = NL + "                            ";
  protected final String TEXT_785 = " = new ";
  protected final String TEXT_786 = "Struct();";
  protected final String TEXT_787 = NL + "                                ";
  protected final String TEXT_788 = ".";
  protected final String TEXT_789 = " = ";
  protected final String TEXT_790 = ".";
  protected final String TEXT_791 = ";";
  protected final String TEXT_792 = NL + "                            rejectedCount_";
  protected final String TEXT_793 = " = rejectedCount_";
  protected final String TEXT_794 = " + 1;";
  protected final String TEXT_795 = NL + "                            ";
  protected final String TEXT_796 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_797 = ";";
  protected final String TEXT_798 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_815 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_816 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_817 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_818 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_819 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_820 = " = deletedCount_";
  protected final String TEXT_821 = " + pstmt_";
  protected final String TEXT_822 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_833 = NL + "                        rejectedCount_";
  protected final String TEXT_834 = " = rejectedCount_";
  ...
  protected final String TEXT_843 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_854 = "                                                " + NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_855 = " <= batchSizeCounter_";
  protected final String TEXT_856 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_857 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_858 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_859 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_860 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_861 = " = pstmt_";
  protected final String TEXT_862 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  protected final String TEXT_863 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_864 = NL + "        \t    \t";
  protected final String TEXT_865 = NL + "        \t    \t\tupdatedCount_";
  protected final String TEXT_866 = NL + "        \t    \t";
  protected final String TEXT_867 = NL + "        \t    \t    deletedCount_";
  protected final String TEXT_868 = NL + "        \t    \t";
  protected final String TEXT_869 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_870 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_871 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_872 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_873 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_874 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_875 = " <= commitCounter_";
  protected final String TEXT_876 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_877 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_878 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_879 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_880 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_881 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_882 = " = pstmt_";
  protected final String TEXT_883 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_884 = NL + "\t\t    \t    \t\tinsertedCount_";
  protected final String TEXT_885 = NL + "\t\t    \t    \t";
  protected final String TEXT_886 = "            \t    \t\t" + NL + "\t\t    \t    \t\tupdatedCount_";
  protected final String TEXT_887 = NL + "\t\t    \t    \t";
  protected final String TEXT_888 = NL + "\t\t    \t    \t    deletedCount_";
  protected final String TEXT_889 = NL + "\t\t    \t    \t";
  protected final String TEXT_890 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_891 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_892 = ":0);" + NL + "\t                ";
  protected final String TEXT_893 = NL + "                \tconn_";
  protected final String TEXT_894 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_895 = "=0;" + NL + "                }\t";
