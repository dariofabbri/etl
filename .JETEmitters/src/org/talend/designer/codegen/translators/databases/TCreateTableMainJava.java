...
public class TCreateTableMainJava
{
  ...
  protected final String TEXT_35 = NL + "            rsTable_";
  protected final String TEXT_36 = ".close();";
  protected final String TEXT_37 = NL + "                if(!whetherExist_";
  protected final String TEXT_38 = ") {" + NL + "                    java.sql.Statement stmt_";
  protected final String TEXT_39 = " = conn_";
  protected final String TEXT_40 = ".createStatement();" + NL + "                    stmt_";
  protected final String TEXT_41 = ".execute(\"";
  protected final String TEXT_42 = "\");                " + NL + "\t\t            ";
  protected final String TEXT_43 = NL + "                }";
  protected final String TEXT_44 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_49 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmt_";
  protected final String TEXT_50 = " = conn_";
  protected final String TEXT_51 = ".createStatement();" + NL + "                stmt_";
  protected final String TEXT_52 = ".execute(\"";
  protected final String TEXT_53 = "\");            " + NL + "\t            ";
  protected final String TEXT_54 = NL + "        ";
  protected final String TEXT_55 = NL + "        globalMap.put(\"";
  protected final String TEXT_56 = "_QUERY\", \"";
  protected final String TEXT_57 = "\");        " + NL + "    } catch(Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_58 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        throw new RuntimeException(\"Creating table failed\", e);" + NL + "    }";
