...
public class TAmazonMysqlOutputMainJava {
  ...
  protected final String TEXT_131 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_157 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_158 = ".execute(\"";
  protected final String TEXT_159 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_160 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_165 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_172 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_182 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_183 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_184 = "            ";
  protected final String TEXT_185 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_191 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_194 = " = stmtTruncCount_";
  protected final String TEXT_195 = ".executeQuery(\"";
  protected final String TEXT_196 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_199 = ".executeUpdate(\"";
  protected final String TEXT_200 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_201 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_202 = " += rsTruncCount_";
  protected final String TEXT_203 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_204 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_205 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_206 = ".close();            ";
  protected final String TEXT_207 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_214 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_215 = ".executeUpdate(\"";
  protected final String TEXT_216 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_217 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_218 = " += rsTruncCount_";
  protected final String TEXT_219 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_220 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_221 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_222 = ".close();";
  protected final String TEXT_223 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_224 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_226 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_227 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_228 = ".append (\"`\" +  ";
  protected final String TEXT_229 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_230 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_252 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_253 = " += \tduplidateClause_";
  protected final String TEXT_254 = ".toString();";
  protected final String TEXT_255 = NL + "\t\t\t\t";
  protected final String TEXT_256 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_257 = " = new StringBuffer(insert_";
  protected final String TEXT_258 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_259 = ".insert(insert_";
  protected final String TEXT_260 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_261 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_262 = " =insertStringBuffer_";
  ...
  protected final String TEXT_267 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_277 = ".prepareStatement(insert_";
  protected final String TEXT_278 = ");\t\t" + NL + "                \t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_279 = ", pstmt_";
  protected final String TEXT_280 = ");" + NL + "                \t\t}else{" + NL + "                \t\t\tpstmt_";
  protected final String TEXT_281 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_282 = ");\t\t\t\t" + NL + "                \t\t}";
  protected final String TEXT_283 = NL + "\t        \t        ";
  protected final String TEXT_284 = "\t            " + NL + "\t            ////////////////////////////////////////////////////////////////////////////////////////////" + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_285 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_286 = ";i++){";
  protected final String TEXT_287 = NL + "                    extendInsertValueStmt_";
  protected final String TEXT_288 = ".append(\"(";
  protected final String TEXT_289 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_290 = ".";
  protected final String TEXT_291 = ")+\")\");";
  protected final String TEXT_292 = NL + "\t\t\t\t    extendInsertValueStmt_";
  protected final String TEXT_293 = ".append(\"(";
  protected final String TEXT_294 = ")\");";
  protected final String TEXT_295 = NL + "                if (i!=";
  protected final String TEXT_296 = "-1) extendInsertValueStmt_";
  protected final String TEXT_297 = ".append(\",\");" + NL + "                }";
  protected final String TEXT_298 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_299 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_300 = " + \"` (";
  protected final String TEXT_301 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_302 = ".";
  protected final String TEXT_303 = ", \"";
  protected final String TEXT_304 = "\")+\") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_305 = ".toString();";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_307 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_308 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_309 = ".";
  protected final String TEXT_310 = ", \"";
  protected final String TEXT_311 = "\")+\") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_312 = ".toString();";
  protected final String TEXT_313 = "            " + NL + "\t\t\t\t    insert_";
  protected final String TEXT_314 = " += \tduplidateClause_";
  protected final String TEXT_315 = ".toString();";
  protected final String TEXT_316 = NL + "\t\t\t\t\t";
  protected final String TEXT_317 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_318 = " = new StringBuffer(insert_";
  protected final String TEXT_319 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_320 = ".insert(insert_";
  protected final String TEXT_321 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_322 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_323 = " =insertStringBuffer_";
  ...
  protected final String TEXT_329 = NL + "\t\t    " + NL + "\t\t\t\t    insertColName";
  protected final String TEXT_330 = " = \"";
  protected final String TEXT_331 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_332 = ".";
  protected final String TEXT_333 = ", \"";
  protected final String TEXT_334 = "\");" + NL + "\t\t\t\t    insertColValue";
  protected final String TEXT_335 = " =  \"";
  protected final String TEXT_336 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_337 = ".";
  protected final String TEXT_338 = "); ";
  protected final String TEXT_339 = NL + "\t      \t\t\tinsertColName";
  protected final String TEXT_340 = " = DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_341 = ".";
  protected final String TEXT_342 = ", \"";
  protected final String TEXT_343 = "\");" + NL + "\t\t\t\t    insertColValue";
  protected final String TEXT_344 = " =  DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_345 = ".";
  protected final String TEXT_346 = "); ";
  protected final String TEXT_347 = NL + "\t\t\t    rowCount";
  protected final String TEXT_348 = " = 0;";
  protected final String TEXT_349 = NL + "\t            int rowCount";
  ...
  protected final String TEXT_354 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  ...
  protected final String TEXT_362 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_363 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_364 = ".";
  protected final String TEXT_365 = ", \"";
  protected final String TEXT_366 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_372 = NL + "\t\t\t\t\t    batchSize_";
  ...
  protected final String TEXT_378 = ";" + NL + "\t\t   \t\t\t    int batchSizeCounter_";
  ...
  protected final String TEXT_389 = "    " + NL + "\t\t        pstmt_";
  ...
  protected final String TEXT_396 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_403 = " + \"` SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = ", \"";
  protected final String TEXT_406 = "\")+\" WHERE ";
  protected final String TEXT_407 = "\";";
  protected final String TEXT_408 = NL + "\t    ";
  protected final String TEXT_409 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_410 = " = new StringBuffer(update_";
  protected final String TEXT_411 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_412 = ".insert(update_";
  protected final String TEXT_413 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_414 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_415 = " =updateStringBuffer_";
  protected final String TEXT_416 = ".toString(); ";
  protected final String TEXT_417 = NL + "\t    pstmt_";
  protected final String TEXT_418 = " = conn_";
  protected final String TEXT_419 = ".prepareStatement(update_";
  protected final String TEXT_420 = ");" + NL + "\t    ";
  protected final String TEXT_421 = NL + "\t\t\t\t\tString insert_";
  protected final String TEXT_422 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_423 = " + \"` (";
  protected final String TEXT_424 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_425 = ".";
  protected final String TEXT_426 = ", \"";
  protected final String TEXT_427 = "\")+\") VALUES (";
  protected final String TEXT_428 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_429 = ".";
  protected final String TEXT_430 = ")+\")\";";
  protected final String TEXT_431 = NL + "\t\t\t\t\tString insert_";
  protected final String TEXT_432 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_433 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_434 = ".";
  protected final String TEXT_435 = ", \"";
  protected final String TEXT_436 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_442 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_443 = ".";
  protected final String TEXT_444 = ", \"";
  protected final String TEXT_445 = "\")+\" WHERE ";
  protected final String TEXT_446 = "\";";
  protected final String TEXT_447 = NL + "\t\t\t\t\tString update_";
  protected final String TEXT_448 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_449 = " + \"` SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_456 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_457 = " + \"` WHERE ";
  protected final String TEXT_458 = "\");//String insert_";
  protected final String TEXT_459 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_460 = " + \"` (";
  protected final String TEXT_461 = ") VALUES (";
  protected final String TEXT_462 = ")\";" + NL + "\t    ";
  protected final String TEXT_463 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_464 = " = new StringBuffer(insert_";
  protected final String TEXT_465 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_466 = ".insert(insert_";
  protected final String TEXT_467 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_468 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_469 = " =insertStringBuffer_";
  protected final String TEXT_470 = ".toString(); ";
  protected final String TEXT_471 = "    " + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_546 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_547 = " + \"` WHERE ";
  protected final String TEXT_548 = "\";" + NL + "\t    ";
  protected final String TEXT_549 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_550 = " = new StringBuffer(delete_";
  protected final String TEXT_551 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_552 = ".insert(delete_";
  protected final String TEXT_553 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_554 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_555 = " =deleteStringBuffer_";
  protected final String TEXT_556 = ".toString();  ";
  protected final String TEXT_557 = NL + "\t    pstmt_";
  ...
  protected final String TEXT_561 = NL + "\t    String replace_";
  protected final String TEXT_562 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_567 = ".prepareStatement(replace_";
  protected final String TEXT_568 = ");" + NL + "\t    ";
  protected final String TEXT_569 = NL + "\t    String insertIgnore_";
  protected final String TEXT_570 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_571 = " + \"` (";
  protected final String TEXT_572 = ") VALUES (";
  protected final String TEXT_573 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_574 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_575 = " = conn_";
  protected final String TEXT_576 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_577 = ");" + NL + "\t    ";
  protected final String TEXT_578 = NL + "\t    String insert_";
  protected final String TEXT_579 = " = \"INSERT IGNORE INTO `\" + ";
  ...
  protected final String TEXT_595 = NL + "        StringBuffer query_";
  protected final String TEXT_596 = " = null;" + NL + "       \t";
  protected final String TEXT_597 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_604 = NL + "\t\t\tupdate_";
  protected final String TEXT_605 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_606 = " = update_";
  protected final String TEXT_607 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_608 = " = insert_";
  protected final String TEXT_609 = ".split(\"\\\\?\");";
  protected final String TEXT_610 = NL + "\t\t\tdelete_";
  protected final String TEXT_611 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_612 = " = delete_";
  protected final String TEXT_613 = ".split(\"\\\\?\");";
  protected final String TEXT_614 = NL + "\t\t\treplace_";
  protected final String TEXT_615 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_616 = " = replace_";
  protected final String TEXT_617 = ".split(\"\\\\?\");";
  protected final String TEXT_618 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_619 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_620 = " = insertIgnore_";
  protected final String TEXT_621 = ".split(\"\\\\?\");";
  protected final String TEXT_622 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_632 = ",java.sql.Types.CHAR);";
  ...
  protected final String TEXT_638 = ",java.sql.Types.DATE);";
  protected final String TEXT_639 = NL + "                if(";
  protected final String TEXT_640 = ".";
  protected final String TEXT_641 = "==null){";
  protected final String TEXT_642 = NL + "                    ";
  protected final String TEXT_643 = ".setNull(counter";
  protected final String TEXT_644 = ",java.sql.Types.ARRAY);         ";
  protected final String TEXT_645 = NL + "                if(";
  protected final String TEXT_646 = ".";
  protected final String TEXT_647 = "==null){";
  protected final String TEXT_648 = NL + "                    ";
  protected final String TEXT_649 = ".setNull(counter";
  protected final String TEXT_650 = ",java.sql.Types.INTEGER);";
  ...
  protected final String TEXT_656 = ",java.sql.Types.VARCHAR);";
  ...
  protected final String TEXT_662 = ",java.sql.Types.OTHER);";
  ...
  protected final String TEXT_668 = ",java.sql.Types.BOOLEAN);   ";
  protected final String TEXT_669 = NL + "                if(";
  protected final String TEXT_670 = ".";
  protected final String TEXT_671 = "==null){";
  protected final String TEXT_672 = NL + "                    ";
  protected final String TEXT_673 = ".setNull(counter";
  protected final String TEXT_674 = ",java.sql.Types.DOUBLE);    ";
  protected final String TEXT_675 = NL + "                if(";
  protected final String TEXT_676 = ".";
  protected final String TEXT_677 = "==null){";
  protected final String TEXT_678 = NL + "                    ";
  protected final String TEXT_679 = ".setNull(counter";
  protected final String TEXT_680 = ",java.sql.Types.FLOAT); ";
  protected final String TEXT_681 = NL + "                }else{";
  protected final String TEXT_682 = NL + "                    if(";
  protected final String TEXT_683 = ".";
  protected final String TEXT_684 = "==null){";
  protected final String TEXT_685 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_686 = ".";
  protected final String TEXT_687 = ").toLowerCase())){";
  protected final String TEXT_688 = NL + "                ";
  protected final String TEXT_689 = ".setNull(counter";
  protected final String TEXT_690 = ",java.sql.Types.CHAR);" + NL + "            " + NL + "                }else if(";
  protected final String TEXT_691 = ".";
  protected final String TEXT_692 = " == '\\0'){" + NL + "        ";
  protected final String TEXT_693 = NL + "                    ";
  protected final String TEXT_694 = ".setString(counter";
  ...
  protected final String TEXT_712 = ".setString(counter";
  protected final String TEXT_713 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_714 = NL + "                        ";
  protected final String TEXT_715 = ".setTimestamp(counter";
  protected final String TEXT_716 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_717 = "));" + NL + "                    }" + NL + "                }else{" + NL + "        ";
  protected final String TEXT_718 = NL + "                    ";
  protected final String TEXT_719 = ".setNull(counter";
  protected final String TEXT_720 = ",java.sql.Types.DATE);" + NL + "            " + NL + "                }";
  protected final String TEXT_721 = NL + "                ";
  protected final String TEXT_722 = ".set";
  protected final String TEXT_723 = "(counter";
  protected final String TEXT_724 = ",";
  protected final String TEXT_725 = ".";
  protected final String TEXT_726 = ");";
  protected final String TEXT_727 = NL + "            " + NL + "                }" + NL + "        ";
  protected final String TEXT_728 = NL + "\t\tquery_";
  protected final String TEXT_729 = " = new StringBuffer(\"\");";
  protected final String TEXT_730 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_731 = " = buffersSize_";
  protected final String TEXT_732 = ";";
  protected final String TEXT_733 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_734 = " = buffersSize_";
  protected final String TEXT_735 = ";";
  protected final String TEXT_736 = NL + "\t\t";
  protected final String TEXT_737 = NL + "        whetherReject_";
  protected final String TEXT_738 = " = false;";
  protected final String TEXT_739 = "                " + NL + "\t                \tint counter";
  protected final String TEXT_740 = " = rowCount";
  protected final String TEXT_741 = " * ";
  protected final String TEXT_742 = " + 1;" + NL + "\t                ";
  protected final String TEXT_743 = NL + "\t                        counter";
  protected final String TEXT_744 = "++;" + NL + "\t                        ";
  protected final String TEXT_745 = NL + "\t\t\t\t\t\t\tint count_dyn_";
  protected final String TEXT_746 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_747 = ".";
  protected final String TEXT_748 = ", pstmt_";
  protected final String TEXT_749 = ", counter";
  protected final String TEXT_750 = "-1, \"";
  protected final String TEXT_751 = "\");" + NL + "\t\t\t\t\t\t\tcounter";
  protected final String TEXT_752 = "+=count_dyn_";
  protected final String TEXT_753 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_754 = NL + "\t             " + NL + "\t                exInsertColValue";
  protected final String TEXT_755 = " = new BufferLine_";
  ...
  protected final String TEXT_764 = "  " + NL + "\t                ); " + NL + "\t               " + NL + "\t                exInsertColValueList";
  protected final String TEXT_765 = ".add(exInsertColValue";
  protected final String TEXT_766 = ");" + NL + "\t    " + NL + "\t                rowCount";
  protected final String TEXT_767 = "++;";
  protected final String TEXT_768 = NL + "\t\t\t\tnb_line_";
  protected final String TEXT_769 = "++;";
  protected final String TEXT_770 = "\t         " + NL + "\t                if(rowCount";
  ...
  protected final String TEXT_775 = ".executeUpdate();" + NL + "\t                    exInsertColValueList";
  protected final String TEXT_776 = ".clear();" + NL + "\t                    rowCount";
  protected final String TEXT_777 = " = 0;" + NL + "\t\t\t    counter";
  protected final String TEXT_778 = "=1;" + NL + "\t                }    ";
  ...
  protected final String TEXT_784 = NL + "\t\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_792 = ".toString().trim());" + NL + "\t                    ";
  protected final String TEXT_793 = NL + "\t\t\t\t\t";
  protected final String TEXT_794 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_795 = ".addBatch();" + NL + "\t\t    \t\tnb_line_";
  ...
  protected final String TEXT_804 = "++;" + NL + "\t                } catch(Exception e) {" + NL + "\t                    whetherReject_";
  protected final String TEXT_805 = " = true;" + NL + "\t                    ";
  protected final String TEXT_806 = NL + "\t                        throw(e);" + NL + "\t                        ";
  ...
  protected final String TEXT_818 = NL + "\t                            System.err.print(e.getMessage());" + NL + "\t                            ";
  ...
  protected final String TEXT_824 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_833 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_834 = " = insertedCount_";
  protected final String TEXT_835 = " + pstmt_";
  protected final String TEXT_836 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_837 = "++;" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_842 = "Struct();";
  ...
  protected final String TEXT_858 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_859 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_860 = ".";
  protected final String TEXT_861 = ", pstmt_";
  ...
  protected final String TEXT_879 = NL + "    \t\tpstmt_";
  protected final String TEXT_880 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_881 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_882 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_883 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_884 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_885 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_886 = " = updatedCount_";
  protected final String TEXT_887 = " + pstmt_";
  protected final String TEXT_888 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_889 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_901 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_902 = ";";
  protected final String TEXT_903 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_909 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_910 = " = pstmt_";
  protected final String TEXT_911 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_912 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_913 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_914 = " = rs_";
  protected final String TEXT_915 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_916 = " > 0) {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_922 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_923 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_939 = NL + "                    globalMap.put(\"";
  protected final String TEXT_940 = "_QUERY\", query_";
  protected final String TEXT_941 = ".toString().trim());";
  protected final String TEXT_942 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_943 = " = updatedCount_";
  protected final String TEXT_944 = " + pstmtUpdate_";
  protected final String TEXT_945 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_960 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_968 = ", pstmtInsert_";
  ...
  protected final String TEXT_975 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_976 = " = insertedCount_";
  protected final String TEXT_977 = " + pstmtInsert_";
  protected final String TEXT_978 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_990 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_991 = ";";
  protected final String TEXT_992 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_993 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_994 = "++;" + NL + "    \t\t";
  protected final String TEXT_995 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_1005 = ", pstmtUpdate_";
  ...
  protected final String TEXT_1019 = NL + "                globalMap.put(\"";
  protected final String TEXT_1020 = "_QUERY\", query_";
  protected final String TEXT_1021 = ".toString().trim());";
  protected final String TEXT_1022 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_1023 = "=pstmtUpdate_";
  protected final String TEXT_1024 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1025 = " = updatedCount_";
  protected final String TEXT_1026 = "+updateFlag_";
  protected final String TEXT_1027 = ";" + NL + "                " + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1028 = " = true;";
  protected final String TEXT_1029 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1039 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1040 = ";";
  protected final String TEXT_1041 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1042 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_1043 = " == 0) {" + NL + "            " + NL + "            \t";
  protected final String TEXT_1044 = NL + "\t\t\t\tquery_";
  protected final String TEXT_1045 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_1051 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1052 = ".";
  protected final String TEXT_1053 = ", pstmtInsert_";
  ...
  protected final String TEXT_1060 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_1061 = " = insertedCount_";
  ...
  protected final String TEXT_1078 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_1090 = NL + "                globalMap.put(\"";
  protected final String TEXT_1091 = "_QUERY\", query_";
  protected final String TEXT_1092 = ".toString().trim());";
  protected final String TEXT_1093 = NL + "        \t";
  protected final String TEXT_1094 = NL + "    \t\tpstmt_";
  protected final String TEXT_1095 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_1100 = NL + "            try {" + NL + "        \t    deletedCount_";
  protected final String TEXT_1101 = " = deletedCount_";
  protected final String TEXT_1102 = " + pstmt_";
  protected final String TEXT_1103 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1104 = " = true;";
  protected final String TEXT_1105 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1118 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1119 = ";" + NL + "                       ";
  protected final String TEXT_1120 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1121 = NL + "            }";
  protected final String TEXT_1122 = NL + "            nb_line_";
  ...
  protected final String TEXT_1128 = NL + "                globalMap.put(\"";
  protected final String TEXT_1129 = "_QUERY\", query_";
  protected final String TEXT_1130 = ".toString().trim());";
  protected final String TEXT_1131 = NL + "            int replaceCount_";
  protected final String TEXT_1132 = " = 0;" + NL + "            try {" + NL + "                replaceCount_";
  protected final String TEXT_1133 = " = pstmt_";
  protected final String TEXT_1134 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1135 = " = true;";
  protected final String TEXT_1136 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1149 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1150 = ";";
  protected final String TEXT_1151 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1152 = "                " + NL + "            }" + NL + "            if(replaceCount_";
  protected final String TEXT_1153 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1154 = " += replaceCount_";
  protected final String TEXT_1155 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1156 = " += 1;" + NL + "                deletedCount_";
  protected final String TEXT_1157 = " += replaceCount_";
  protected final String TEXT_1158 = " - 1;" + NL + "            }";
  ...
  protected final String TEXT_1167 = NL + "                globalMap.put(\"";
  protected final String TEXT_1168 = "_QUERY\", query_";
  protected final String TEXT_1169 = ".toString().trim());";
  protected final String TEXT_1170 = NL + "            int count_on_duplicate_key_";
  protected final String TEXT_1171 = " = 0;" + NL + "            try {" + NL + "                count_on_duplicate_key_";
  protected final String TEXT_1172 = " = pstmt_";
  protected final String TEXT_1173 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1174 = " = true;";
  protected final String TEXT_1175 = NL + "                    throw(e);";
  protected final String TEXT_1176 = NL + "                        ";
  protected final String TEXT_1177 = " = new ";
  protected final String TEXT_1178 = "Struct();";
  ...
  protected final String TEXT_1184 = NL + "                        rejectedCount_";
  protected final String TEXT_1185 = " =  rejectedCount_";
  ...
  protected final String TEXT_1191 = "                " + NL + "            }" + NL + "            if(count_on_duplicate_key_";
  protected final String TEXT_1192 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1193 = " += count_on_duplicate_key_";
  protected final String TEXT_1194 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1195 = " += 1;" + NL + "                updatedCount_";
  protected final String TEXT_1196 = " += count_on_duplicate_key_";
  protected final String TEXT_1197 = " - 1;" + NL + "            }";
  protected final String TEXT_1198 = NL + "                        ";
  protected final String TEXT_1199 = NL + "                            query_";
  ...
  protected final String TEXT_1209 = "++;" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1210 = " = true;";
  protected final String TEXT_1211 = NL + "                        throw(e);";
  ...
  protected final String TEXT_1224 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1225 = ";";
  protected final String TEXT_1226 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1227 = NL + "                }";
  protected final String TEXT_1228 = NL + "            if(!whetherReject_";
  protected final String TEXT_1229 = ") {";
  protected final String TEXT_1230 = NL + "                            ";
  protected final String TEXT_1231 = " = new ";
  protected final String TEXT_1232 = "Struct();";
  ...
  protected final String TEXT_1239 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1240 = " <= batchSizeCounter_";
  protected final String TEXT_1241 = ") {                ";
  protected final String TEXT_1242 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1243 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1244 = ": pstmt_";
  protected final String TEXT_1245 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1246 = " += (countEach_";
  protected final String TEXT_1247 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1248 = ");" + NL + "\t\t\t\t\t\t}                  \t" + NL + "            \t    \t";
  protected final String TEXT_1249 = NL + "            \t    \tinsertedCount_";
  protected final String TEXT_1250 = " += countSum_";
  protected final String TEXT_1251 = ";" + NL + "            \t    \t";
  protected final String TEXT_1252 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1253 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1254 = NL + "                \tint countSum_";
  protected final String TEXT_1255 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1256 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1257 = " += (countEach_";
  protected final String TEXT_1258 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1259 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1260 = NL + "            \t    insertedCount_";
  protected final String TEXT_1261 = " += countSum_";
  protected final String TEXT_1262 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_1263 = "  " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1264 = NL + "                }";
  protected final String TEXT_1265 = "    " + NL + "                \t\t\t" + NL + "    \t\t\tbatchSizeCounter_";
  protected final String TEXT_1266 = " = 0;" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_1267 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1268 = " <= batchSizeCounter_";
  protected final String TEXT_1269 = ") {                ";
  protected final String TEXT_1270 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1271 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1272 = ": pstmt_";
  protected final String TEXT_1273 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1274 = " += (countEach_";
  protected final String TEXT_1275 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1276 = ");" + NL + "\t\t\t\t\t\t}              \t" + NL + "            \t    \t";
  protected final String TEXT_1277 = NL + "            \t    \tupdatedCount_";
  protected final String TEXT_1278 = " += countSum_";
  protected final String TEXT_1279 = ";" + NL + "            \t    \t";
  protected final String TEXT_1280 = NL + "            \t    \tdeletedCount_";
  protected final String TEXT_1281 = " += countSum_";
  protected final String TEXT_1282 = ";" + NL + "            \t    \t";
  protected final String TEXT_1283 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1284 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1285 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1286 = NL + "                \tint countSum_";
  protected final String TEXT_1287 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1288 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1289 = " += (countEach_";
  protected final String TEXT_1290 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1291 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1292 = NL + "            \t    updatedCount_";
  protected final String TEXT_1293 = " += countSum_";
  protected final String TEXT_1294 = ";" + NL + "            \t    ";
  protected final String TEXT_1295 = NL + "            \t    deletedCount_";
  protected final String TEXT_1296 = " += countSum_";
  ...
  protected final String TEXT_1300 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1301 = NL + "        \t    commitCounter_";
  protected final String TEXT_1302 = "++;" + NL + "       " + NL + "                if(commitEvery_";
  protected final String TEXT_1303 = " <= commitCounter_";
  protected final String TEXT_1304 = ") {" + NL + "                ";
  protected final String TEXT_1305 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1306 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1307 = ": pstmt_";
  protected final String TEXT_1308 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1309 = " += (countEach_";
  protected final String TEXT_1310 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1311 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_1312 = NL + "            \t    \tinsertedCount_";
  protected final String TEXT_1313 = " += countSum_";
  protected final String TEXT_1314 = ";" + NL + "            \t    \t";
  protected final String TEXT_1315 = "            \t    \t\t" + NL + "            \t    \tupdatedCount_";
  protected final String TEXT_1316 = " += countSum_";
  protected final String TEXT_1317 = ";" + NL + "            \t    \t";
  protected final String TEXT_1318 = NL + "            \t    \tdeletedCount_";
  protected final String TEXT_1319 = " += countSum_";
  protected final String TEXT_1320 = ";" + NL + "            \t    \t";
  protected final String TEXT_1321 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1322 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1323 = NL + "                \tint countSum_";
  protected final String TEXT_1324 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1325 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1326 = " += (countEach_";
  protected final String TEXT_1327 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1328 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1329 = NL + "        \t    \tinsertedCount_";
  protected final String TEXT_1330 = " += countSum_";
  protected final String TEXT_1331 = ";" + NL + "        \t    \t";
  protected final String TEXT_1332 = "            \t    \t\t" + NL + "        \t    \tupdatedCount_";
  protected final String TEXT_1333 = " += countSum_";
  protected final String TEXT_1334 = ";" + NL + "        \t    \t";
  protected final String TEXT_1335 = NL + "        \t    \tdeletedCount_";
  protected final String TEXT_1336 = " += countSum_";
  protected final String TEXT_1337 = ";" + NL + "        \t    \t";
  protected final String TEXT_1338 = NL + "                    System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1339 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1340 = NL + "                \tconn_";
  protected final String TEXT_1341 = ".commit();" + NL + "                \t" + NL + "                \tcommitCounter_";
  protected final String TEXT_1342 = "=0;" + NL + "                " + NL + "                }\t" + NL + "    ";
