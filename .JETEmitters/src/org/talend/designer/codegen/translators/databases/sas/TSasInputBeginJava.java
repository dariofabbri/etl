...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_92 = " = \"jdbc:sasiom://\"+";
  ...
  protected final String TEXT_100 = ";" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_101 = " = new java.util.Properties();" + NL + "\t\t\t" + NL + "\t\t\tproperty_";
  protected final String TEXT_102 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_103 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_104 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_105 = ");" + NL + "\t\t\t";
  protected final String TEXT_106 = NL + "\t\t\tconn_";
  protected final String TEXT_107 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_108 = ", property_";
  protected final String TEXT_109 = ");";
  protected final String TEXT_110 = NL + "\t\t\tif(rs_";
  protected final String TEXT_111 = ".getString(";
  protected final String TEXT_112 = ")!=null&&(rs_";
  ...
  protected final String TEXT_118 = ").charAt(0);" + NL + "\t\t\t}else{\t\t\t  \t";
  protected final String TEXT_119 = NL + "\t\t\t\t\tif((rs_";
  protected final String TEXT_120 = ".getString(";
  protected final String TEXT_121 = "))==null){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_122 = ".";
  protected final String TEXT_123 = "=null;" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = "='\\0';" + NL + "\t\t\t  \t\t}";
  protected final String TEXT_126 = NL + "\t\t\t  \t\t" + NL + "\t\t\t  \t\tif((rs_";
  protected final String TEXT_127 = ".getString(";
  protected final String TEXT_128 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_131 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  protected final String TEXT_132 = NL + "\t\t\t  " + NL + "\t\t\t}\t\t";
  protected final String TEXT_133 = NL + "    " + NL + "\t";
  protected final String TEXT_134 = NL + "\t\t    int nb_line_";
  protected final String TEXT_135 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_139 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_140 = ") {";
  protected final String TEXT_141 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_142 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_143 = " = dataSources_";
  protected final String TEXT_144 = ".get(";
  protected final String TEXT_145 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_146 = "\", conn_";
  protected final String TEXT_147 = ");" + NL + "\t\t        }";
  protected final String TEXT_148 = NL + NL + "\t\t    ";
  protected final String TEXT_149 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_152 = "_QUERY\",dbquery_";
  protected final String TEXT_153 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_154 = " = stmt_";
  protected final String TEXT_155 = ".executeQuery(dbquery_";
  protected final String TEXT_156 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_157 = " = rs_";
  protected final String TEXT_158 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_159 = " = rsmd_";
  protected final String TEXT_160 = ".getColumnCount();" + NL;
  protected final String TEXT_161 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_162 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_163 = ".setDbmsId(\"";
  protected final String TEXT_164 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_165 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_166 = "=1; i_";
  protected final String TEXT_167 = "<";
  protected final String TEXT_168 = "; i_";
  protected final String TEXT_169 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_170 = ".add(rsmd_";
  protected final String TEXT_171 = ".getColumnName(i_";
  protected final String TEXT_172 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_173 = " = ";
  protected final String TEXT_174 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_175 = "; i <= rsmd_";
  protected final String TEXT_176 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_177 = ".contains(rsmd_";
  protected final String TEXT_178 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_179 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_180 = ".setName(rsmd_";
  protected final String TEXT_181 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_182 = ".setDbName(rsmd_";
  protected final String TEXT_183 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_184 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_185 = "\", rsmd_";
  protected final String TEXT_186 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_187 = ".getPrecision(i), rsmd_";
  protected final String TEXT_188 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_189 = ".setDbType(rsmd_";
  protected final String TEXT_190 = ".getColumnTypeName(i));";
  protected final String TEXT_191 = NL + "                \tdcm_";
  protected final String TEXT_192 = ".setFormat(";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_195 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_196 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_197 = ".setLength(rsmd_";
  protected final String TEXT_198 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_199 = ".setLength(rsmd_";
  protected final String TEXT_200 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_201 = NL + "\t\t\tdcm_";
  protected final String TEXT_202 = ".setLength(rsmd_";
  protected final String TEXT_203 = ".getPrecision(i));";
  protected final String TEXT_204 = NL + "                \tdcm_";
  protected final String TEXT_205 = ".setPrecision(rsmd_";
  protected final String TEXT_206 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_207 = ".setNullable(rsmd_";
  protected final String TEXT_208 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_209 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_210 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_211 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_212 = ".metadatas.add(dcm_";
  protected final String TEXT_213 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_214 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_215 = " = null;" + NL + "\t\t    while (rs_";
  ...
  protected final String TEXT_278 = ".getObject(";
