...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_127 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_164 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_193 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_222 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
