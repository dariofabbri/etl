...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_92 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_103 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_104 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  ...
  protected final String TEXT_192 = " = (List)rs_";
  protected final String TEXT_193 = ".getObject(";
  protected final String TEXT_194 = ");";
  protected final String TEXT_195 = NL + "\t\t                         ";
  protected final String TEXT_196 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_197 = ".getObject(";
  protected final String TEXT_198 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_199 = NL + "                                    ";
  protected final String TEXT_200 = ".";
  protected final String TEXT_201 = " = new Geometry(wktValue);";
  protected final String TEXT_202 = NL + "                                        ";
  protected final String TEXT_203 = ".";
  protected final String TEXT_204 = ".setEPSG(";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_207 = NL + "                                  ";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = "=dcg_";
  protected final String TEXT_210 = ";";
  protected final String TEXT_211 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_212 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_213 = " = ";
  protected final String TEXT_214 = "; i_";
  protected final String TEXT_215 = "  <= rsmd_";
  protected final String TEXT_216 = ".getColumnCount(); i_";
  protected final String TEXT_217 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_218 = ".getColumnTypeName(i_";
  protected final String TEXT_219 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_220 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_221 = ".getClob(i_";
  protected final String TEXT_222 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_223 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_224 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_225 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_226 = ".add(tNTextImpl_";
  protected final String TEXT_227 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_228 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_229 = ".";
  protected final String TEXT_230 = ", rs_";
  protected final String TEXT_231 = ", fixedColumnCount_";
  protected final String TEXT_232 = ",list_";
  protected final String TEXT_233 = ");";
  protected final String TEXT_234 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_235 = ".";
  protected final String TEXT_236 = ", rs_";
  protected final String TEXT_237 = ", fixedColumnCount_";
  protected final String TEXT_238 = ");";
  protected final String TEXT_239 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_240 = ".getObject(";
  protected final String TEXT_241 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = " = new Geometry(sb.toString());";
