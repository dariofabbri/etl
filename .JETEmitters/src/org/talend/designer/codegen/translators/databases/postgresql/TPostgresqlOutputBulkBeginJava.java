...
public class TPostgresqlOutputBulkBeginJava
{
  ...
  protected final String TEXT_12 = NL + "        \tchar escapeChar_";
  protected final String TEXT_13 = " = ";
  protected final String TEXT_14 = ";" + NL + "" + NL + "       \t\tchar textEnclosure_";
  protected final String TEXT_15 = " = ";
  protected final String TEXT_16 = ";" + NL + "" + NL + "\t        int escape_mode_";
  protected final String TEXT_17 = " = 0;  // 0: double quotes; 1: backslash" + NL + "    \t    if(escapeChar_";
  protected final String TEXT_18 = "=='\\\\'){" + NL + "        \t    escape_mode_";
  protected final String TEXT_19 = " = 1;" + NL + "\t        }else if(escapeChar_";
  protected final String TEXT_20 = " == textEnclosure_";
  protected final String TEXT_21 = "){" + NL + "    \t        escape_mode_";
  protected final String TEXT_22 = " = 0;" + NL + "        \t}else {" + NL + "            \tthrow new RuntimeException(\"The escape mode only support the '\\\\' or double text enclosure.\");" + NL + "\t        }";
  protected final String TEXT_23 = NL + "    \t\t\t\tout";
  protected final String TEXT_24 = ".write(\"";
  protected final String TEXT_25 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_26 = "out";
  protected final String TEXT_27 = ".write(OUT_DELIM_";
