...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_164 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_220 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_240 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_241 = ".execute(\"";
  protected final String TEXT_242 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_243 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_248 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_255 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_265 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_266 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_267 = "            ";
  protected final String TEXT_268 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_271 = ".executeUpdate(\"";
  protected final String TEXT_272 = "\");" + NL + "            stmtClear_";
  ...
  protected final String TEXT_306 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_307 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_309 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_310 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_311 = ".append (\"`\" +  ";
  protected final String TEXT_312 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_313 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_341 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_342 = " = conn_";
  protected final String TEXT_343 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_344 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_345 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_346 = ",insert_";
  protected final String TEXT_347 = ",keyPsmt_";
  protected final String TEXT_348 = ");";
  protected final String TEXT_349 = NL + "\t        \t        ";
  protected final String TEXT_350 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_351 = " {" + NL + "    \t            ";
  protected final String TEXT_352 = NL + "                            ";
  protected final String TEXT_353 = " ";
  protected final String TEXT_354 = ";                ";
  protected final String TEXT_355 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_356 = "(";
  protected final String TEXT_357 = NL + "                                ,";
  protected final String TEXT_358 = NL + "                            ";
  protected final String TEXT_359 = " ";
  protected final String TEXT_360 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_361 = NL + "                                this.";
  protected final String TEXT_362 = " = ";
  protected final String TEXT_363 = ";              ";
  protected final String TEXT_364 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_365 = "> exInsertColValueList";
  protected final String TEXT_366 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_367 = " exInsertColValue";
  protected final String TEXT_368 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_369 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_370 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_371 = ".append(\"(";
  protected final String TEXT_372 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_373 = "-1) extendInsertValueStmt_";
  protected final String TEXT_374 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_375 = " = \"INSERT INTO `\"+";
  protected final String TEXT_376 = "+\"` (";
  protected final String TEXT_377 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_378 = ".toString();";
  protected final String TEXT_379 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_380 = " += \tduplidateClause_";
  ...
  protected final String TEXT_394 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_395 = " = \"";
  protected final String TEXT_396 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_397 = " =  \"";
  protected final String TEXT_398 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_399 = " = 0;\t ";
  protected final String TEXT_400 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_401 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_408 = NL + "\t\t        int batchSize_";
  protected final String TEXT_409 = " = ";
  protected final String TEXT_410 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_411 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_412 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_413 = " = new StringBuffer(insert_";
  protected final String TEXT_414 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_415 = ".insert(insert_";
  protected final String TEXT_416 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_417 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_418 = " =insertStringBuffer_";
  ...
  protected final String TEXT_425 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_443 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_444 = " + \"` WHERE ";
  protected final String TEXT_445 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_446 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_447 = " + \"` (";
  protected final String TEXT_448 = ") VALUES (";
  protected final String TEXT_449 = ")\";" + NL + "\t    ";
  protected final String TEXT_450 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_451 = " = new StringBuffer(insert_";
  protected final String TEXT_452 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_453 = ".insert(insert_";
  protected final String TEXT_454 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_455 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_456 = " =insertStringBuffer_";
  protected final String TEXT_457 = ".toString(); ";
  protected final String TEXT_458 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_479 = " = \"UPDATE `\" + ";
  protected final String TEXT_480 = " + \"` SET ";
  protected final String TEXT_481 = " WHERE ";
  protected final String TEXT_482 = "\";" + NL + "\t    ";
  protected final String TEXT_483 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_484 = " = new StringBuffer(update_";
  protected final String TEXT_485 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_486 = ".insert(update_";
  protected final String TEXT_487 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_488 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_489 = " =updateStringBuffer_";
  ...
  protected final String TEXT_499 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_500 = " = new StringBuffer(insert_";
  protected final String TEXT_501 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_502 = ".insert(insert_";
  protected final String TEXT_503 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_504 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_505 = " =insertStringBuffer_";
  ...
  protected final String TEXT_512 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_513 = " + \"` WHERE ";
  protected final String TEXT_514 = "\";" + NL + "\t    ";
  protected final String TEXT_515 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_516 = " = new StringBuffer(delete_";
  protected final String TEXT_517 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_518 = ".insert(delete_";
  protected final String TEXT_519 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_520 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_521 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_527 = NL + "\t    String replace_";
  protected final String TEXT_528 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_533 = ".prepareStatement(replace_";
  protected final String TEXT_534 = ");" + NL + "\t    ";
  protected final String TEXT_535 = NL + "\t    String insertIgnore_";
  protected final String TEXT_536 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_537 = " + \"` (";
  protected final String TEXT_538 = ") VALUES (";
  protected final String TEXT_539 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_540 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_541 = " = conn_";
  protected final String TEXT_542 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_543 = ");" + NL + "\t    ";
  protected final String TEXT_544 = NL + "\t    String insert_";
  protected final String TEXT_545 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_546 = " + \"` (";
  protected final String TEXT_547 = ") VALUES (";
  protected final String TEXT_548 = ")\";" + NL + "\t    ";
  protected final String TEXT_549 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_550 = " = new StringBuffer(insert_";
  protected final String TEXT_551 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_552 = ".insert(insert_";
  protected final String TEXT_553 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_554 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_555 = " =insertStringBuffer_";
  ...
  protected final String TEXT_559 = ".prepareStatement(insert_";
  protected final String TEXT_560 = ");" + NL + "\t    ";
  protected final String TEXT_561 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_573 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_574 = " = insert_";
  protected final String TEXT_575 = ".split(\"\\\\?\");";
  protected final String TEXT_576 = NL + "\t\t\tdelete_";
  protected final String TEXT_577 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_578 = " = delete_";
  protected final String TEXT_579 = ".split(\"\\\\?\");";
  protected final String TEXT_580 = NL + "\t\t\treplace_";
  protected final String TEXT_581 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_582 = " = replace_";
  protected final String TEXT_583 = ".split(\"\\\\?\");";
  protected final String TEXT_584 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_585 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_586 = " = insertIgnore_";
  ...
  protected final String TEXT_591 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_592 = " {" + NL + "    \t            ";
  protected final String TEXT_593 = NL + "                            ";
  protected final String TEXT_594 = " ";
  protected final String TEXT_595 = ";                ";
  protected final String TEXT_596 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_597 = ";" + NL + "\t\t\t";
  protected final String TEXT_598 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_599 = "(";
  protected final String TEXT_600 = NL + "                                ,";
  protected final String TEXT_601 = NL + "                            ";
  protected final String TEXT_602 = " ";
  protected final String TEXT_603 = NL + "\t\t\t\t, Dynamic ";
  ...
  protected final String TEXT_609 = NL + "\t\t\t\tthis.";
  protected final String TEXT_610 = "=";
  protected final String TEXT_611 = ";" + NL + "\t\t\t";
  protected final String TEXT_612 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_613 = "> exInsertColValueList";
  protected final String TEXT_614 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_615 = " exInsertColValue";
  protected final String TEXT_616 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_617 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_618 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_619 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_620 = "=1;";
  protected final String TEXT_621 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_622 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_623 = "=0;";
  protected final String TEXT_624 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_625 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_626 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_627 = " =null;" + NL + "\tint rowCount";
