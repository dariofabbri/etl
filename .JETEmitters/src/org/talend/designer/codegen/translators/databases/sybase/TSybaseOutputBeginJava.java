...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_303 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_372 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_373 = " = conn_";
  protected final String TEXT_374 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_375 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_376 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_377 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_378 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_379 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
