...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_56 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_57 = ")) {" + NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\t";
  protected final String TEXT_59 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_60 = "\", conn_";
  protected final String TEXT_61 = ");" + NL + "\t}";
  protected final String TEXT_62 = NL + "\tif (null != conn_";
  protected final String TEXT_63 = ") {" + NL + "\t\t";
  protected final String TEXT_64 = NL + "\t}";
  protected final String TEXT_65 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
