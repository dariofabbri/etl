...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_300 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_344 = " + \" SET ";
  protected final String TEXT_345 = " WHERE ";
  protected final String TEXT_346 = "\";" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_347 = " = conn_";
  protected final String TEXT_348 = ".prepareStatement(update_";
  protected final String TEXT_349 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_350 = " = conn_";
  protected final String TEXT_351 = ".prepareStatement(insert_";
  protected final String TEXT_352 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_353 = NL + "\t    String delete_";
  protected final String TEXT_354 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_355 = " + \" WHERE ";
  ...
  protected final String TEXT_365 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_376 = " = update_";
  protected final String TEXT_377 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_378 = " = insert_";
  protected final String TEXT_379 = ".split(\"\\\\?\");";
  protected final String TEXT_380 = NL + "\t\t\tdelete_";
  protected final String TEXT_381 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_382 = " = delete_";
  protected final String TEXT_383 = ".split(\"\\\\?\");";
  protected final String TEXT_384 = NL + "\t\t\treplace_";
  protected final String TEXT_385 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_386 = " = replace_";
  protected final String TEXT_387 = ".split(\"\\\\?\");";
  protected final String TEXT_388 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_389 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_390 = " = insertIgnore_";
  protected final String TEXT_391 = ".split(\"\\\\?\");";
  protected final String TEXT_392 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_393 = " = insert_";
  protected final String TEXT_394 = ".split(\"\\\\?\");";
  protected final String TEXT_395 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_396 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_397 = " = buffersSize_";
  protected final String TEXT_398 = ";";
  protected final String TEXT_399 = NL + "\t\t\t\t\tbatchSize_";
  ...
  protected final String TEXT_419 = NL + "    \t\tpstmt_";
  protected final String TEXT_420 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_421 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_422 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_428 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_473 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_474 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_475 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_481 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_537 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_572 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_616 = "_QUERY\", query_";
  protected final String TEXT_617 = ".toString().trim());";
  protected final String TEXT_618 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_619 = "=pstmtUpdate_";
  protected final String TEXT_620 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_621 = " = updatedCount_";
  protected final String TEXT_622 = " + updateFlag_";
  protected final String TEXT_623 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_638 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_639 = ";";
  protected final String TEXT_640 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_641 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_642 = " == 0) {" + NL + "            \t";
  protected final String TEXT_643 = NL + "\t\t\t\tquery_";
  protected final String TEXT_644 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_645 = NL + "                        ";
  protected final String TEXT_646 = NL + "                            query_";
  protected final String TEXT_647 = " = ";
  protected final String TEXT_648 = ";";
  protected final String TEXT_649 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_650 = ".";
  protected final String TEXT_651 = ", pstmtInsert_";
  ...
  protected final String TEXT_658 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_659 = " = insertedCount_";
  protected final String TEXT_660 = " + pstmtInsert_";
  protected final String TEXT_661 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_662 = " = true;";
  protected final String TEXT_663 = NL + "                        throw(e);";
  protected final String TEXT_664 = NL + "                            ";
  protected final String TEXT_665 = " = new ";
  protected final String TEXT_666 = "Struct();";
  protected final String TEXT_667 = NL + "                                ";
  protected final String TEXT_668 = ".";
  protected final String TEXT_669 = " = ";
  protected final String TEXT_670 = ".";
  protected final String TEXT_671 = ";";
  protected final String TEXT_672 = NL + "                            rejectedCount_";
  protected final String TEXT_673 = " = rejectedCount_";
  protected final String TEXT_674 = " + 1;";
  protected final String TEXT_675 = NL + "                            ";
  protected final String TEXT_676 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_677 = ";";
  protected final String TEXT_678 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_679 = NL + "                }" + NL + "                " + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_690 = NL + "                globalMap.put(\"";
  protected final String TEXT_691 = "_QUERY\", query_";
  protected final String TEXT_692 = ".toString().trim());";
  protected final String TEXT_693 = NL + "       ";
  protected final String TEXT_694 = NL + "    \t\tpstmt_";
  protected final String TEXT_695 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_696 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_697 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_698 = "++;";
  protected final String TEXT_699 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_700 = " = deletedCount_";
  protected final String TEXT_701 = " + pstmt_";
  protected final String TEXT_702 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_717 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_718 = ";";
  protected final String TEXT_719 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_720 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_721 = NL + "            nb_line_";
  protected final String TEXT_722 = "++;";
  protected final String TEXT_723 = NL + "            if(!whetherReject_";
  protected final String TEXT_724 = ") {";
  protected final String TEXT_725 = NL + "                            ";
  protected final String TEXT_726 = " = new ";
  protected final String TEXT_727 = "Struct();";
  ...
  protected final String TEXT_734 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_735 = " <= batchSizeCounter_";
  protected final String TEXT_736 = ") {                ";
  protected final String TEXT_737 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_738 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_739 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_740 = " += pstmt_";
  protected final String TEXT_741 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_742 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_743 = " += pstmt_";
  protected final String TEXT_744 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_745 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_746 = " += pstmt_";
  protected final String TEXT_747 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_748 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_749 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_750 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_751 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_752 = NL + "                }";
  protected final String TEXT_753 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_754 = NL + "            commitCounter_";
  protected final String TEXT_755 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_756 = "<=commitCounter_";
  protected final String TEXT_757 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_758 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_759 = " = 0;" + NL + "            " + NL + "            }" + NL + "        ";
