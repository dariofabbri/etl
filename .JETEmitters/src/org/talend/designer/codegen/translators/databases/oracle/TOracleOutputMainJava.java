...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_127 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_141 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_166 = NL + "                if(whetherExist_";
  protected final String TEXT_167 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_168 = " = conn_";
  protected final String TEXT_169 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_170 = ".execute(\"";
  protected final String TEXT_171 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_172 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_184 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_194 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_195 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_196 = "            ";
  protected final String TEXT_197 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_226 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_227 = ".executeUpdate(\"";
  ...
  protected final String TEXT_231 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_232 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_233 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_234 = ".close();";
  protected final String TEXT_235 = NL + "\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\tString insert_";
  protected final String TEXT_237 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_238 = " + \" (";
  protected final String TEXT_239 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_240 = ".";
  protected final String TEXT_241 = ",\"";
  protected final String TEXT_242 = "\")+\") VALUES (";
  protected final String TEXT_243 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_244 = ".";
  protected final String TEXT_245 = ")+\")\";";
  protected final String TEXT_246 = NL + "\t\t\t\t\t\tString insert_";
  protected final String TEXT_247 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_248 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_249 = ".";
  protected final String TEXT_250 = ", \"";
  protected final String TEXT_251 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_266 = ".prepareStatement(insert_";
  protected final String TEXT_267 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_270 = " = null;         " + NL + "\t\t\t\t\t\t\t\t// [%connection%][psmt][tableName]" + NL + "\t\t\t\t\t\t\t\tString keyPsmt_";
  ...
  protected final String TEXT_277 = ");\t\t" + NL + "\t\t\t\t\t\t\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_278 = ", pstmt_";
  protected final String TEXT_279 = ");" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_280 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_299 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_300 = " = new StringBuffer(update_";
  protected final String TEXT_301 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_302 = ".insert(update_";
  protected final String TEXT_303 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_304 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_305 = " =updateStringBuffer_";
  ...
  protected final String TEXT_323 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_324 = ".";
  protected final String TEXT_325 = ")+\")\";";
  protected final String TEXT_326 = NL + "\t\t\t\t\t\tString insert_";
  protected final String TEXT_327 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_328 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_329 = ".";
  protected final String TEXT_330 = ", \"";
  protected final String TEXT_331 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_332 = ".";
  protected final String TEXT_333 = ")+\")\";";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\tString update_";
  protected final String TEXT_335 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_336 = " + \" SET ";
  protected final String TEXT_337 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_338 = ".";
  protected final String TEXT_339 = ", \"";
  protected final String TEXT_340 = "\")+\" WHERE ";
  protected final String TEXT_341 = "\";";
  protected final String TEXT_342 = NL + "\t\t\t\t\t\tString update_";
  protected final String TEXT_343 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_344 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_345 = ".";
  protected final String TEXT_346 = ", \"";
  protected final String TEXT_347 = "\")+\" WHERE ";
  protected final String TEXT_348 = "\";";
  protected final String TEXT_349 = NL + "\t\t\t\t";
  protected final String TEXT_350 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_351 = " = new StringBuffer(insert_";
  protected final String TEXT_352 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_353 = ".insert(insert_";
  protected final String TEXT_354 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_355 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_356 = " =insertStringBuffer_";
  protected final String TEXT_357 = ".toString(); ";
  protected final String TEXT_358 = "    " + NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_359 = " = conn_";
  protected final String TEXT_360 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_370 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_381 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_389 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_395 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_402 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_416 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_420 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_421 = " = new StringBuffer(insert_";
  protected final String TEXT_422 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_423 = ".insert(insert_";
  protected final String TEXT_424 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_425 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_426 = " =insertStringBuffer_";
  protected final String TEXT_427 = ".toString(); ";
  protected final String TEXT_428 = "    " + NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_429 = " = conn_";
  protected final String TEXT_430 = ".prepareStatement(insert_";
  protected final String TEXT_431 = ");\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_432 = NL + "\t\t\t\tString delete_";
  protected final String TEXT_433 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_434 = " + \" WHERE ";
  protected final String TEXT_435 = "\";" + NL + "\t\t\t\t";
  protected final String TEXT_436 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_437 = " = new StringBuffer(delete_";
  protected final String TEXT_438 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_439 = ".insert(delete_";
  protected final String TEXT_440 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_441 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_442 = " =deleteStringBuffer_";
  protected final String TEXT_443 = ".toString();  ";
  protected final String TEXT_444 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".prepareStatement(delete_";
  protected final String TEXT_447 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_448 = NL + "\t\t\t\tStringBuffer query_";
  protected final String TEXT_449 = " = null;" + NL + "\t\t\t   ";
  protected final String TEXT_450 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_451 = " = insert_";
  ...
  protected final String TEXT_456 = ".split(\"\\\\?\");";
  protected final String TEXT_457 = NL + "\t\t\tupdate_";
  protected final String TEXT_458 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_459 = " = update_";
  protected final String TEXT_460 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_461 = " = insert_";
  protected final String TEXT_462 = ".split(\"\\\\?\");";
  protected final String TEXT_463 = NL + "\t\t\tdelete_";
  protected final String TEXT_464 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_465 = " = delete_";
  protected final String TEXT_466 = ".split(\"\\\\?\");";
  protected final String TEXT_467 = NL + "\t\t\treplace_";
  protected final String TEXT_468 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_469 = " = replace_";
  protected final String TEXT_470 = ".split(\"\\\\?\");";
  protected final String TEXT_471 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_472 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_473 = " = insertIgnore_";
  protected final String TEXT_474 = ".split(\"\\\\?\");";
  protected final String TEXT_475 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_480 = NL + "\t\tquery_";
  protected final String TEXT_481 = " = new StringBuffer(\"\");";
  protected final String TEXT_482 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_483 = " = buffersSize_";
  protected final String TEXT_484 = ";";
  protected final String TEXT_485 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_486 = " = buffersSize_";
  protected final String TEXT_487 = ";";
  protected final String TEXT_488 = NL + NL + "\t\t";
  protected final String TEXT_489 = NL + "        whetherReject_";
  protected final String TEXT_490 = " = false;";
  protected final String TEXT_491 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_492 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_493 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_494 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_495 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_496 = ".";
  protected final String TEXT_497 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_498 = " = tGeometry_";
  protected final String TEXT_499 = "._getInternalGeometry();" + NL + "                    \t" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_500 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_501 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_502 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_503 = "\", geometry_";
  protected final String TEXT_504 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_505 = ".expandToInclude(geometry_";
  protected final String TEXT_506 = ".getEnvelopeInternal()); " + NL + "                    \t}" + NL + "                    \t" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_507 = " = geometry_";
  protected final String TEXT_508 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_509 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_510 = " = oracle_wkt_";
  protected final String TEXT_511 = ".toJGeometry(wkt_";
  protected final String TEXT_512 = ".getBytes());" + NL;
  protected final String TEXT_513 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_514 = ".setSRID(";
  protected final String TEXT_515 = ");";
  protected final String TEXT_516 = NL + "               \t\tpstmt_";
  protected final String TEXT_517 = ".setObject(";
  protected final String TEXT_518 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_525 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_536 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_537 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_538 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_539 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_540 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_541 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_542 = " = insertedCount_";
  protected final String TEXT_543 = " + pstmt_";
  protected final String TEXT_544 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_545 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_546 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_547 = " = true;";
  protected final String TEXT_548 = NL + "                    throw(e_";
  protected final String TEXT_549 = ");";
  protected final String TEXT_550 = NL + "                        ";
  protected final String TEXT_551 = " = new ";
  protected final String TEXT_552 = "Struct();";
  protected final String TEXT_553 = NL + "                            ";
  protected final String TEXT_554 = ".";
  protected final String TEXT_555 = " = ";
  protected final String TEXT_556 = ".";
  protected final String TEXT_557 = ";";
  protected final String TEXT_558 = NL + "                        rejectedCount_";
  protected final String TEXT_559 = " = rejectedCount_";
  protected final String TEXT_560 = " + 1;";
  protected final String TEXT_561 = NL + "                        ";
  protected final String TEXT_562 = ".errorMessage = e_";
  protected final String TEXT_563 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_564 = ";";
  protected final String TEXT_565 = NL + "                        System.err.print(e_";
  protected final String TEXT_566 = ".getMessage());";
  ...
  protected final String TEXT_572 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_573 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_594 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_595 = "++;" + NL + "    \t\t";
  protected final String TEXT_596 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_597 = "++;" + NL + "    \t\t";
  protected final String TEXT_598 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_599 = NL + "             try {" + NL + "                updatedCount_";
  protected final String TEXT_600 = " = updatedCount_";
  protected final String TEXT_601 = " + pstmt_";
  protected final String TEXT_602 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_603 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_604 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_605 = " = true;";
  protected final String TEXT_606 = NL + "                    throw(e_";
  ...
  protected final String TEXT_620 = ".errorMessage = e_";
  protected final String TEXT_621 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_622 = ";";
  protected final String TEXT_623 = NL + "                        System.err.print(e_";
  protected final String TEXT_624 = ".getMessage());";
  ...
  protected final String TEXT_631 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_632 = " = pstmt_";
  protected final String TEXT_633 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_634 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_635 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_636 = " = rs_";
  protected final String TEXT_637 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_638 = " > 0) {";
  protected final String TEXT_639 = NL + "                        ";
  protected final String TEXT_640 = NL + "                            query_";
  protected final String TEXT_641 = " = ";
  protected final String TEXT_642 = ";";
  protected final String TEXT_643 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_644 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_645 = ".";
  protected final String TEXT_646 = ", pstmtUpdate_";
  ...
  protected final String TEXT_659 = NL + "                    globalMap.put(\"";
  protected final String TEXT_660 = "_QUERY\", query_";
  protected final String TEXT_661 = ".toString().trim());";
  protected final String TEXT_662 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_663 = " = updatedCount_";
  protected final String TEXT_664 = " + pstmtUpdate_";
  protected final String TEXT_665 = ".executeUpdate();" + NL + "                } catch(Exception e_";
  protected final String TEXT_666 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_667 = " = true;";
  protected final String TEXT_668 = NL + "                        throw(e_";
  ...
  protected final String TEXT_682 = ".errorMessage = e_";
  protected final String TEXT_683 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_684 = ";";
  protected final String TEXT_685 = NL + "                            System.err.print(e_";
  protected final String TEXT_686 = ".getMessage());";
  protected final String TEXT_687 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_688 = NL + "                        ";
  protected final String TEXT_689 = NL + "                            query_";
  protected final String TEXT_690 = " = ";
  protected final String TEXT_691 = ";";
  protected final String TEXT_692 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_693 = ".";
  protected final String TEXT_694 = ", pstmtInsert_";
  ...
  protected final String TEXT_701 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_702 = " = insertedCount_";
  protected final String TEXT_703 = " + pstmtInsert_";
  protected final String TEXT_704 = ".executeUpdate();" + NL + "                } catch(Exception e_";
  ...
  protected final String TEXT_721 = ".errorMessage = e_";
  protected final String TEXT_722 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_723 = ";";
  protected final String TEXT_724 = NL + "                            System.err.print(e_";
  protected final String TEXT_725 = ".getMessage());";
  protected final String TEXT_726 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_727 = "++;" + NL + "    \t\t";
  protected final String TEXT_728 = NL + "    \t    int updateFlag_";
  protected final String TEXT_729 = " = 0;" + NL + "    \t    ";
  protected final String TEXT_730 = NL + "                    ";
  protected final String TEXT_731 = NL + "                        query_";
  protected final String TEXT_732 = " = ";
  protected final String TEXT_733 = ";";
  protected final String TEXT_734 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_735 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_754 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_755 = " = pstmtUpdate_";
  protected final String TEXT_756 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_757 = " = updatedCount_";
  protected final String TEXT_758 = "+updateFlag_";
  protected final String TEXT_759 = ";" + NL + "            } catch(Exception e_";
  protected final String TEXT_760 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_761 = " = true;";
  protected final String TEXT_762 = NL + "                    throw(e_";
  ...
  protected final String TEXT_776 = ".errorMessage = e_";
  protected final String TEXT_777 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_778 = ";";
  protected final String TEXT_779 = NL + "                        System.err.print(e_";
  protected final String TEXT_780 = ".getMessage());";
  protected final String TEXT_781 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_782 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_783 = NL + "\t\t\t\tquery_";
  protected final String TEXT_784 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_800 = " + pstmtInsert_";
  protected final String TEXT_801 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(Exception e_";
  protected final String TEXT_802 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_803 = " = true;";
  protected final String TEXT_804 = NL + "                        throw(e_";
  ...
  protected final String TEXT_818 = ".errorMessage = e_";
  protected final String TEXT_819 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_820 = ";";
  protected final String TEXT_821 = NL + "                            System.err.print(e_";
  protected final String TEXT_822 = ".getMessage());";
  protected final String TEXT_823 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_838 = NL + "    \t\tpstmt_";
  protected final String TEXT_839 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_840 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_841 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_842 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_843 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_844 = " = deletedCount_";
  protected final String TEXT_845 = " + pstmt_";
  protected final String TEXT_846 = ".executeUpdate();" + NL + "            } catch(Exception e_";
  protected final String TEXT_847 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_848 = " = true;";
  protected final String TEXT_849 = NL + "                    throw(e_";
  ...
  protected final String TEXT_863 = ".errorMessage = e_";
  protected final String TEXT_864 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_865 = ";";
  protected final String TEXT_866 = NL + "                        System.err.print(e_";
  protected final String TEXT_867 = ".getMessage());";
  protected final String TEXT_868 = NL + "            }    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_869 = NL + "            nb_line_";
  protected final String TEXT_870 = "++;" + NL + "    \t";
  protected final String TEXT_871 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_882 = "                                                " + NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_883 = " <= batchSizeCounter_";
  protected final String TEXT_884 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_885 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_886 = "){" + NL + "                \t";
  protected final String TEXT_887 = NL + "                \t\tthrow(e_";
  protected final String TEXT_888 = ");" + NL + "                \t";
  protected final String TEXT_889 = NL + "                \t\tSystem.err.println(e_";
  protected final String TEXT_890 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_891 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_892 = " = pstmt_";
  protected final String TEXT_893 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  protected final String TEXT_894 = NL + "        \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_900 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_901 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_902 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_903 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_904 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_905 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_906 = " <= commitCounter_";
  protected final String TEXT_907 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_908 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_909 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_910 = "){" + NL + "\t\t                \t";
  protected final String TEXT_911 = NL + "\t\t\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_912 = ");" + NL + "\t\t                \t";
  protected final String TEXT_913 = NL + "\t\t                        System.out.println(e_";
  protected final String TEXT_914 = ".getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_915 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_916 = " = pstmt_";
  protected final String TEXT_917 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_918 = NL + "\t\t    \t    \t\tinsertedCount_";
  protected final String TEXT_919 = NL + "\t\t    \t    \t";
  protected final String TEXT_920 = "            \t    \t\t" + NL + "\t\t    \t    \t\tupdatedCount_";
  protected final String TEXT_921 = NL + "\t\t    \t    \t";
  protected final String TEXT_922 = NL + "\t\t    \t    \t    deletedCount_";
  protected final String TEXT_923 = NL + "\t\t    \t    \t";
  protected final String TEXT_924 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_925 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_926 = ":0);" + NL + "\t                ";
  protected final String TEXT_927 = NL + "                \tconn_";
  protected final String TEXT_928 = ".commit();                " + NL + "                \tcommitCounter_";
