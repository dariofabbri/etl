...
public class TInformixConnectionBeginJava
{
  ...
  protected final String TEXT_54 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_55 = "\", conn_";
  protected final String TEXT_56 = ");" + NL + "\t}";
  protected final String TEXT_57 = NL + "\tif (null != conn_";
  protected final String TEXT_58 = ") {" + NL + "\t\t";
  protected final String TEXT_59 = NL + "\t}";
  protected final String TEXT_60 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_61 = "\",conn_";
  protected final String TEXT_62 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
