...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_380 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_386 = NL + "    final Process process_";
  protected final String TEXT_387 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_388 = ");";
  protected final String TEXT_389 = NL + "\t\tjava.util.ArrayList<String> envParam_";
  protected final String TEXT_390 = "=new java.util.ArrayList<String>();" + NL + "\t\tjava.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_391 = " = System.getenv();" + NL + "\t\tfor (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_392 = ".entrySet())" + NL + "\t\t{" + NL + "\t\t   envParam_";
  protected final String TEXT_393 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "\t\t}";
  protected final String TEXT_394 = NL + "\t\tenvParam_";
  protected final String TEXT_395 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_396 = "\");";
  protected final String TEXT_397 = NL + "\t\tenvParam_";
  protected final String TEXT_398 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_399 = "\");";
  protected final String TEXT_400 = NL + "\t\t\tenvParam_";
  protected final String TEXT_401 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_402 = "\");";
  protected final String TEXT_403 = NL + "        envParam_";
  protected final String TEXT_404 = ".add(\"";
  protected final String TEXT_405 = "=";
  protected final String TEXT_406 = "\");";
  protected final String TEXT_407 = NL + "    final Process process_";
  protected final String TEXT_408 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_409 = ",envParam_";
  protected final String TEXT_410 = ".toArray(new String[0]));";
  protected final String TEXT_411 = " " + NL + "" + NL + "//System.out.println(command_";
  protected final String TEXT_412 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_413 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_414 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t        ";
  protected final String TEXT_415 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_416 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_417 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_418 = "_OUTPUT\") + \"\\n\" + line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_419 = NL + "\t\t        }" + NL + "\t\t    } finally {" + NL + "\t\t         reader.close();" + NL + "\t\t    }" + NL + "\t    }catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_420 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_421 = " = new Thread() {" + NL + "    public void run() {" + NL + "\t   try {" + NL + "\t\t   java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_422 = ".getErrorStream()));" + NL + "\t\t   String line = \"\";" + NL + "\t\t   try {" + NL + "\t\t\t   while((line = reader.readLine()) != null) {" + NL + "\t\t\t   \t  globalMap.put(\"";
  protected final String TEXT_423 = "_SQLLOAD_ERROR\", \"true\");\t" + NL + "\t\t\t       ";
  protected final String TEXT_424 = NL + "\t\t\t\t\t   System.err.println(line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_425 = NL + "\t\t\t\t\t   globalMap.put(\"";
  protected final String TEXT_426 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_427 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_428 = NL + "\t\t\t   }" + NL + "\t\t    } finally {" + NL + "\t\t\t    reader.close();" + NL + "\t\t    }" + NL + "\t    } catch(java.io.IOException ioe) {" + NL + "\t\t   ioe.printStackTrace();" + NL + "        }" + NL + "\t}" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_429 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_430 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_431 = " = process_";
  protected final String TEXT_432 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_433 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_434 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_435 = "_SQLLOAD_ERROR\"))) {" + NL + "\tthrow new TalendException(new Exception() , \"";
  protected final String TEXT_436 = "\" , globalMap);" + NL + "} " + NL + "\t" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_437 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_438 = "));" + NL + "int nb_line_data_";
  protected final String TEXT_439 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_440 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_441 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_442 = " = 0;" + NL + "" + NL + "/*\t1.get log file all lines count\t" + NL + "\t2.get \"Total logical records read\" line number from file end.\t" + NL + "\t3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_443 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_444 = " =0;//log file lines count" + NL + "//1" + NL + "boolean isEnglish_";
  protected final String TEXT_445 = " = false;" + NL + "while ((tempLine_";
  protected final String TEXT_446 = " = lr_";
  protected final String TEXT_447 = ".readLine() )!= null) {" + NL + "\tcountLines_";
  protected final String TEXT_448 = "++;" + NL + "\tif(!isEnglish_";
  protected final String TEXT_449 = " && tempLine_";
  protected final String TEXT_450 = ".contains(\"Total logical records\")){" + NL + "\t\tisEnglish_";
  protected final String TEXT_451 = " = true;" + NL + "\t}" + NL + "}" + NL + "lr_";
  protected final String TEXT_452 = ".close();" + NL + "//need new instance to readLine ." + NL + "lr_";
  protected final String TEXT_453 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_454 = "));" + NL + "if(isEnglish_";
  protected final String TEXT_455 = "){" + NL + "\tfor (int i_";
  protected final String TEXT_456 = "=0; i_";
  protected final String TEXT_457 = "<= countLines_";
  protected final String TEXT_458 = "; i_";
  protected final String TEXT_459 = "++) {" + NL + "\t\ttempLine_";
  protected final String TEXT_460 = " = lr_";
  protected final String TEXT_461 = ".readLine();" + NL + "\t\tif(tempLine_";
  protected final String TEXT_462 = ".contains(\"Rows successfully loaded\")){" + NL + "\t\t\tnb_line_inserted_";
  protected final String TEXT_463 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_464 = ".substring(0,tempLine_";
  protected final String TEXT_465 = ".indexOf(\"Rows successfully loaded\")).trim());" + NL + "\t\t}" + NL + "\t\tif(tempLine_";
  protected final String TEXT_466 = ".contains(\"Total logical records read\")){" + NL + "\t\t\tnb_line_data_";
  protected final String TEXT_467 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_468 = ".substring(tempLine_";
  protected final String TEXT_469 = ".indexOf(\":\") + 1).trim());" + NL + "\t\t}" + NL + "\t\tif(tempLine_";
  protected final String TEXT_470 = ".contains(\"Total logical records rejected\")){" + NL + "\t\t\tnb_line_bad_";
  protected final String TEXT_471 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_472 = ".substring(tempLine_";
  protected final String TEXT_473 = ".indexOf(\":\") + 1).trim());" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t}" + NL + "}else{" + NL + "//2" + NL + "for (int i_";
  protected final String TEXT_474 = "=0; i_";
  protected final String TEXT_475 = "<= countLines_";
  protected final String TEXT_476 = " - 10; i_";
  protected final String TEXT_477 = "++) {" + NL + "\tlr_";
  protected final String TEXT_478 = ".readLine();" + NL + "}" + NL + "//3.Total logical records read" + NL + "tempLine_";
  protected final String TEXT_479 = " = lr_";
  protected final String TEXT_480 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_481 = " != null) {" + NL + "\tnb_line_data_";
  protected final String TEXT_482 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_483 = ".substring(tempLine_";
  protected final String TEXT_484 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "//3.Total logical records rejected" + NL + "tempLine_";
  protected final String TEXT_485 = " = lr_";
  protected final String TEXT_486 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_487 = " != null) {" + NL + "\tnb_line_bad_";
  protected final String TEXT_488 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_489 = ".substring(tempLine_";
  protected final String TEXT_490 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "tempLine_";
  protected final String TEXT_491 = " = lr_";
  protected final String TEXT_492 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_493 = " != null) {" + NL + "\tnb_line_discarded_";
  protected final String TEXT_494 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_495 = ".substring(tempLine_";
  protected final String TEXT_496 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "\tnb_line_inserted_";
  protected final String TEXT_497 = " = nb_line_data_";
  protected final String TEXT_498 = " - nb_line_bad_";
  protected final String TEXT_499 = " - nb_line_discarded_";
  protected final String TEXT_500 = ";" + NL + "}" + NL + "lr_";
  protected final String TEXT_501 = ".close();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_502 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_503 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_504 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_505 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_506 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_507 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_508 = "_RETURN_CODE\", exitCode_";
