...
public class TELTGreenplumOutputMainJava
{
  ...
  protected final String TEXT_33 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_34 = " =null;" + NL + "\t";
  protected final String TEXT_35 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_36 = "+\"(";
  protected final String TEXT_37 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_38 = " = conn_";
  protected final String TEXT_39 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_40 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_41 = "+\" SET ";
  protected final String TEXT_42 = " \" +select_query.substring(select_query.indexOf(\"FROM\"));";
  protected final String TEXT_43 = NL + "\t\tif(select_query.indexOf(\"WHERE\")==-1){" + NL + "\t\tupdateQuery +=\"  WHERE \";" + NL + "\t\t}else{" + NL + "\t\tupdateQuery +=\"  AND \";" + NL + "\t\t} " + NL + "\t\tupdateQuery+= ";
  protected final String TEXT_44 = ";";
  protected final String TEXT_45 = NL + "\tpstmt_";
  protected final String TEXT_46 = " = conn_";
  protected final String TEXT_47 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_48 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_49 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_50 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_51 = NL + "\t";
  protected final String TEXT_52 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_53 = " = conn_";
  protected final String TEXT_54 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_60 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "nb_line_inserted_";
  protected final String TEXT_61 = " = pstmt_";
  protected final String TEXT_62 = ".executeUpdate();" + NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_63 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_64 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "nb_line_update_";
  protected final String TEXT_65 = " = pstmt_";
  protected final String TEXT_66 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_67 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_68 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_69 = " = pstmt_";
  protected final String TEXT_70 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_71 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  ...
  protected final String TEXT_76 = ".isClosed()) {" + NL + "        conn_";
