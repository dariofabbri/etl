...
public class TMomConnectionMainJava
{
  protected static String nl;
  public static synchronized TMomConnectionMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMomConnectionMainJava result = new TMomConnectionMainJava();
    nl = null;
    return result;
  }
