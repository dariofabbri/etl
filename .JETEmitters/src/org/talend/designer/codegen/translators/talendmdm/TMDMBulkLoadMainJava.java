...
public class TMDMBulkLoadMainJava
{
  ...
  protected final String TEXT_7 = ".load();" + NL + "}" + NL + "" + NL + "if(";
  protected final String TEXT_8 = ".";
  protected final String TEXT_9 = "!=null){" + NL + "\tinputStreamMerger_";
  protected final String TEXT_10 = ".push(new java.io.ByteArrayInputStream(";
  protected final String TEXT_11 = ".";
  protected final String TEXT_12 = ".toString().getBytes(\"UTF-8\")));" + NL + "}else{" + NL + "\tinputStreamMerger_";
  protected final String TEXT_13 = ".push(null);" + NL + "}" + NL + "\tcount_";
