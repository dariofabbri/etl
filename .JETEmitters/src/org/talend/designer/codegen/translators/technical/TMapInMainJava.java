...
public class TMapInMainJava {
  ...
  protected final String TEXT_51 = ".put(rsc_";
  ...
  protected final String TEXT_357 = NL + "\t\t} catch (Exception e) {" + NL + "\t\t\t//if anohter Exception when processing an Exception" + NL + "\t\t\ttry{//EE";
  ...
  protected final String TEXT_373 = NL + "         } catch (Exception ee) {//EE" + NL + "\t\t\t\tee.printStackTrace();";
