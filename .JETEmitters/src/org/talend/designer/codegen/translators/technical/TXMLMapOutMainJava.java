...
public class TXMLMapOutMainJava {
  ...
  protected final String TEXT_269 = NL + "\t\t\t\t\t\t\t\t\t//begin to lookup Document Object (case 1:lookup doc key exists),(case 2:lookup doc key not exists but lookup line doc output exist)" + NL + "\t\t\t\t\t\t\t\t\tDocument lookupDoc_";
  ...
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t\t\t\tDocument lookupDoc_";
  ...
  protected final String TEXT_526 = NL + "\t\t\t\t//init document to flat tool" + NL + "\t\t\t\tDocumentToFlat docToFlat_";
  protected final String TEXT_527 = " = new DocumentToFlat();" + NL + "\t\t\t\tdocToFlat_";
  ...
  protected final String TEXT_749 = NL + "\t\t\t\t\t\t\t\t\t//begin to lookup Document Object (case 1:lookup doc key exists),(case 2:lookup doc key not exists but lookup line doc output exist)" + NL + "\t\t\t\t\t\t\t\t\tDocument lookupDoc_";
  ...
  protected final String TEXT_873 = NL + "\t\t\t\t\t\t\t\t\tDocument lookupDoc_";
