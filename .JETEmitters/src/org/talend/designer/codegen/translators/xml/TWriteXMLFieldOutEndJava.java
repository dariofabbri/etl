...
public class TWriteXMLFieldOutEndJava {
  ...
  protected final String TEXT_180 = ".join();" + NL + "if(txf_";
  protected final String TEXT_181 = ".getLastException()!=null) {" + NL + "\tcurrentComponent = txf_";
  protected final String TEXT_182 = ".getCurrentComponent();" + NL + "\tthrow txf_";
  protected final String TEXT_183 = ".getLastException();" + NL + "}";
