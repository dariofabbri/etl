...
public class TXMLMapMainJava {
  ...
  protected final String TEXT_267 = NL + "\t\t\t\t\t\t\t\t\tif(lookupDoc_";
  protected final String TEXT_268 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_269 = ".";
  protected final String TEXT_270 = " can't be empty\");" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\tList<java.util.Map<String,Object>> result_";
  protected final String TEXT_271 = " = lookupDoc_";
  protected final String TEXT_272 = ".LookupDocument(\"";
  protected final String TEXT_273 = "\",";
  protected final String TEXT_274 = ",";
  protected final String TEXT_275 = "HashKey.documentLookupResult," + NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_276 = ",xmlNameSpaceMap_";
  protected final String TEXT_277 = ",xpathToTypeMap_";
  protected final String TEXT_278 = ",xpathToPatternMap_";
  protected final String TEXT_279 = ",\"";
  protected final String TEXT_280 = "\");" + NL + "\t\t\t\t\t\t\t\t\tif(result_";
  protected final String TEXT_281 = " == null || result_";
  protected final String TEXT_282 = ".size() == 0) {" + NL + "\t\t\t\t\t\t\t\t\t\t// not find" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t//find and cache it,now only memory,inner join and unique match mode" + NL + "\t\t\t\t\t\t\t\t\t\t//once find,not reject." + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_283 = NL + "\t\t\t\t\t\t\t\t\t\tisMatchDocRow";
  protected final String TEXT_284 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_285 = NL + "\t\t\t\t\t\t\t\t\t\tfor(java.util.Map<String,Object> docRow_";
  protected final String TEXT_286 = " : result_";
  protected final String TEXT_287 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tfor(String path_";
  protected final String TEXT_288 = " : docRow_";
  protected final String TEXT_289 = ".keySet()) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_290 = ".put(path_";
  protected final String TEXT_291 = ", StringUtils.valueOf(docRow_";
  protected final String TEXT_292 = ".get(path_";
  protected final String TEXT_293 = ")));" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  ...
  protected final String TEXT_300 = NL + "\t\t\t\t\t\t\t\t\t\tquit";
  protected final String TEXT_301 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_304 = " = fromLookup_";
  protected final String TEXT_305 = ";" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\t\t\t\t\t\tif(isMatchDocRow";
  protected final String TEXT_308 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_309 = ".put(\"";
  protected final String TEXT_310 = "\",";
  protected final String TEXT_311 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_312 = ".put(lookupCacheKey";
  protected final String TEXT_313 = ",cacheResult";
  protected final String TEXT_314 = "); " + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_315 = NL + "\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_316 = ".put(\"";
  protected final String TEXT_317 = "\",";
  protected final String TEXT_318 = "); " + NL + "\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_319 = ".put(lookupCacheKey";
  protected final String TEXT_320 = ",cacheResult";
  protected final String TEXT_321 = "); " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_323 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\t\t\t\t\t\t\tif(quit";
  protected final String TEXT_325 = ") {//for first match,once find in document,no need to continue to lookup." + NL + "\t\t\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}//TD119" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\t   \t";
  protected final String TEXT_328 = " = !isMatchDocRow";
  protected final String TEXT_329 = " && !hasResultFromLookupCache";
  protected final String TEXT_330 = ";" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = ";" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_333 = NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t  \tif(!isMatchDocRow";
  protected final String TEXT_335 = " && !hasResultFromLookupCache";
  protected final String TEXT_336 = ") {" + NL + "\t\t\t\t\t\t  \t\t";
  protected final String TEXT_337 = " = ";
  protected final String TEXT_338 = "Default;" + NL + "\t\t\t\t\t\t  \t}" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_339 = NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_340 = NL + "\t\t\t\t\t\t  \t\t//do nothing" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_341 = NL + "\t\t\t\t  \t\t}//TD10086" + NL + "\t\t\t\t  \t\t" + NL + "\t\t\t\t  \t\t";
  protected final String TEXT_342 = NL + "\t\t\t\t  \t\t\tif(!";
  protected final String TEXT_343 = " &&" + NL + "\t\t\t\t  \t\t\t\t!(";
  protected final String TEXT_344 = ")" + NL + "\t\t\t\t  \t\t\t) {" + NL + "\t\t\t\t  \t\t\t\t";
  protected final String TEXT_345 = " = ";
  protected final String TEXT_346 = "Default;" + NL + "\t\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t";
  protected final String TEXT_347 = " " + NL + "\t\t\t\t  \t\t\t\ttreeNodeAPI_";
  protected final String TEXT_348 = ".put(\"";
  ...
  protected final String TEXT_355 = NL + "\t\t\t\t  \t\tboolean fromCache";
  protected final String TEXT_356 = " = hasResultFromLookupCache";
  protected final String TEXT_357 = ";" + NL + "\t\t\t\t  \t\tList<java.util.Map<String,Object>> multipleResultSet";
  protected final String TEXT_358 = " = new java.util.ArrayList<java.util.Map<String,Object>>();" + NL + "\t\t\t\t  \t\t//the var for cache the ";
  protected final String TEXT_359 = "Struct" + NL + "\t\t\t\t  \t\tjava.util.Map<String,Object> oneRow_";
  protected final String TEXT_360 = " = null;" + NL + "\t\t\t\t\t\tif(hasResultFromLookupCache";
  protected final String TEXT_361 = ") {" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_362 = NL + "\t\t\t\t\t    \tjava.util.Map<String,Object> cacheResult_";
  protected final String TEXT_363 = " = tHash_Lookup_Cache_";
  protected final String TEXT_364 = ".next();" + NL + "\t\t\t\t\t    \tmultipleResultSet";
  protected final String TEXT_365 = ".add(cacheResult_";
  protected final String TEXT_366 = ");" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_367 = NL + "\t\t\t\t\t    } else if(!";
  protected final String TEXT_368 = ") {" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_369 = NL + "\t\t\t\t\t\t   \tisMatchDocRow";
  protected final String TEXT_370 = " = false;" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_371 = NL + "\t\t\t\t\t    \twhile (tHash_Lookup_";
  protected final String TEXT_372 = ".hasNext()) {" + NL + "\t\t\t\t\t    \t\tfromLookup_";
  protected final String TEXT_373 = " = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_374 = " = ";
  protected final String TEXT_375 = "Default;" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_376 = " = tHash_Lookup_";
  protected final String TEXT_377 = ".next();" + NL + "\t\t\t\t\t\t\t\tif(fromLookup_";
  protected final String TEXT_378 = " != null) {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\t\t\t\t\t\t\tDocument lookupDoc_";
  protected final String TEXT_380 = " = fromLookup_";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = ";" + NL + "\t\t\t\t\t\t\t\t\tjava.util.Map<String,String> xPathAsOutput_";
  protected final String TEXT_383 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_384 = NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_385 = ".put(\"";
  protected final String TEXT_386 = "\",\"";
  protected final String TEXT_387 = "\");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t\t\t\tif(lookupDoc_";
  protected final String TEXT_389 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_390 = ".";
  protected final String TEXT_391 = " can't be empty\");" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\tList<java.util.Map<String,Object>> result_";
  protected final String TEXT_392 = " = lookupDoc_";
  protected final String TEXT_393 = ".LookupDocument(\"";
  protected final String TEXT_394 = "\",";
  protected final String TEXT_395 = ",";
  protected final String TEXT_396 = "HashKey.documentLookupResult," + NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_397 = ",xmlNameSpaceMap_";
  protected final String TEXT_398 = ",xpathToTypeMap_";
  protected final String TEXT_399 = ",xpathToPatternMap_";
  protected final String TEXT_400 = ",\"";
  protected final String TEXT_401 = "\");" + NL + "\t\t\t\t\t\t\t\t\tif(result_";
  protected final String TEXT_402 = " == null || result_";
  protected final String TEXT_403 = ".size() == 0) {" + NL + "\t\t\t\t\t\t\t\t\t\t//do nothing" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\t\t\t\t\t\tisMatchDocRow";
  protected final String TEXT_405 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\t\t\t\t\t\t\tfor(java.util.Map<String,Object> docRow_";
  protected final String TEXT_407 = " : result_";
  protected final String TEXT_408 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tdocRow_";
  protected final String TEXT_409 = ".put(\"";
  protected final String TEXT_410 = "\",fromLookup_";
  protected final String TEXT_411 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\tmultipleResultSet";
  protected final String TEXT_412 = ".add(docRow_";
  protected final String TEXT_413 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\t\t\t\t\t\tfor(String path_";
  protected final String TEXT_415 = " : docRow_";
  protected final String TEXT_416 = ".keySet()) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_417 = ".put(path_";
  protected final String TEXT_418 = ",StringUtils.valueOf(docRow_";
  protected final String TEXT_419 = ".get(path_";
  protected final String TEXT_420 = ")));" + NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_421 = ".put(\"";
  protected final String TEXT_422 = "\",fromLookup_";
  protected final String TEXT_423 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_424 = ".put(lookupCacheKey";
  protected final String TEXT_425 = ",cacheResult";
  protected final String TEXT_426 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_429 = "\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_430 = " = fromLookup_";
  protected final String TEXT_431 = ";" + NL + "\t\t\t\t\t\t\t\t\t//construct the resultset for mutiple lookup when no document lookup." + NL + "\t\t\t\t\t\t\t\t\toneRow_";
  protected final String TEXT_432 = " = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\t\t\t\t\t\toneRow_";
  protected final String TEXT_433 = ".put(\"";
  protected final String TEXT_434 = "\",";
  protected final String TEXT_435 = ");" + NL + "\t\t\t\t\t\t\t\t\tmultipleResultSet";
  protected final String TEXT_436 = ".add(oneRow_";
  protected final String TEXT_437 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t    \t}//end while" + NL + "\t\t\t\t\t    \t" + NL + "\t\t\t\t\t    }//end else if" + NL + "\t\t\t\t\t    //now not support cache all_matches lookup" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_439 = NL + "\t\t\t\t\t    \tforceLoop";
  protected final String TEXT_440 = " = !isMatchDocRow";
  protected final String TEXT_441 = " && !hasResultFromLookupCache";
  ...
  protected final String TEXT_449 = ";" + NL + "\t\t\t\t\t    forceLoop";
  protected final String TEXT_450 = " = ";
  protected final String TEXT_451 = ";" + NL + "\t\t\t\t\t  \t";
  protected final String TEXT_452 = NL + "\t\t\t\t\t    " + NL + "\t\t\t\t\t    java.util.Iterator<java.util.Map<String,Object>> iter";
  protected final String TEXT_453 = " = multipleResultSet";
  protected final String TEXT_454 = ".iterator();" + NL + "\t\t\t\t\t    while(iter";
  protected final String TEXT_455 = ".hasNext() || forceLoop";
  protected final String TEXT_456 = ") { // G_TM_M_002" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_457 = " = ";
  protected final String TEXT_458 = "Default;" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_459 = "Struct tempLookup";
  protected final String TEXT_460 = " = null; " + NL + "\t\t\t\t\t    \tif(!forceLoop";
  protected final String TEXT_461 = ") {" + NL + "\t\t\t\t\t\t    \tjava.util.Map<String,Object> oneRow";
  protected final String TEXT_462 = " = iter";
  protected final String TEXT_463 = ".next();" + NL + "\t\t\t\t\t\t   \t\t";
  protected final String TEXT_464 = NL + "\t\t\t\t\t\t    \t\t\ttreeNodeAPI_";
  protected final String TEXT_465 = ".put(\"";
  protected final String TEXT_466 = "\",StringUtils.valueOf(oneRow";
  protected final String TEXT_467 = ".get(\"";
  protected final String TEXT_468 = "\")));" + NL + "\t\t\t\t\t\t    \t";
  protected final String TEXT_469 = NL + "\t\t\t\t\t    \t\ttempLookup";
  protected final String TEXT_470 = " = (";
  protected final String TEXT_471 = ")oneRow";
  protected final String TEXT_472 = ".get(\"";
  protected final String TEXT_473 = "\");" + NL + "\t\t\t\t\t    \t\tif(tempLookup";
  protected final String TEXT_474 = "!=null) {" + NL + "\t\t\t\t\t    \t\t\t";
  protected final String TEXT_475 = " = tempLookup";
  protected final String TEXT_476 = ";" + NL + "\t\t\t\t\t    \t\t}" + NL + "\t\t\t\t\t    \t\t" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_477 = NL + "\t\t\t\t\t    \t\tif(!";
  protected final String TEXT_478 = " &&" + NL + "\t\t\t\t  \t\t\t\t\t!(";
  protected final String TEXT_479 = ")" + NL + "\t\t\t\t  \t\t\t\t) {" + NL + "\t\t\t\t  \t\t\t\t\t";
  protected final String TEXT_480 = " = ";
  protected final String TEXT_481 = "Default;" + NL + "\t\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t\t";
  protected final String TEXT_482 = " " + NL + "\t\t\t\t  \t\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_483 = ".put(\"";
  ...
  protected final String TEXT_489 = NL + "\t\t\t\t    \t\t}" + NL + "\t\t\t\t    \t\tforceLoop";
  protected final String TEXT_490 = " = false;" + NL + "\t\t\t\t  \t\t";
  protected final String TEXT_491 = NL + "\t\t\t\t  \t\t/////////////////////////////////////////////////////////////////////////////////////////////////" + NL + "\t\t\t\t  \t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_492 = NL + "\t\t\t\t";
  protected final String TEXT_493 = NL + "        { // start of Var scope" + NL + "        " + NL + "\t        // ###############################" + NL + "        \t// # Vars tables" + NL + "        ";
  protected final String TEXT_494 = NL + "\t\t\t\t\t";
  protected final String TEXT_495 = NL + "\t\t// ###############################" + NL + "\t\t// # Output tables";
  protected final String TEXT_496 = NL;
  protected final String TEXT_497 = NL;
  protected final String TEXT_498 = NL + "\t\tif(nb_line_";
  protected final String TEXT_499 = " == nodeList_";
  protected final String TEXT_500 = ".size()) {";
  protected final String TEXT_501 = NL + "\t\t\t\t\t";
  protected final String TEXT_502 = " = ";
  protected final String TEXT_503 = "_save;";
