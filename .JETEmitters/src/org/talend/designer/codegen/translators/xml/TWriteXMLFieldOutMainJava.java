...
public class TWriteXMLFieldOutMainJava {
  ...
  protected final String TEXT_302 = NL + "\t\t    listGroupby_";
  protected final String TEXT_303 = ".add(strWriter_";
  protected final String TEXT_304 = ".toString());";
  protected final String TEXT_305 = NL + "\t\t    doc_";
  protected final String TEXT_306 = ".clearContent();" + NL + "\t\t\tneedRoot_";
  protected final String TEXT_307 = " = true;" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_308 = "=0;i_";
  protected final String TEXT_309 = "<orders_";
  protected final String TEXT_310 = ".length;i_";
  protected final String TEXT_311 = "++){" + NL + "\t\t\t\torders_";
  protected final String TEXT_312 = "[i_";
  protected final String TEXT_313 = "] = 0;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tif(groupbyList_";
  protected final String TEXT_314 = " != null && groupbyList_";
  protected final String TEXT_315 = ".size() >= 0){" + NL + "\t\t\t\tgroupbyList_";
  protected final String TEXT_316 = ".clear();" + NL + "\t\t\t}" + NL + "\t\t\tstrCompCache_";
  protected final String TEXT_317 = "=strTemp_";
  protected final String TEXT_318 = ";";
  protected final String TEXT_319 = NL + "\t\t}";
  protected final String TEXT_320 = NL + "\t}" + NL;
  protected final String TEXT_321 = NL + "\torg.dom4j.Element subTreeRootParent_";
  protected final String TEXT_322 = " = null;" + NL + "\t" + NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_323 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_324 = "=false;";
  protected final String TEXT_325 = NL + "\t\troot4Group_";
  protected final String TEXT_326 = " = subTreeRootParent_";
  protected final String TEXT_327 = ";" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent_";
  protected final String TEXT_328 = "=root4Group_";
  protected final String TEXT_329 = ";" + NL + "\t}" + NL + "\t// build group xml tree ";
  protected final String TEXT_330 = NL + "\tboolean isNewElememt = false;";
  protected final String TEXT_331 = NL + "\tif(isNewElememt || groupbyList_";
  protected final String TEXT_332 = ".size()<=";
  protected final String TEXT_333 = " || groupbyList_";
  protected final String TEXT_334 = ".get(";
  protected final String TEXT_335 = ")==null";
  protected final String TEXT_336 = NL + "\t|| ( groupbyList_";
  protected final String TEXT_337 = ".get(";
  protected final String TEXT_338 = ").get(";
  protected final String TEXT_339 = ")!=null " + NL + "\t\t? !groupbyList_";
  ...
  protected final String TEXT_346 = NL + "\t\tif(groupbyList_";
  protected final String TEXT_347 = ".size()<=";
  protected final String TEXT_348 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_349 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_350 = ".get(";
  protected final String TEXT_351 = ").clear();" + NL + "        }";
  protected final String TEXT_352 = NL + "\t\tgroupbyList_";
  protected final String TEXT_353 = ".get(";
  protected final String TEXT_354 = ").add(";
  protected final String TEXT_355 = ");";
  protected final String TEXT_356 = NL + "        isNewElememt=true;" + NL + "        if(groupElementList_";
  protected final String TEXT_357 = ".size()<=";
  protected final String TEXT_358 = "){" + NL + "\t\t\tgroupElementList_";
  protected final String TEXT_359 = ".add(group";
  protected final String TEXT_360 = "__";
  protected final String TEXT_361 = ");" + NL + "        }else{" + NL + "        \tgroupElementList_";
  protected final String TEXT_362 = ".set(";
  protected final String TEXT_363 = ",group";
  protected final String TEXT_364 = "__";
  protected final String TEXT_365 = ");" + NL + "        }" + NL + "        " + NL + "\t}else{" + NL + "\t\tsubTreeRootParent_";
  protected final String TEXT_366 = "=groupElementList_";
  protected final String TEXT_367 = ".get(";
  protected final String TEXT_368 = ");" + NL + "\t}";
  protected final String TEXT_369 = NL + "\t// build loop xml tree";
  protected final String TEXT_370 = NL + "\t\t//the data read is different from the data read last time. " + NL + "\t\tif(strCompCache_";
  protected final String TEXT_371 = ".equals(strTemp_";
  protected final String TEXT_372 = ")==false){";
  protected final String TEXT_373 = NL + NL + "\t\t // write the endtag to the StringWriter:strWriter_tWriteXMLField_1_Out" + NL + "\t\t // close the bufferWriter" + NL + "\t\t // add the data in strWriter_tWriteXMLField_1_Out to listGroupby\t\t\t\t\t\t\t " + NL + "" + NL + "\t\tif (preUnNullMaxIndex_";
  protected final String TEXT_374 = " >= 0) {" + NL + "\t        // output all buffer" + NL + "\t        for (int j_";
  protected final String TEXT_375 = " = 0; j_";
  protected final String TEXT_376 = " <= preUnNullMaxIndex_";
  protected final String TEXT_377 = "; j_";
  protected final String TEXT_378 = "++) {" + NL + "\t            if (startTabs_";
  protected final String TEXT_379 = "[j_";
  protected final String TEXT_380 = "] != null)" + NL + "\t                out_";
  protected final String TEXT_381 = ".write(startTabs_";
  protected final String TEXT_382 = "[j_";
  protected final String TEXT_383 = "]);" + NL + "\t        }" + NL + "\t" + NL + "\t        if (preUnNullMaxIndex_";
  protected final String TEXT_384 = " < preNewTabIndex_";
  protected final String TEXT_385 = " ) {" + NL + "\t\t\t\tfor (int i_";
  protected final String TEXT_386 = " = preNewTabIndex_";
  protected final String TEXT_387 = " - 1; i_";
  protected final String TEXT_388 = " >= 0; i_";
  protected final String TEXT_389 = "--) {" + NL + "                \tif(endTabs_";
  protected final String TEXT_390 = "[i_";
  protected final String TEXT_391 = "]!=null){" + NL + "                \t\tout_";
  protected final String TEXT_392 = ".write(endTabs_";
  protected final String TEXT_393 = "[i_";
  protected final String TEXT_394 = "]);" + NL + "                \t}                \t" + NL + "\t                out_";
  protected final String TEXT_395 = ".write(\"";
  protected final String TEXT_396 = "\");" + NL + "\t                out_";
  protected final String TEXT_397 = ".write(endTabStrs_";
  protected final String TEXT_398 = ".get(i_";
  protected final String TEXT_399 = "));" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            for (int i_";
  protected final String TEXT_400 = " = preUnNullMaxIndex_";
  protected final String TEXT_401 = "; i_";
  protected final String TEXT_402 = " >= 0; i_";
  protected final String TEXT_403 = "--) {" + NL + "                \tif(endTabs_";
  protected final String TEXT_404 = "[i_";
  protected final String TEXT_405 = "]!=null){" + NL + "                \t\tout_";
  protected final String TEXT_406 = ".write(endTabs_";
  protected final String TEXT_407 = "[i_";
  protected final String TEXT_408 = "]);" + NL + "                \t}" + NL + "                \tout_";
  protected final String TEXT_409 = ".write(\"";
  protected final String TEXT_410 = "\");" + NL + "\t                out_";
  protected final String TEXT_411 = ".write(endTabStrs_";
  protected final String TEXT_412 = ".get(i_";
  protected final String TEXT_413 = "));" + NL + "\t            }" + NL + "\t        }" + NL + "\t    }";
  protected final String TEXT_414 = NL + "\t\tfor (int i_";
  protected final String TEXT_415 = " = endTabStrs_";
  protected final String TEXT_416 = ".size() - 1; i_";
  protected final String TEXT_417 = " >= 0; i_";
  protected final String TEXT_418 = "--) {" + NL + "        \tif(endTabs_";
  protected final String TEXT_419 = "[i_";
  protected final String TEXT_420 = "]!=null){" + NL + "        \t\tout_";
  protected final String TEXT_421 = ".write(endTabs_";
  protected final String TEXT_422 = "[i_";
  protected final String TEXT_423 = "]);" + NL + "        \t}" + NL + "\t        out_";
  protected final String TEXT_424 = ".write(\"";
  protected final String TEXT_425 = "\");" + NL + "\t        out_";
  protected final String TEXT_426 = ".write(endTabStrs_";
  protected final String TEXT_427 = ".get(i_";
  protected final String TEXT_428 = "));" + NL + "\t    }";
  protected final String TEXT_429 = NL + "\t\tfor (int i_";
  protected final String TEXT_430 = " = 0; i_";
  protected final String TEXT_431 = " < endTabs_";
  protected final String TEXT_432 = ".length; i_";
  protected final String TEXT_433 = "++) {" + NL + "\t\t\tstartTabs_";
  protected final String TEXT_434 = "[i_";
  protected final String TEXT_435 = "] = null;" + NL + "\t\t\tendTabs_";
  protected final String TEXT_436 = "[i_";
  protected final String TEXT_437 = "] = null;" + NL + "\t\t}" + NL + "//\t\tendTabStrs_";
  protected final String TEXT_438 = ".clear();" + NL + "\t\tout_";
  protected final String TEXT_439 = ".write(\"";
  protected final String TEXT_440 = "\");" + NL + "\t\tout_";
  protected final String TEXT_441 = ".close();" + NL + "\t\tlistGroupby_";
  protected final String TEXT_442 = ".add(strWriter_";
  protected final String TEXT_443 = ".toString());" + NL + "" + NL + "\t\t//create a new StringWriter and BufferWriter" + NL + "\t\t//write the head title to the StringWriter\t\t" + NL + "\t\tstrWriter_";
  protected final String TEXT_444 = " = new java.io.StringWriter();" + NL + "\t\tout_";
  protected final String TEXT_445 = " = new java.io.BufferedWriter(strWriter_";
  protected final String TEXT_446 = ");";
  protected final String TEXT_447 = NL + "\t\tout_";
  protected final String TEXT_448 = ".write(\"<?xml version=\\\"1.0\\\" encoding=\\\"\"+";
  protected final String TEXT_449 = "+\"\\\"?>\");" + NL + "\t\tout_";
  protected final String TEXT_450 = ".write(\"";
  protected final String TEXT_451 = "\");";
  protected final String TEXT_452 = NL + NL + "\t\tneedRoot_";
  protected final String TEXT_453 = " = true;" + NL + "\t\tstrCompCache_";
  protected final String TEXT_454 = "=strTemp_";
  protected final String TEXT_455 = ";" + NL + "\t\tpreNewTabIndex_";
  protected final String TEXT_456 = " = -1;";
  protected final String TEXT_457 = NL + "\t\t}";
  protected final String TEXT_458 = "\t" + NL + "\t}\t" + NL + "\t" + NL + "\tStringBuffer buf_";
  protected final String TEXT_459 = " = new StringBuffer();" + NL + "\t//init value is 0 not -1, because it will output the root tab when all the row value is null." + NL + "\tint unNullMaxIndex_";
  protected final String TEXT_460 = " = 0;" + NL + "" + NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_461 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_462 = "=false;";
  protected final String TEXT_463 = NL + "\t\tif( false";
  protected final String TEXT_464 = " || valueMap_";
  protected final String TEXT_465 = ".get(\"";
  protected final String TEXT_466 = "\") != null";
  protected final String TEXT_467 = NL + "\t\t){" + NL + "\t\t\tunNullMaxIndex_";
  protected final String TEXT_468 = " = ";
  protected final String TEXT_469 = ";" + NL + "\t\t}";
  protected final String TEXT_470 = NL + "\t\tendTabs_";
  protected final String TEXT_471 = "[";
  protected final String TEXT_472 = "] = buf_";
  protected final String TEXT_473 = ".toString();" + NL + "\t\tbuf_";
  protected final String TEXT_474 = " = new StringBuffer();";
  protected final String TEXT_475 = NL + "\t}" + NL + "\t" + NL + "\t// build group xml tree ";
  protected final String TEXT_476 = NL + "\tboolean isNewElememt = false;" + NL + "\t//The index of group element which is the first new group in groups." + NL + "\tint newTabIndex_";
  protected final String TEXT_477 = " = -1;" + NL + "\t//Buffer all group tab XML, then set to startTabBuffer." + NL + "    String[] groupBuffer_";
  protected final String TEXT_478 = " = new String[";
  protected final String TEXT_479 = "];" + NL + "    String[] groupEndBuffer_";
  protected final String TEXT_480 = " = new String[";
  protected final String TEXT_481 = "];";
  protected final String TEXT_482 = NL + NL + "\t// need a new group element ";
  protected final String TEXT_483 = " or not" + NL + "\tif(isNewElememt || groupbyList_";
  ...
  protected final String TEXT_488 = NL + "\t|| ( groupbyList_";
  protected final String TEXT_489 = ".get(";
  protected final String TEXT_490 = ").get(";
  protected final String TEXT_491 = ")!=null " + NL + "\t\t? !groupbyList_";
  protected final String TEXT_492 = ".get(";
  protected final String TEXT_493 = ").get(";
  protected final String TEXT_494 = ").equals(";
  protected final String TEXT_495 = ") " + NL + "\t\t: ";
  protected final String TEXT_496 = "!=null )";
  protected final String TEXT_497 = NL + "\t){" + NL + "\t\t// Is the first new element in groups." + NL + "\t\tif(isNewElememt == false && groupbyList_";
  protected final String TEXT_498 = ".size()>";
  protected final String TEXT_499 = "){" + NL + "\t\t\tnewTabIndex_";
  protected final String TEXT_500 = " = ";
  protected final String TEXT_501 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t// count the groupby element" + NL + "\t\tif(groupbyList_";
  protected final String TEXT_502 = ".size()<=";
  protected final String TEXT_503 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_504 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_505 = ".get(";
  protected final String TEXT_506 = ").clear();" + NL + "        }";
  protected final String TEXT_507 = NL + "\t\tgroupbyList_";
  protected final String TEXT_508 = ".get(";
  protected final String TEXT_509 = ").add(";
  protected final String TEXT_510 = ");";
  protected final String TEXT_511 = NL + "        isNewElememt=true;" + NL + "\t}" + NL + "\t" + NL + "\t// subtree XML string generate";
  protected final String TEXT_512 = NL + "\tif( false";
  protected final String TEXT_513 = " || valueMap_";
  protected final String TEXT_514 = ".get(\"";
  protected final String TEXT_515 = "\") != null";
  protected final String TEXT_516 = NL + "\t){" + NL + "\t\tunNullMaxIndex_";
  protected final String TEXT_517 = " = ";
  protected final String TEXT_518 = ";" + NL + "\t}";
  protected final String TEXT_519 = NL + "\t// buffer the end tabs to group buffer" + NL + "\tgroupEndBuffer_";
  protected final String TEXT_520 = "[";
  protected final String TEXT_521 = "] = buf_";
  protected final String TEXT_522 = ".toString();" + NL + "    buf_";
  protected final String TEXT_523 = " = new StringBuffer();";
  protected final String TEXT_524 = NL + "\t//output the previous groups as there's a new group" + NL + "    if (newTabIndex_";
  protected final String TEXT_525 = " >= 0 && preNewTabIndex_";
  protected final String TEXT_526 = "!=-1) {" + NL + "        //out_";
  protected final String TEXT_527 = ".newLine();//Track code";
  protected final String TEXT_528 = NL + "\t\t// output unNull tabs in start tabs buffer" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_529 = " >= 0) {" + NL + "            for (int i_";
  protected final String TEXT_530 = " = 0; i_";
  protected final String TEXT_531 = " < startTabs_";
  protected final String TEXT_532 = ".length; i_";
  protected final String TEXT_533 = "++) {" + NL + "                if (i_";
  protected final String TEXT_534 = " <= preUnNullMaxIndex_";
  protected final String TEXT_535 = ") {" + NL + "                    if (startTabs_";
  protected final String TEXT_536 = "[i_";
  protected final String TEXT_537 = "] != null) {" + NL + "                        out_";
  protected final String TEXT_538 = ".write(startTabs_";
  protected final String TEXT_539 = "[i_";
  protected final String TEXT_540 = "]);" + NL + "                    }" + NL + "                    startTabs_";
  protected final String TEXT_541 = "[i_";
  protected final String TEXT_542 = "] = null;" + NL + "                }" + NL + "            }" + NL + "        }";
  protected final String TEXT_543 = NL + "\t\t//output all start tabs buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_544 = " = 0; i_";
  protected final String TEXT_545 = " < startTabs_";
  protected final String TEXT_546 = ".length; i_";
  ...
  protected final String TEXT_555 = NL + "        // output endtabs" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_556 = " >= preNewTabIndex_";
  protected final String TEXT_557 = NL + "            && preUnNullMaxIndex_";
  protected final String TEXT_558 = " >= ";
  protected final String TEXT_559 = " + newTabIndex_";
  protected final String TEXT_560 = ") {" + NL + "            for (int i_";
  protected final String TEXT_561 = " = preUnNullMaxIndex_";
  protected final String TEXT_562 = "; i_";
  protected final String TEXT_563 = " >= ";
  protected final String TEXT_564 = " + newTabIndex_";
  protected final String TEXT_565 = "; i_";
  protected final String TEXT_566 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_567 = "[i_";
  protected final String TEXT_568 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_569 = ".write(endTabs_";
  protected final String TEXT_570 = "[i_";
  protected final String TEXT_571 = "]);" + NL + "            \t}" + NL + "            \tendTabs_";
  protected final String TEXT_572 = "[i_";
  protected final String TEXT_573 = "] = null;" + NL + "                out_";
  protected final String TEXT_574 = ".write(\"";
  ...
  protected final String TEXT_593 = ".write(\"";
  protected final String TEXT_594 = "\");" + NL + "                out_";
  protected final String TEXT_595 = ".write(endTabStrs_";
  protected final String TEXT_596 = NL + "                        .get(i_";
  protected final String TEXT_597 = "));" + NL + "            }";
  protected final String TEXT_598 = NL + "        }";
  protected final String TEXT_599 = NL + "        preNewTabIndex_";
  protected final String TEXT_600 = " = newTabIndex_";
  protected final String TEXT_601 = " + ";
  protected final String TEXT_602 = ";" + NL + "    }" + NL + "" + NL + "    // set new element groupbuffer to startbuffer" + NL + "    for (int i_";
  protected final String TEXT_603 = " = 0; i_";
  protected final String TEXT_604 = " < groupBuffer_";
  protected final String TEXT_605 = ".length; i_";
  protected final String TEXT_606 = "++) {" + NL + "        // when newTabIndex is null, must use the perNewTabIndex" + NL + "        if (i_";
  protected final String TEXT_607 = " >= preNewTabIndex_";
  protected final String TEXT_608 = " - ";
  protected final String TEXT_609 = ") {" + NL + "            startTabs_";
  protected final String TEXT_610 = "[i_";
  protected final String TEXT_611 = " + ";
  protected final String TEXT_612 = "] = groupBuffer_";
  protected final String TEXT_613 = "[i_";
  protected final String TEXT_614 = "];" + NL + "            endTabs_";
  protected final String TEXT_615 = "[i_";
  protected final String TEXT_616 = " + ";
  protected final String TEXT_617 = "] = groupEndBuffer_";
  protected final String TEXT_618 = "[i_";
  protected final String TEXT_619 = "];" + NL + "        }" + NL + "    }";
  protected final String TEXT_620 = NL + "\t//reset the preUnNullMaxIndex" + NL + "\tif(unNullMaxIndex_";
  protected final String TEXT_621 = ">=0){" + NL + "    \tpreUnNullMaxIndex_";
  protected final String TEXT_622 = "=unNullMaxIndex_";
  protected final String TEXT_623 = ";" + NL + "\t}else{" + NL + "\t\tif(preUnNullMaxIndex_";
  protected final String TEXT_624 = ">";
  protected final String TEXT_625 = "){" + NL + "\t\t\tpreUnNullMaxIndex_";
  protected final String TEXT_626 = "=";
  protected final String TEXT_627 = ";" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_628 = NL + "\t// build loop xml tree";
  protected final String TEXT_629 = NL + "\t\tif( false";
  protected final String TEXT_630 = " || valueMap_";
  protected final String TEXT_631 = ".get(\"";
  protected final String TEXT_632 = "\") != null";
  protected final String TEXT_633 = " || true " + NL + "    \t";
  protected final String TEXT_634 = NL + "\t\t){";
  protected final String TEXT_635 = NL + "\t\t// output all buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_636 = " = 0; i_";
  protected final String TEXT_637 = " < startTabs_";
  protected final String TEXT_638 = ".length; i_";
  protected final String TEXT_639 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_640 = "[i_";
  protected final String TEXT_641 = "] != null && startTabs_";
  protected final String TEXT_642 = "[i_";
  protected final String TEXT_643 = "].length() > 0) {" + NL + "                out_";
  protected final String TEXT_644 = ".write(startTabs_";
  protected final String TEXT_645 = "[i_";
  protected final String TEXT_646 = "]);" + NL + "                startTabs_";
  protected final String TEXT_647 = "[i_";
  protected final String TEXT_648 = "] = null;" + NL + "            }" + NL + "        }" + NL + "\t\tout_";
  protected final String TEXT_649 = ".write(buf_";
  protected final String TEXT_650 = ".toString());" + NL + "\t\tpreNewTabIndex_";
  protected final String TEXT_651 = " = ";
  protected final String TEXT_652 = ";";
  protected final String TEXT_653 = NL + "            preUnNullMaxIndex_";
